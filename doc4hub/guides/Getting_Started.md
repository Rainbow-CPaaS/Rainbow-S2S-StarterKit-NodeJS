...
In configuration file some parameters are related to your credentials and allow to target the Rainbow Cloud Services server to use (refer to section [Configuration file](#configuration-file) for more details).
