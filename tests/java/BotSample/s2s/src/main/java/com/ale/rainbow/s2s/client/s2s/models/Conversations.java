 ...
 */
@ApiModel(description = "All users's conversations")
...
public class Conversations implements Serializable {
  ...
  public Conversations data(List<Conversation> data) {
    
    this.data = data;
    return this;
  }

  public Conversations addDataItem(Conversation dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "the list of conversations")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.data, conversations.data);
  }
