 ...
 * A presence status
 */
@ApiModel(description = "A presence status")
...
public class Presence implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(value = "An optional additional information")
  ...
  public Presence show(ShowEnum show) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The user presence status")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, presence.status) &&
        Objects.equals(this.show, presence.show);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, show);
  }
