...
public class ApiRainbowUcsV10ConnectionsMessageAttachment implements Serializable {
  ...
  public ApiRainbowUcsV10ConnectionsMessageAttachment url(String url) {
  ...
  **/
  ...
  @ApiModelProperty(example = "https://hello.com/filename.pdf", value = "the attachment Url")
  ...
  public ApiRainbowUcsV10ConnectionsMessageAttachment filename(String filename) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "filename.pdf", value = "the attachment filename")
  ...
  public ApiRainbowUcsV10ConnectionsMessageAttachment mime(String mime) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "application/pdf", value = "the attachment mime type")
  ...
  public ApiRainbowUcsV10ConnectionsMessageAttachment size(Integer size) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1000", value = "the attachment size in bytes")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApiRainbowUcsV10ConnectionsMessageAttachment apiRainbowUcsV10ConnectionsMessageAttachment = (ApiRainbowUcsV10ConnectionsMessageAttachment) o;
    return Objects.equals(this.url, apiRainbowUcsV10ConnectionsMessageAttachment.url) &&
        Objects.equals(this.filename, apiRainbowUcsV10ConnectionsMessageAttachment.filename) &&
        Objects.equals(this.mime, apiRainbowUcsV10ConnectionsMessageAttachment.mime) &&
        Objects.equals(this.size, apiRainbowUcsV10ConnectionsMessageAttachment.size);
  }

  @Override
  public int hashCode() {
    return Objects.hash(url, filename, mime, size);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiRainbowUcsV10ConnectionsMessageAttachment {\n");
