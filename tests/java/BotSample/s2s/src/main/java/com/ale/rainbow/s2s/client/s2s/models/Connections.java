 ...
 */
@ApiModel(description = "All connections for a specific user")
...
public class Connections implements Serializable {
  ...
  public Connections addDataItem(Connection dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Connection>();
    }
  ...
  **/
  ...
  @ApiModelProperty(value = "the list of connections")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.data, connections.data);
  }
