...
import com.ale.rainbow.s2s.client.s2s.models.MessageCreateMessage;
 ...
 */
@ApiModel(description = "Message creation data")
...
public class MessageCreate implements Serializable {
  ...
  private MessageCreateMessage message;


  public MessageCreate message(MessageCreateMessage message) {
  ...
  **/
  ...
  public MessageCreateMessage getMessage() {
    return message;
  }


  public void setMessage(MessageCreateMessage message) {
    this.message = message;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.message, messageCreate.message);
  }
