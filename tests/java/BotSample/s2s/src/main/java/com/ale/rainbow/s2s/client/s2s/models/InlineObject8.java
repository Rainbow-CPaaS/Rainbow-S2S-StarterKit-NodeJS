...
import com.ale.rainbow.s2s.client.s2s.models.ApiRainbowUcsV10ConnectionsRoomMember;
...
public class InlineObject8 implements Serializable {
  ...
  public static final String SERIALIZED_NAME_ROOM_MEMBER = "room-member";
  @SerializedName(SERIALIZED_NAME_ROOM_MEMBER)
  private ApiRainbowUcsV10ConnectionsRoomMember roomMember;


  public InlineObject8 id(String id) {
  ...
  **/
  ...
  public InlineObject8 timestamp(String timestamp) {
  ...
  **/
  ...
  public InlineObject8 roomMember(ApiRainbowUcsV10ConnectionsRoomMember roomMember) {
  ...
  **/
  ...
  public ApiRainbowUcsV10ConnectionsRoomMember getRoomMember() {
    return roomMember;
  }


  public void setRoomMember(ApiRainbowUcsV10ConnectionsRoomMember roomMember) {
    this.roomMember = roomMember;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, inlineObject8.id) &&
        Objects.equals(this.timestamp, inlineObject8.timestamp) &&
        Objects.equals(this.roomMember, inlineObject8.roomMember);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, timestamp, roomMember);
  }
  ...
  public String toString() {
    ...
    sb.append("    roomMember: ").append(toIndentedString(roomMember)).append("\n");
    sb.append("}");
    return sb.toString();
  }
