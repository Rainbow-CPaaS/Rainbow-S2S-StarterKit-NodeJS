 ...
 * A receipt status
 */
@ApiModel(description = "A receipt status")
...
public class ReceiptStatus implements Serializable {
  ...
  public ReceiptStatus msgId(String msgId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The message identifier")
  ...
  public ReceiptStatus event(EventEnum event) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The receipt event")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.msgId, receiptStatus.msgId) &&
        Objects.equals(this.event, receiptStatus.event);
  }

  @Override
  public int hashCode() {
    return Objects.hash(msgId, event);
  }
