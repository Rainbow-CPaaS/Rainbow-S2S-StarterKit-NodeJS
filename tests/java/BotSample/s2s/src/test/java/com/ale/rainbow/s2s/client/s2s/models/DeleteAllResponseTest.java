...
/**
 * Model tests for DeleteAllResponse
 */
public class DeleteAllResponseTest {
    private final DeleteAllResponse model = new DeleteAllResponse();
