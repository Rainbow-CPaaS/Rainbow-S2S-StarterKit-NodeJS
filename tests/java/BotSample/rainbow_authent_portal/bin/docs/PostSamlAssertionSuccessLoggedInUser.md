...
**phoneNumbers** | [**List&lt;PostSamlAssertionSuccessPhoneNumbers&gt;**](PostSamlAssertionSuccessPhoneNumbers.md) | Array of user phone numbers objects. &lt;br/&gt; Phone number objects can: &lt;ul&gt;     &lt;li&gt; be created by user (information filled by user),&lt;/li&gt;     &lt;li&gt; come from association with a system (pbx) device (association is done by admin).&lt;/li&gt; &lt;/ul&gt; | 
**emails** | [**List&lt;PostSamlAssertionSuccessEmails&gt;**](PostSamlAssertionSuccessEmails.md) | Array of user emails addresses objects | 
