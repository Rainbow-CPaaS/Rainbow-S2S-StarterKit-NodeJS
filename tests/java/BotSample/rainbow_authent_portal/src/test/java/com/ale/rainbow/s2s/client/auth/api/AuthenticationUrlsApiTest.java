...
/**
 * API tests for AuthenticationUrlsApi
 */
@Ignore
public class AuthenticationUrlsApiTest {

    private final AuthenticationUrlsApi api = new AuthenticationUrlsApi();
    ...
    public void getLoginUrlTest() throws ApiException {
        String uid = null;
        GetLoginUrlSuccess response = api.getLoginUrl(uid);
