...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ApiRainbowUcsV10ConnectionsRoommember();
  });
  ...
  describe('ApiRainbowUcsV10ConnectionsRoommember', function() {
    it('should create an instance of ApiRainbowUcsV10ConnectionsRoommember', function() {
      // uncomment below and update the code to test ApiRainbowUcsV10ConnectionsRoommember
      //var instance = new S2SApi.ApiRainbowUcsV10ConnectionsRoommember();
      //expect(instance).to.be.a(S2SApi.ApiRainbowUcsV10ConnectionsRoommember);
    });
