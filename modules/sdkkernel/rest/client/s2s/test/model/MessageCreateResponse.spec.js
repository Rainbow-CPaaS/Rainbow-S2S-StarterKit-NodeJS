...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.MessageCreateResponse();
  });
  ...
  describe('MessageCreateResponse', function() {
    it('should create an instance of MessageCreateResponse', function() {
      // uncomment below and update the code to test MessageCreateResponse
      //var instance = new S2SApi.MessageCreateResponse();
      //expect(instance).to.be.a(S2SApi.MessageCreateResponse);
    });
