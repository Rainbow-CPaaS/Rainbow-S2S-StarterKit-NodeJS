...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ApiRainbowUcsV10ConnectionsConnection();
  });
  ...
  describe('ApiRainbowUcsV10ConnectionsConnection', function() {
    it('should create an instance of ApiRainbowUcsV10ConnectionsConnection', function() {
      // uncomment below and update the code to test ApiRainbowUcsV10ConnectionsConnection
      //var instance = new S2SApi.ApiRainbowUcsV10ConnectionsConnection();
      //expect(instance).to.be.a(S2SApi.ApiRainbowUcsV10ConnectionsConnection);
    });
