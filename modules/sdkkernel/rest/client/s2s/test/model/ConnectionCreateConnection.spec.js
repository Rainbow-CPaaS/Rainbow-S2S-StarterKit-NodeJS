...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ConnectionCreateConnection();
  });
  ...
  describe('ConnectionCreateConnection', function() {
    it('should create an instance of ConnectionCreateConnection', function() {
      // uncomment below and update the code to test ConnectionCreateConnection
      //var instance = new S2SApi.ConnectionCreateConnection();
      //expect(instance).to.be.a(S2SApi.ConnectionCreateConnection);
    });
