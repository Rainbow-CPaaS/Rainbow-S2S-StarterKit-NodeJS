...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.DeleteAllResponseData();
  });
  ...
  describe('DeleteAllResponseData', function() {
    it('should create an instance of DeleteAllResponseData', function() {
      // uncomment below and update the code to test DeleteAllResponseData
      //var instance = new S2SApi.DeleteAllResponseData();
      //expect(instance).to.be.a(S2SApi.DeleteAllResponseData);
    });
