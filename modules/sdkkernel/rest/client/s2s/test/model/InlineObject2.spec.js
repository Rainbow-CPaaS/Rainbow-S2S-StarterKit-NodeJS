...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.InlineObject2();
  });
  ...
  describe('InlineObject2', function() {
    it('should create an instance of InlineObject2', function() {
      ...
      //var instance = new S2SApi.InlineObject2();
      //expect(instance).to.be.a(S2SApi.InlineObject2);
    });
    ...
    it('should have the property chatstate (base name: "chatstate")', function() {
      // uncomment below and update the code to test the property chatstate
      //var instance = new S2SApi.InlineObject2();
      //expect(instance).to.be();
    });
