...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ApiRainbowUcsV10ConnectionsMessageAttachment();
  });
  ...
  describe('ApiRainbowUcsV10ConnectionsMessageAttachment', function() {
    it('should create an instance of ApiRainbowUcsV10ConnectionsMessageAttachment', function() {
      // uncomment below and update the code to test ApiRainbowUcsV10ConnectionsMessageAttachment
      //var instance = new S2SApi.ApiRainbowUcsV10ConnectionsMessageAttachment();
      //expect(instance).to.be.a(S2SApi.ApiRainbowUcsV10ConnectionsMessageAttachment);
    });
