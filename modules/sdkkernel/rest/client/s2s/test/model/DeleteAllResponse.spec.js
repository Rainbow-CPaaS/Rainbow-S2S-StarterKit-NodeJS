...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.DeleteAllResponse();
  });
  ...
  describe('DeleteAllResponse', function() {
    it('should create an instance of DeleteAllResponse', function() {
      // uncomment below and update the code to test DeleteAllResponse
      //var instance = new S2SApi.DeleteAllResponse();
      //expect(instance).to.be.a(S2SApi.DeleteAllResponse);
    });
