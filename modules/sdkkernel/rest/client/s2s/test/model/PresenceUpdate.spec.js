...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.PresenceUpdate();
  });
  ...
  describe('PresenceUpdate', function() {
    it('should create an instance of PresenceUpdate', function() {
      // uncomment below and update the code to test PresenceUpdate
      //var instance = new S2SApi.PresenceUpdate();
      //expect(instance).to.be.a(S2SApi.PresenceUpdate);
    });
