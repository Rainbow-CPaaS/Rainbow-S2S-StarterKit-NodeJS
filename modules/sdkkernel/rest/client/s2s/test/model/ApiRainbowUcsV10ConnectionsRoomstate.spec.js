...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ApiRainbowUcsV10ConnectionsRoomstate();
  });
  ...
  describe('ApiRainbowUcsV10ConnectionsRoomstate', function() {
    it('should create an instance of ApiRainbowUcsV10ConnectionsRoomstate', function() {
      // uncomment below and update the code to test ApiRainbowUcsV10ConnectionsRoomstate
      //var instance = new S2SApi.ApiRainbowUcsV10ConnectionsRoomstate();
      //expect(instance).to.be.a(S2SApi.ApiRainbowUcsV10ConnectionsRoomstate);
    });
