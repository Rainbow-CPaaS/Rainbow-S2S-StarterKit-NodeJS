...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.MessageCreateMessage();
  });
  ...
  describe('MessageCreateMessage', function() {
    it('should create an instance of MessageCreateMessage', function() {
      // uncomment below and update the code to test MessageCreateMessage
      //var instance = new S2SApi.MessageCreateMessage();
      //expect(instance).to.be.a(S2SApi.MessageCreateMessage);
    });
