...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.InlineObject7();
  });
  ...
  describe('InlineObject7', function() {
    it('should create an instance of InlineObject7', function() {
      ...
      //var instance = new S2SApi.InlineObject7();
      //expect(instance).to.be.a(S2SApi.InlineObject7);
    });
    ...
    it('should have the property roomMember (base name: "room-member")', function() {
      // uncomment below and update the code to test the property roomMember
      //var instance = new S2SApi.InlineObject7();
      //expect(instance).to.be();
    });
