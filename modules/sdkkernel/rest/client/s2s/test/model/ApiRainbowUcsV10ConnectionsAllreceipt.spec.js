...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ApiRainbowUcsV10ConnectionsAllreceipt();
  });
  ...
  describe('ApiRainbowUcsV10ConnectionsAllreceipt', function() {
    it('should create an instance of ApiRainbowUcsV10ConnectionsAllreceipt', function() {
      // uncomment below and update the code to test ApiRainbowUcsV10ConnectionsAllreceipt
      //var instance = new S2SApi.ApiRainbowUcsV10ConnectionsAllreceipt();
      //expect(instance).to.be.a(S2SApi.ApiRainbowUcsV10ConnectionsAllreceipt);
    });
