...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ApiRainbowUcsV10ConnectionsReceipt();
  });
  ...
  describe('ApiRainbowUcsV10ConnectionsReceipt', function() {
    it('should create an instance of ApiRainbowUcsV10ConnectionsReceipt', function() {
      // uncomment below and update the code to test ApiRainbowUcsV10ConnectionsReceipt
      //var instance = new S2SApi.ApiRainbowUcsV10ConnectionsReceipt();
      //expect(instance).to.be.a(S2SApi.ApiRainbowUcsV10ConnectionsReceipt);
    });
