...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.MessageCreateResponseData();
  });
  ...
  describe('MessageCreateResponseData', function() {
    it('should create an instance of MessageCreateResponseData', function() {
      // uncomment below and update the code to test MessageCreateResponseData
      //var instance = new S2SApi.MessageCreateResponseData();
      //expect(instance).to.be.a(S2SApi.MessageCreateResponseData);
    });
