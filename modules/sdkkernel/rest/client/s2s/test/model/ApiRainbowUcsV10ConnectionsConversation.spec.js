...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ApiRainbowUcsV10ConnectionsConversation();
  });
  ...
  describe('ApiRainbowUcsV10ConnectionsConversation', function() {
    it('should create an instance of ApiRainbowUcsV10ConnectionsConversation', function() {
      // uncomment below and update the code to test ApiRainbowUcsV10ConnectionsConversation
      //var instance = new S2SApi.ApiRainbowUcsV10ConnectionsConversation();
      //expect(instance).to.be.a(S2SApi.ApiRainbowUcsV10ConnectionsConversation);
    });
