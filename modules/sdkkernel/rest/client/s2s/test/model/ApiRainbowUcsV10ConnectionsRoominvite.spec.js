...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ApiRainbowUcsV10ConnectionsRoominvite();
  });
  ...
  describe('ApiRainbowUcsV10ConnectionsRoominvite', function() {
    it('should create an instance of ApiRainbowUcsV10ConnectionsRoominvite', function() {
      // uncomment below and update the code to test ApiRainbowUcsV10ConnectionsRoominvite
      //var instance = new S2SApi.ApiRainbowUcsV10ConnectionsRoominvite();
      //expect(instance).to.be.a(S2SApi.ApiRainbowUcsV10ConnectionsRoominvite);
    });
