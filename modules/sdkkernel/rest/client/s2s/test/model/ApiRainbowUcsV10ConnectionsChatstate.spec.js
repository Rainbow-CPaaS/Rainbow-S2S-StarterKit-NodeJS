...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ApiRainbowUcsV10ConnectionsChatstate();
  });
  ...
  describe('ApiRainbowUcsV10ConnectionsChatstate', function() {
    it('should create an instance of ApiRainbowUcsV10ConnectionsChatstate', function() {
      // uncomment below and update the code to test ApiRainbowUcsV10ConnectionsChatstate
      //var instance = new S2SApi.ApiRainbowUcsV10ConnectionsChatstate();
      //expect(instance).to.be.a(S2SApi.ApiRainbowUcsV10ConnectionsChatstate);
    });
