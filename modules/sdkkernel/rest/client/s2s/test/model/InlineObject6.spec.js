...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.InlineObject6();
  });
  ...
  describe('InlineObject6', function() {
    it('should create an instance of InlineObject6', function() {
      ...
      //var instance = new S2SApi.InlineObject6();
      //expect(instance).to.be.a(S2SApi.InlineObject6);
    });
    ...
    it('should have the property roomInvite (base name: "room-invite")', function() {
      // uncomment below and update the code to test the property roomInvite
      //var instance = new S2SApi.InlineObject6();
      //expect(instance).to.be();
    });
