...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ConnectionCreateResponse();
  });
  ...
  describe('ConnectionCreateResponse', function() {
    it('should create an instance of ConnectionCreateResponse', function() {
      // uncomment below and update the code to test ConnectionCreateResponse
      //var instance = new S2SApi.ConnectionCreateResponse();
      //expect(instance).to.be.a(S2SApi.ConnectionCreateResponse);
    });
