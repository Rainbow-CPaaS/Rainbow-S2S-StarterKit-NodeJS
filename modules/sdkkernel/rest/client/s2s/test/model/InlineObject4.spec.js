...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.InlineObject4();
  });
  ...
  describe('InlineObject4', function() {
    it('should create an instance of InlineObject4', function() {
      ...
      //var instance = new S2SApi.InlineObject4();
      //expect(instance).to.be.a(S2SApi.InlineObject4);
    });
    ...
    it('should have the property allReceipt (base name: "all-receipt")', function() {
      // uncomment below and update the code to test the property allReceipt
      //var instance = new S2SApi.InlineObject4();
      //expect(instance).to.be();
    });
