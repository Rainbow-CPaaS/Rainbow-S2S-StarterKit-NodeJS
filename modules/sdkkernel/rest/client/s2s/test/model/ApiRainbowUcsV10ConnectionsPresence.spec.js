...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ApiRainbowUcsV10ConnectionsPresence();
  });
  ...
  describe('ApiRainbowUcsV10ConnectionsPresence', function() {
    it('should create an instance of ApiRainbowUcsV10ConnectionsPresence', function() {
      // uncomment below and update the code to test ApiRainbowUcsV10ConnectionsPresence
      //var instance = new S2SApi.ApiRainbowUcsV10ConnectionsPresence();
      //expect(instance).to.be.a(S2SApi.ApiRainbowUcsV10ConnectionsPresence);
    });
