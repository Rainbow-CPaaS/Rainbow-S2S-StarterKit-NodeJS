...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ConversationCreateConversation();
  });
  ...
  describe('ConversationCreateConversation', function() {
    it('should create an instance of ConversationCreateConversation', function() {
      // uncomment below and update the code to test ConversationCreateConversation
      //var instance = new S2SApi.ConversationCreateConversation();
      //expect(instance).to.be.a(S2SApi.ConversationCreateConversation);
    });
