...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ConnectionCreateResponseData();
  });
  ...
  describe('ConnectionCreateResponseData', function() {
    it('should create an instance of ConnectionCreateResponseData', function() {
      // uncomment below and update the code to test ConnectionCreateResponseData
      //var instance = new S2SApi.ConnectionCreateResponseData();
      //expect(instance).to.be.a(S2SApi.ConnectionCreateResponseData);
    });
