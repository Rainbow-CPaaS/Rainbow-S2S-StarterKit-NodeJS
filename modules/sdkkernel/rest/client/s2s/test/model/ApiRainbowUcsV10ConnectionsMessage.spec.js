...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ApiRainbowUcsV10ConnectionsMessage();
  });
  ...
  describe('ApiRainbowUcsV10ConnectionsMessage', function() {
    it('should create an instance of ApiRainbowUcsV10ConnectionsMessage', function() {
      // uncomment below and update the code to test ApiRainbowUcsV10ConnectionsMessage
      //var instance = new S2SApi.ApiRainbowUcsV10ConnectionsMessage();
      //expect(instance).to.be.a(S2SApi.ApiRainbowUcsV10ConnectionsMessage);
    });
