...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.ApiRainbowUcsV10ConnectionsError();
  });
  ...
  describe('ApiRainbowUcsV10ConnectionsError', function() {
    it('should create an instance of ApiRainbowUcsV10ConnectionsError', function() {
      // uncomment below and update the code to test ApiRainbowUcsV10ConnectionsError
      //var instance = new S2SApi.ApiRainbowUcsV10ConnectionsError();
      //expect(instance).to.be.a(S2SApi.ApiRainbowUcsV10ConnectionsError);
    });
