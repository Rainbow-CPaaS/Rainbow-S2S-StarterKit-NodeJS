...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.InlineObject8();
  });
  ...
  describe('InlineObject8', function() {
    it('should create an instance of InlineObject8', function() {
      ...
      //var instance = new S2SApi.InlineObject8();
      //expect(instance).to.be.a(S2SApi.InlineObject8);
    });
    ...
    it('should have the property roomState (base name: "room-state")', function() {
      // uncomment below and update the code to test the property roomState
      //var instance = new S2SApi.InlineObject8();
      //expect(instance).to.be();
    });
