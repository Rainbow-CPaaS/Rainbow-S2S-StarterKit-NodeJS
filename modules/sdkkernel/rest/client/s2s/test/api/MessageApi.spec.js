...
(function(root, factory) {
  ...
  describe('MessageApi', function() {
    describe('messageCreate', function() {
      it('should call messageCreate successfully', function(done) {
        //uncomment below and update the code to test messageCreate
        //instance.messageCreate(function(error) {
    ...
    describe('messageIndex', function() {
      it('should call messageIndex successfully', function(done) {
        //uncomment below and update the code to test messageIndex
        //instance.messageIndex(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('messageReadReceipt', function() {
      it('should call messageReadReceipt successfully', function(done) {
        //uncomment below and update the code to test messageReadReceipt
        //instance.messageReadReceipt(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('messageReceivedReceipt', function() {
      it('should call messageReceivedReceipt successfully', function(done) {
        //uncomment below and update the code to test messageReceivedReceipt
        //instance.messageReceivedReceipt(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
