...
(function(root, factory) {
  ...
  describe('ConnectionApi', function() {
    describe('connectionCreate', function() {
      it('should call connectionCreate successfully', function(done) {
        //uncomment below and update the code to test connectionCreate
        //instance.connectionCreate(function(error) {
    ...
    describe('connectionIndex', function() {
      it('should call connectionIndex successfully', function(done) {
        //uncomment below and update the code to test connectionIndex
        //instance.connectionIndex(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('connectionShow', function() {
      it('should call connectionShow successfully', function(done) {
        //uncomment below and update the code to test connectionShow
        //instance.connectionShow(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
