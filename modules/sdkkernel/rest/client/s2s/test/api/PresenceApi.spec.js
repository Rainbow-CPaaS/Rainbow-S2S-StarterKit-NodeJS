...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new S2SApi.PresenceApi();
  });
  ...
  describe('PresenceApi', function() {
    describe('s2SPhxWebPresenceControllerShow', function() {
      it('should call s2SPhxWebPresenceControllerShow successfully', function(done) {
        //uncomment below and update the code to test s2SPhxWebPresenceControllerShow
        //instance.s2SPhxWebPresenceControllerShow(function(error) {
    ...
    describe('s2SPhxWebPresenceControllerUpdate', function() {
      it('should call s2SPhxWebPresenceControllerUpdate successfully', function(done) {
        //uncomment below and update the code to test s2SPhxWebPresenceControllerUpdate
        //instance.s2SPhxWebPresenceControllerUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
