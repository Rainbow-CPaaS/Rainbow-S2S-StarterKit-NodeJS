...
(function(root, factory) {
  ...
  describe('PresenceApi', function() {
    describe('presenceShow', function() {
      it('should call presenceShow successfully', function(done) {
        //uncomment below and update the code to test presenceShow
        //instance.presenceShow(function(error) {
    ...
    describe('presenceUpdate', function() {
      it('should call presenceUpdate successfully', function(done) {
        //uncomment below and update the code to test presenceUpdate
        //instance.presenceUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
