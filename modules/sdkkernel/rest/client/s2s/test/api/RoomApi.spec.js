...
(function(root, factory) {
  ...
  describe('RoomApi', function() {
    describe('s2SPhxWebRoomControllerJoin', function() {
      it('should call s2SPhxWebRoomControllerJoin successfully', function(done) {
        //uncomment below and update the code to test s2SPhxWebRoomControllerJoin
        //instance.s2SPhxWebRoomControllerJoin(function(error) {
