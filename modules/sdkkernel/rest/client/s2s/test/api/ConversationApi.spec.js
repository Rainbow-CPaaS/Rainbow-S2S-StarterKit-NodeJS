...
(function(root, factory) {
  ...
  describe('ConversationApi', function() {
    describe('conversationChatstate', function() {
      it('should call conversationChatstate successfully', function(done) {
        //uncomment below and update the code to test conversationChatstate
        //instance.conversationChatstate(function(error) {
    ...
    describe('conversationCreate', function() {
      it('should call conversationCreate successfully', function(done) {
        //uncomment below and update the code to test conversationCreate
        //instance.conversationCreate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('conversationDelete', function() {
      it('should call conversationDelete successfully', function(done) {
        //uncomment below and update the code to test conversationDelete
        //instance.conversationDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('conversationIndex', function() {
      it('should call conversationIndex successfully', function(done) {
        //uncomment below and update the code to test conversationIndex
        //instance.conversationIndex(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('conversationShow', function() {
      it('should call conversationShow successfully', function(done) {
        //uncomment below and update the code to test conversationShow
        //instance.conversationShow(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
