...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiRainbowUcsV10ConnectionsConnection'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiRainbowUcsV10ConnectionsConnection'));
  } else {
    // Browser globals (root is window)
    if (!root.S2SApi) {
      root.S2SApi = {};
    }
    root.S2SApi.InlineObject = factory(root.S2SApi.ApiClient, root.S2SApi.ApiRainbowUcsV10ConnectionsConnection);
  }
}(this, function(ApiClient, ApiRainbowUcsV10ConnectionsConnection) {
  'use strict';
   ...
   * @param connection {module:model/ApiRainbowUcsV10ConnectionsConnection} 
   */
  var exports = function(id, timestamp, connection) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('connection')) {
        obj['connection'] = ApiRainbowUcsV10ConnectionsConnection.constructFromObject(data['connection']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ApiRainbowUcsV10ConnectionsConnection} connection
   */
