...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S2SApi.ApiRainbowUcsV10ConnectionsRoominvite = factory(root.S2SApi.ApiClient);
  }
  ...
  /**
   * The ApiRainbowUcsV10ConnectionsRoominvite model module.
   * @module model/ApiRainbowUcsV10ConnectionsRoominvite
   * @version 1.99.0
   */

  /**
   * Constructs a new <code>ApiRainbowUcsV10ConnectionsRoominvite</code>.
   * @alias module:model/ApiRainbowUcsV10ConnectionsRoominvite
   * @class
   * @param id {String} the room Id
   * @param by {String} the inviting user Id
   * @param name {String} the room name
   */
  var exports = function(id, by, name) {
    var _this = this;
  ...
  /**
   * Constructs a <code>ApiRainbowUcsV10ConnectionsRoominvite</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ApiRainbowUcsV10ConnectionsRoominvite} obj Optional instance to populate.
   * @return {module:model/ApiRainbowUcsV10ConnectionsRoominvite} The populated <code>ApiRainbowUcsV10ConnectionsRoominvite</code> instance.
   */
