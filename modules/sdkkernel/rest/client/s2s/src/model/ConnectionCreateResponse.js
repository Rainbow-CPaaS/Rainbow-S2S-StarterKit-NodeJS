...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConnectionCreateResponseData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConnectionCreateResponseData'));
  } else {
    // Browser globals (root is window)
    if (!root.S2SApi) {
      root.S2SApi = {};
    }
    root.S2SApi.ConnectionCreateResponse = factory(root.S2SApi.ApiClient, root.S2SApi.ConnectionCreateResponseData);
  }
}(this, function(ApiClient, ConnectionCreateResponseData) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = ConnectionCreateResponseData.constructFromObject(data['data']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ConnectionCreateResponseData} data
   */
