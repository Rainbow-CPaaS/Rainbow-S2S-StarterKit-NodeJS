...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiRainbowUcsV10ConnectionsMessage'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiRainbowUcsV10ConnectionsMessage'));
  } else {
    // Browser globals (root is window)
    if (!root.S2SApi) {
      root.S2SApi = {};
    }
    root.S2SApi.InlineObject10 = factory(root.S2SApi.ApiClient, root.S2SApi.ApiRainbowUcsV10ConnectionsMessage);
  }
}(this, function(ApiClient, ApiRainbowUcsV10ConnectionsMessage) {
  'use strict';
   ...
   * @param message {module:model/ApiRainbowUcsV10ConnectionsMessage} 
   */
  var exports = function(id, timestamp, message) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('message')) {
        obj['message'] = ApiRainbowUcsV10ConnectionsMessage.constructFromObject(data['message']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ApiRainbowUcsV10ConnectionsMessage} message
   */
