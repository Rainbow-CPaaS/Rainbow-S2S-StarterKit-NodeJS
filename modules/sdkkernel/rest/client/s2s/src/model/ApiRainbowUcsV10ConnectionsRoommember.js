...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S2SApi.ApiRainbowUcsV10ConnectionsRoommember = factory(root.S2SApi.ApiClient);
  }
  ...
  /**
   * The ApiRainbowUcsV10ConnectionsRoommember model module.
   * @module model/ApiRainbowUcsV10ConnectionsRoommember
   * @version 1.99.0
   */

  /**
   * Constructs a new <code>ApiRainbowUcsV10ConnectionsRoommember</code>.
   * @alias module:model/ApiRainbowUcsV10ConnectionsRoommember
   * @class
   * @param id {String} the room Id
   * @param user {String} the user Id
   * @param status {module:model/ApiRainbowUcsV10ConnectionsRoommember.StatusEnum} the member status
   */
  var exports = function(id, user, status) {
    var _this = this;
  ...
  /**
   * Constructs a <code>ApiRainbowUcsV10ConnectionsRoommember</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ApiRainbowUcsV10ConnectionsRoommember} obj Optional instance to populate.
   * @return {module:model/ApiRainbowUcsV10ConnectionsRoommember} The populated <code>ApiRainbowUcsV10ConnectionsRoommember</code> instance.
   */
  ...
  /**
   * the member status
   * @member {module:model/ApiRainbowUcsV10ConnectionsRoommember.StatusEnum} status
   */
