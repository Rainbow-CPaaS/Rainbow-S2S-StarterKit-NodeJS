...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S2SApi.ApiRainbowUcsV10ConnectionsMessageAttachment = factory(root.S2SApi.ApiClient);
  }
  ...
  /**
   * The ApiRainbowUcsV10ConnectionsMessageAttachment model module.
   * @module model/ApiRainbowUcsV10ConnectionsMessageAttachment
   * @version 1.99.0
   */

  /**
   * Constructs a new <code>ApiRainbowUcsV10ConnectionsMessageAttachment</code>.
   * @alias module:model/ApiRainbowUcsV10ConnectionsMessageAttachment
   * @class
   */
  ...
  /**
   * Constructs a <code>ApiRainbowUcsV10ConnectionsMessageAttachment</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ApiRainbowUcsV10ConnectionsMessageAttachment} obj Optional instance to populate.
   * @return {module:model/ApiRainbowUcsV10ConnectionsMessageAttachment} The populated <code>ApiRainbowUcsV10ConnectionsMessageAttachment</code> instance.
   */
