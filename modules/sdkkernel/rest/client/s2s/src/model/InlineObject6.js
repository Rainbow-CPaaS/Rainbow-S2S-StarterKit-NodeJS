...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiRainbowUcsV10ConnectionsRoominvite'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiRainbowUcsV10ConnectionsRoominvite'));
  } else {
    // Browser globals (root is window)
    if (!root.S2SApi) {
      root.S2SApi = {};
    }
    root.S2SApi.InlineObject6 = factory(root.S2SApi.ApiClient, root.S2SApi.ApiRainbowUcsV10ConnectionsRoominvite);
  }
}(this, function(ApiClient, ApiRainbowUcsV10ConnectionsRoominvite) {
  'use strict';
   ...
   * @param roomInvite {module:model/ApiRainbowUcsV10ConnectionsRoominvite} 
   */
  var exports = function(id, timestamp, roomInvite) {
    var _this = this;

    _this['id'] = id;
    _this['timestamp'] = timestamp;
    _this['room-invite'] = roomInvite;
  };
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('room-invite')) {
        obj['room-invite'] = ApiRainbowUcsV10ConnectionsRoominvite.constructFromObject(data['room-invite']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ApiRainbowUcsV10ConnectionsRoominvite} room-invite
   */
  exports.prototype['room-invite'] = undefined;
