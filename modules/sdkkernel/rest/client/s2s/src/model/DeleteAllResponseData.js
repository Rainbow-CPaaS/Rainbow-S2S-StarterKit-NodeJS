...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S2SApi.DeleteAllResponseData = factory(root.S2SApi.ApiClient);
  }
  ...
  /**
   * The DeleteAllResponseData model module.
   * @module model/DeleteAllResponseData
   * @version 1.104.0
   */

  /**
   * Constructs a new <code>DeleteAllResponseData</code>.
   * @alias module:model/DeleteAllResponseData
   * @class
   */
  ...
  /**
   * Constructs a <code>DeleteAllResponseData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeleteAllResponseData} obj Optional instance to populate.
   * @return {module:model/DeleteAllResponseData} The populated <code>DeleteAllResponseData</code> instance.
   */
