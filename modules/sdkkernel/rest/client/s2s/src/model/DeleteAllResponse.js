...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DeleteAllResponseData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DeleteAllResponseData'));
  } else {
    // Browser globals (root is window)
    if (!root.S2SApi) {
      root.S2SApi = {};
    }
    root.S2SApi.DeleteAllResponse = factory(root.S2SApi.ApiClient, root.S2SApi.DeleteAllResponseData);
  }
}(this, function(ApiClient, DeleteAllResponseData) {
  'use strict';



  /**
   * The DeleteAllResponse model module.
   * @module model/DeleteAllResponse
   * @version 1.104.0
   */

  /**
   * Constructs a new <code>DeleteAllResponse</code>.
   * @alias module:model/DeleteAllResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>DeleteAllResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeleteAllResponse} obj Optional instance to populate.
   * @return {module:model/DeleteAllResponse} The populated <code>DeleteAllResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('data')) {
        obj['data'] = DeleteAllResponseData.constructFromObject(data['data']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/DeleteAllResponseData} data
   */
