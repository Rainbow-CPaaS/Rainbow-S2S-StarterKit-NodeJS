...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MessageCreateResponseData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MessageCreateResponseData'));
  } else {
    // Browser globals (root is window)
    if (!root.S2SApi) {
      root.S2SApi = {};
    }
    root.S2SApi.MessageCreateResponse = factory(root.S2SApi.ApiClient, root.S2SApi.MessageCreateResponseData);
  }
}(this, function(ApiClient, MessageCreateResponseData) {
  'use strict';



  /**
   * The MessageCreateResponse model module.
   * @module model/MessageCreateResponse
   * @version 1.99.0
   */

  /**
   * Constructs a new <code>MessageCreateResponse</code>.
   * @alias module:model/MessageCreateResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>MessageCreateResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MessageCreateResponse} obj Optional instance to populate.
   * @return {module:model/MessageCreateResponse} The populated <code>MessageCreateResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('data')) {
        obj['data'] = MessageCreateResponseData.constructFromObject(data['data']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/MessageCreateResponseData} data
   */
