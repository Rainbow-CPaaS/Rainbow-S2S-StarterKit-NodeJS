...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiRainbowUcsV10ConnectionsRoomstate'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiRainbowUcsV10ConnectionsRoomstate'));
  } else {
    // Browser globals (root is window)
    if (!root.S2SApi) {
      root.S2SApi = {};
    }
    root.S2SApi.InlineObject8 = factory(root.S2SApi.ApiClient, root.S2SApi.ApiRainbowUcsV10ConnectionsRoomstate);
  }
}(this, function(ApiClient, ApiRainbowUcsV10ConnectionsRoomstate) {
  'use strict';
   ...
   * @param roomState {module:model/ApiRainbowUcsV10ConnectionsRoomstate} 
   */
  var exports = function(id, timestamp, roomState) {
    var _this = this;

    _this['id'] = id;
    _this['timestamp'] = timestamp;
    _this['room-state'] = roomState;
  };
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('room-state')) {
        obj['room-state'] = ApiRainbowUcsV10ConnectionsRoomstate.constructFromObject(data['room-state']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ApiRainbowUcsV10ConnectionsRoomstate} room-state
   */
  exports.prototype['room-state'] = undefined;
