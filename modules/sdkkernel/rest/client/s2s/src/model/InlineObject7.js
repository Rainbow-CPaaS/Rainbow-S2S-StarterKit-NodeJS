...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiRainbowUcsV10ConnectionsRoommember'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiRainbowUcsV10ConnectionsRoommember'));
  } else {
    // Browser globals (root is window)
    if (!root.S2SApi) {
      root.S2SApi = {};
    }
    root.S2SApi.InlineObject7 = factory(root.S2SApi.ApiClient, root.S2SApi.ApiRainbowUcsV10ConnectionsRoommember);
  }
}(this, function(ApiClient, ApiRainbowUcsV10ConnectionsRoommember) {
  'use strict';
   ...
   * @param roomMember {module:model/ApiRainbowUcsV10ConnectionsRoommember} 
   */
  var exports = function(id, timestamp, roomMember) {
    var _this = this;

    _this['id'] = id;
    _this['timestamp'] = timestamp;
    _this['room-member'] = roomMember;
  };
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('room-member')) {
        obj['room-member'] = ApiRainbowUcsV10ConnectionsRoommember.constructFromObject(data['room-member']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ApiRainbowUcsV10ConnectionsRoommember} room-member
   */
  exports.prototype['room-member'] = undefined;
