...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiRainbowUcsV10ConnectionsAllreceipt'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiRainbowUcsV10ConnectionsAllreceipt'));
  } else {
    // Browser globals (root is window)
    if (!root.S2SApi) {
      root.S2SApi = {};
    }
    root.S2SApi.InlineObject4 = factory(root.S2SApi.ApiClient, root.S2SApi.ApiRainbowUcsV10ConnectionsAllreceipt);
  }
}(this, function(ApiClient, ApiRainbowUcsV10ConnectionsAllreceipt) {
  'use strict';
   ...
   * @param allReceipt {module:model/ApiRainbowUcsV10ConnectionsAllreceipt} 
   */
  var exports = function(id, timestamp, allReceipt) {
    var _this = this;

    _this['id'] = id;
    _this['timestamp'] = timestamp;
    _this['all-receipt'] = allReceipt;
  };
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('all-receipt')) {
        obj['all-receipt'] = ApiRainbowUcsV10ConnectionsAllreceipt.constructFromObject(data['all-receipt']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ApiRainbowUcsV10ConnectionsAllreceipt} all-receipt
   */
  exports.prototype['all-receipt'] = undefined;
