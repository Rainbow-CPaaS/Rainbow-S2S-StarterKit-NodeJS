...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S2SApi.ConversationCreateConversation = factory(root.S2SApi.ApiClient);
  }
  ...
  /**
   * The ConversationCreateConversation model module.
   * @module model/ConversationCreateConversation
   * @version 1.99.0
   */

  /**
   * Constructs a new <code>ConversationCreateConversation</code>.
   * Conversation object
   * @alias module:model/ConversationCreateConversation
   * @class
   */
  ...
  /**
   * Constructs a <code>ConversationCreateConversation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConversationCreateConversation} obj Optional instance to populate.
   * @return {module:model/ConversationCreateConversation} The populated <code>ConversationCreateConversation</code> instance.
   */
   ...
   * @member {module:model/ConversationCreateConversation.TypeEnum} type
   */
