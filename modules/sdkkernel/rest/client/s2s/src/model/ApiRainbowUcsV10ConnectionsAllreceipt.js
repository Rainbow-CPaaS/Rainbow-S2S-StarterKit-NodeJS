...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.S2SApi.ApiRainbowUcsV10ConnectionsAllreceipt = factory(root.S2SApi.ApiClient);
  }
  ...
  /**
   * The ApiRainbowUcsV10ConnectionsAllreceipt model module.
   * @module model/ApiRainbowUcsV10ConnectionsAllreceipt
   * @version 1.99.0
   */

  /**
   * Constructs a new <code>ApiRainbowUcsV10ConnectionsAllreceipt</code>.
   * @alias module:model/ApiRainbowUcsV10ConnectionsAllreceipt
   * @class
   * @param id {module:model/ApiRainbowUcsV10ConnectionsAllreceipt.IdEnum} Receipt applies to 'sent' or 'received' messages
   * @param conversationId {String} 
   * @param _with {String} 
   */
  var exports = function(id, conversationId, _with) {
    var _this = this;
  ...
  /**
   * Constructs a <code>ApiRainbowUcsV10ConnectionsAllreceipt</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ApiRainbowUcsV10ConnectionsAllreceipt} obj Optional instance to populate.
   * @return {module:model/ApiRainbowUcsV10ConnectionsAllreceipt} The populated <code>ApiRainbowUcsV10ConnectionsAllreceipt</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('with')) {
        obj['with'] = ApiClient.convertToType(data['with'], 'String');
      }
    }
    return obj;
  }
   ...
   * @member {module:model/ApiRainbowUcsV10ConnectionsAllreceipt.IdEnum} id
   */
   ...
   * @member {String} with
   */
  exports.prototype['with'] = undefined;
