...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiRainbowUcsV10ConnectionsChatstate'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiRainbowUcsV10ConnectionsChatstate'));
  } else {
    // Browser globals (root is window)
    if (!root.S2SApi) {
      root.S2SApi = {};
    }
    root.S2SApi.InlineObject2 = factory(root.S2SApi.ApiClient, root.S2SApi.ApiRainbowUcsV10ConnectionsChatstate);
  }
}(this, function(ApiClient, ApiRainbowUcsV10ConnectionsChatstate) {
  'use strict';
   ...
   * @param chatstate {module:model/ApiRainbowUcsV10ConnectionsChatstate} 
   */
  var exports = function(id, timestamp, chatstate) {
    var _this = this;

    _this['id'] = id;
    _this['timestamp'] = timestamp;
    _this['chatstate'] = chatstate;
  };
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('chatstate')) {
        obj['chatstate'] = ApiRainbowUcsV10ConnectionsChatstate.constructFromObject(data['chatstate']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ApiRainbowUcsV10ConnectionsChatstate} chatstate
   */
  exports.prototype['chatstate'] = undefined;
