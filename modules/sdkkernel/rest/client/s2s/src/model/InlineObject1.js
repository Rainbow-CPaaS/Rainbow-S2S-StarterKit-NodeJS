...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiRainbowUcsV10ConnectionsPresence'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiRainbowUcsV10ConnectionsPresence'));
  } else {
    // Browser globals (root is window)
    if (!root.S2SApi) {
      root.S2SApi = {};
    }
    root.S2SApi.InlineObject1 = factory(root.S2SApi.ApiClient, root.S2SApi.ApiRainbowUcsV10ConnectionsPresence);
  }
}(this, function(ApiClient, ApiRainbowUcsV10ConnectionsPresence) {
  'use strict';
   ...
   * @param presence {module:model/ApiRainbowUcsV10ConnectionsPresence} 
   */
  var exports = function(id, timestamp, presence) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('presence')) {
        obj['presence'] = ApiRainbowUcsV10ConnectionsPresence.constructFromObject(data['presence']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ApiRainbowUcsV10ConnectionsPresence} presence
   */
