...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowApplicationPortal.ApplicationsApplicationsPostApps();
  });
  ...
  describe('ApplicationsApplicationsPostApps', function() {
    it('should create an instance of ApplicationsApplicationsPostApps', function() {
      // uncomment below and update the code to test ApplicationsApplicationsPostApps
      //var instance = new RainbowApplicationPortal.ApplicationsApplicationsPostApps();
      //expect(instance).to.be.a(RainbowApplicationPortal.ApplicationsApplicationsPostApps);
    });
