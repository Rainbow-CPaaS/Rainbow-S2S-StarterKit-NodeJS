...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowApplicationPortal.ApplicationsDevelopersPostConfirmSuccess();
  });
  ...
  describe('ApplicationsDevelopersPostConfirmSuccess', function() {
    it('should create an instance of ApplicationsDevelopersPostConfirmSuccess', function() {
      // uncomment below and update the code to test ApplicationsDevelopersPostConfirmSuccess
      //var instance = new RainbowApplicationPortal.ApplicationsDevelopersPostConfirmSuccess();
      //expect(instance).to.be.a(RainbowApplicationPortal.ApplicationsDevelopersPostConfirmSuccess);
    });
