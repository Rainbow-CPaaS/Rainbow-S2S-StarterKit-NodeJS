...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowApplicationPortal.ApplicationsDevelopersPostConfirm();
  });
  ...
  describe('ApplicationsDevelopersPostConfirm', function() {
    it('should create an instance of ApplicationsDevelopersPostConfirm', function() {
      // uncomment below and update the code to test ApplicationsDevelopersPostConfirm
      //var instance = new RainbowApplicationPortal.ApplicationsDevelopersPostConfirm();
      //expect(instance).to.be.a(RainbowApplicationPortal.ApplicationsDevelopersPostConfirm);
    });
