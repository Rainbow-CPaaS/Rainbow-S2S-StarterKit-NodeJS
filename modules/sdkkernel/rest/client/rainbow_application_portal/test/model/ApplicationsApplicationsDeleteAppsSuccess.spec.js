...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowApplicationPortal.ApplicationsApplicationsDeleteAppsSuccess();
  });
  ...
  describe('ApplicationsApplicationsDeleteAppsSuccess', function() {
    it('should create an instance of ApplicationsApplicationsDeleteAppsSuccess', function() {
      // uncomment below and update the code to test ApplicationsApplicationsDeleteAppsSuccess
      //var instance = new RainbowApplicationPortal.ApplicationsApplicationsDeleteAppsSuccess();
      //expect(instance).to.be.a(RainbowApplicationPortal.ApplicationsApplicationsDeleteAppsSuccess);
    });
