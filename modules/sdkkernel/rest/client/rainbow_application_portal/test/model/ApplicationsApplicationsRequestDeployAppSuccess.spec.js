...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowApplicationPortal.ApplicationsApplicationsRequestDeployAppSuccess();
  });
  ...
  describe('ApplicationsApplicationsRequestDeployAppSuccess', function() {
    it('should create an instance of ApplicationsApplicationsRequestDeployAppSuccess', function() {
      // uncomment below and update the code to test ApplicationsApplicationsRequestDeployAppSuccess
      //var instance = new RainbowApplicationPortal.ApplicationsApplicationsRequestDeployAppSuccess();
      //expect(instance).to.be.a(RainbowApplicationPortal.ApplicationsApplicationsRequestDeployAppSuccess);
    });
