...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowApplicationPortal.ApplicationsDevelopersPostConfirmSuccessData();
  });
  ...
  describe('ApplicationsDevelopersPostConfirmSuccessData', function() {
    it('should create an instance of ApplicationsDevelopersPostConfirmSuccessData', function() {
      // uncomment below and update the code to test ApplicationsDevelopersPostConfirmSuccessData
      //var instance = new RainbowApplicationPortal.ApplicationsDevelopersPostConfirmSuccessData();
      //expect(instance).to.be.a(RainbowApplicationPortal.ApplicationsDevelopersPostConfirmSuccessData);
    });
