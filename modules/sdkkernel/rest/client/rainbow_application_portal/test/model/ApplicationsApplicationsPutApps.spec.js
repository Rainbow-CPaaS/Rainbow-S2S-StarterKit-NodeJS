...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowApplicationPortal.ApplicationsApplicationsPutApps();
  });
  ...
  describe('ApplicationsApplicationsPutApps', function() {
    it('should create an instance of ApplicationsApplicationsPutApps', function() {
      // uncomment below and update the code to test ApplicationsApplicationsPutApps
      //var instance = new RainbowApplicationPortal.ApplicationsApplicationsPutApps();
      //expect(instance).to.be.a(RainbowApplicationPortal.ApplicationsApplicationsPutApps);
    });
    ...
    it('should have the property refreshAppSecret (base name: "refreshAppSecret")', function() {
      // uncomment below and update the code to test the property refreshAppSecret
      //var instance = new RainbowApplicationPortal.ApplicationsApplicationsPutApps();
      //expect(instance).to.be();
    });
