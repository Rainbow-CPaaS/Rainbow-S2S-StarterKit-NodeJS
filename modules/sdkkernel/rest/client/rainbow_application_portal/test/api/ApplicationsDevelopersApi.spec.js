...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowApplicationPortal.ApplicationsDevelopersApi();
  });
  ...
  describe('ApplicationsDevelopersApi', function() {
    describe('applicationsDevelopersPostConfirm', function() {
      it('should call applicationsDevelopersPostConfirm successfully', function(done) {
        //uncomment below and update the code to test applicationsDevelopersPostConfirm
        //instance.applicationsDevelopersPostConfirm(function(error) {
