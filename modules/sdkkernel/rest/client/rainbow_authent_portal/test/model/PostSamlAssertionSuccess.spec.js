...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.PostSamlAssertionSuccess();
  });
  ...
  describe('PostSamlAssertionSuccess', function() {
    it('should create an instance of PostSamlAssertionSuccess', function() {
      // uncomment below and update the code to test PostSamlAssertionSuccess
      //var instance = new RainbowAuthenticationPortal.PostSamlAssertionSuccess();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.PostSamlAssertionSuccess);
    });
