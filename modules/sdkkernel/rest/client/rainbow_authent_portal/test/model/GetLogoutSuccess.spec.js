...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthentPortal.GetLogoutSuccess();
  });
  ...
  describe('GetLogoutSuccess', function() {
    it('should create an instance of GetLogoutSuccess', function() {
      // uncomment below and update the code to test GetLogoutSuccess
      //var instance = new RainbowAuthentPortal.GetLogoutSuccess();
      //expect(instance).to.be.a(RainbowAuthentPortal.GetLogoutSuccess);
    });
