...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.GetJwtSuccessProfiles();
  });
  ...
  describe('GetJwtSuccessProfiles', function() {
    it('should create an instance of GetJwtSuccessProfiles', function() {
      // uncomment below and update the code to test GetJwtSuccessProfiles
      //var instance = new RainbowAuthenticationPortal.GetJwtSuccessProfiles();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.GetJwtSuccessProfiles);
    });
