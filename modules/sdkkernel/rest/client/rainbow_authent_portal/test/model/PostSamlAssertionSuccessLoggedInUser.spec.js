...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.PostSamlAssertionSuccessLoggedInUser();
  });
  ...
  describe('PostSamlAssertionSuccessLoggedInUser', function() {
    it('should create an instance of PostSamlAssertionSuccessLoggedInUser', function() {
      // uncomment below and update the code to test PostSamlAssertionSuccessLoggedInUser
      //var instance = new RainbowAuthenticationPortal.PostSamlAssertionSuccessLoggedInUser();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.PostSamlAssertionSuccessLoggedInUser);
    });
    ...
    it('should have the property userInfo2 (base name: "userInfo2")', function() {
      // uncomment below and update the code to test the property userInfo2
      //var instance = new RainbowAuthenticationPortal.PostSamlAssertionSuccessLoggedInUser();
      //expect(instance).to.be();
    });

    it('should have the property userInfo1 (base name: "userInfo1")', function() {
      // uncomment below and update the code to test the property userInfo1
      //var instance = new RainbowAuthenticationPortal.PostSamlAssertionSuccessLoggedInUser();
      //expect(instance).to.be();
    });
