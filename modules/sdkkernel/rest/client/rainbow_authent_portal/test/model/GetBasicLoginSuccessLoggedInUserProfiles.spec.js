...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.GetBasicLoginSuccessLoggedInUserProfiles();
  });
  ...
  describe('GetBasicLoginSuccessLoggedInUserProfiles', function() {
    it('should create an instance of GetBasicLoginSuccessLoggedInUserProfiles', function() {
      // uncomment below and update the code to test GetBasicLoginSuccessLoggedInUserProfiles
      //var instance = new RainbowAuthenticationPortal.GetBasicLoginSuccessLoggedInUserProfiles();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.GetBasicLoginSuccessLoggedInUserProfiles);
    });
