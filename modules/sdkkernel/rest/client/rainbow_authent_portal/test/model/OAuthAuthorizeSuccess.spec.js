...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.OAuthAuthorizeSuccess();
  });
  ...
  describe('OAuthAuthorizeSuccess', function() {
    it('should create an instance of OAuthAuthorizeSuccess', function() {
      // uncomment below and update the code to test OAuthAuthorizeSuccess
      //var instance = new RainbowAuthenticationPortal.OAuthAuthorizeSuccess();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.OAuthAuthorizeSuccess);
    });
