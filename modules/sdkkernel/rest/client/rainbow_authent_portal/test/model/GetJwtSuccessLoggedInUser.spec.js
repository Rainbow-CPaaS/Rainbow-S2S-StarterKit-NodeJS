...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.GetJwtSuccessLoggedInUser();
  });
  ...
  describe('GetJwtSuccessLoggedInUser', function() {
    it('should create an instance of GetJwtSuccessLoggedInUser', function() {
      // uncomment below and update the code to test GetJwtSuccessLoggedInUser
      //var instance = new RainbowAuthenticationPortal.GetJwtSuccessLoggedInUser();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.GetJwtSuccessLoggedInUser);
    });
