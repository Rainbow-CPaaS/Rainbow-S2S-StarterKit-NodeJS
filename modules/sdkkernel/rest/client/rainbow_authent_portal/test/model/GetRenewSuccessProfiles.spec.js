...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.GetRenewSuccessProfiles();
  });
  ...
  describe('GetRenewSuccessProfiles', function() {
    it('should create an instance of GetRenewSuccessProfiles', function() {
      // uncomment below and update the code to test GetRenewSuccessProfiles
      //var instance = new RainbowAuthenticationPortal.GetRenewSuccessProfiles();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.GetRenewSuccessProfiles);
    });
