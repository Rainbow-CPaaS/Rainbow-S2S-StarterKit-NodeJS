...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthentPortal.GetBasicLoginSuccessLoggedInUserCreatedByAdmin();
  });
  ...
  describe('GetBasicLoginSuccessLoggedInUserCreatedByAdmin', function() {
    it('should create an instance of GetBasicLoginSuccessLoggedInUserCreatedByAdmin', function() {
      // uncomment below and update the code to test GetBasicLoginSuccessLoggedInUserCreatedByAdmin
      //var instance = new RainbowAuthentPortal.GetBasicLoginSuccessLoggedInUserCreatedByAdmin();
      //expect(instance).to.be.a(RainbowAuthentPortal.GetBasicLoginSuccessLoggedInUserCreatedByAdmin);
    });
