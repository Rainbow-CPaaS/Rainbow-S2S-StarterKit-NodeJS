...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.GetRenewSuccessLoggedInUserProfiles();
  });
  ...
  describe('GetRenewSuccessLoggedInUserProfiles', function() {
    it('should create an instance of GetRenewSuccessLoggedInUserProfiles', function() {
      // uncomment below and update the code to test GetRenewSuccessLoggedInUserProfiles
      //var instance = new RainbowAuthenticationPortal.GetRenewSuccessLoggedInUserProfiles();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.GetRenewSuccessLoggedInUserProfiles);
    });
