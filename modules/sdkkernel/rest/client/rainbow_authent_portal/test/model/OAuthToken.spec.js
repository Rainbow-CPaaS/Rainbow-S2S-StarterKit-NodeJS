...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.OAuthToken();
  });
  ...
  describe('OAuthToken', function() {
    it('should create an instance of OAuthToken', function() {
      ...
      //var instance = new RainbowAuthenticationPortal.OAuthToken();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.OAuthToken);
    });
