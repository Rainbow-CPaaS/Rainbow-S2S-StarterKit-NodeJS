...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.GetJwtSuccessLoggedInUserProfiles();
  });
  ...
  describe('GetJwtSuccessLoggedInUserProfiles', function() {
    it('should create an instance of GetJwtSuccessLoggedInUserProfiles', function() {
      // uncomment below and update the code to test GetJwtSuccessLoggedInUserProfiles
      //var instance = new RainbowAuthenticationPortal.GetJwtSuccessLoggedInUserProfiles();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.GetJwtSuccessLoggedInUserProfiles);
    });
