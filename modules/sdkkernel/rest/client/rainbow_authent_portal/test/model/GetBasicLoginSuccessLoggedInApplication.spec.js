...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthentPortal.GetBasicLoginSuccessLoggedInApplication();
  });
  ...
  describe('GetBasicLoginSuccessLoggedInApplication', function() {
    it('should create an instance of GetBasicLoginSuccessLoggedInApplication', function() {
      ...
      //var instance = new RainbowAuthentPortal.GetBasicLoginSuccessLoggedInApplication();
      //expect(instance).to.be.a(RainbowAuthentPortal.GetBasicLoginSuccessLoggedInApplication);
    });
