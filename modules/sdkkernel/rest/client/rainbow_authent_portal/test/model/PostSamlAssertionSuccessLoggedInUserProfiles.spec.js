...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.PostSamlAssertionSuccessLoggedInUserProfiles();
  });
  ...
  describe('PostSamlAssertionSuccessLoggedInUserProfiles', function() {
    it('should create an instance of PostSamlAssertionSuccessLoggedInUserProfiles', function() {
      // uncomment below and update the code to test PostSamlAssertionSuccessLoggedInUserProfiles
      //var instance = new RainbowAuthenticationPortal.PostSamlAssertionSuccessLoggedInUserProfiles();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.PostSamlAssertionSuccessLoggedInUserProfiles);
    });
