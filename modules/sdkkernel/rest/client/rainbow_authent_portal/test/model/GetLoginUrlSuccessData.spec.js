...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.GetLoginUrlSuccessData();
  });
  ...
  describe('GetLoginUrlSuccessData', function() {
    it('should create an instance of GetLoginUrlSuccessData', function() {
      // uncomment below and update the code to test GetLoginUrlSuccessData
      //var instance = new RainbowAuthenticationPortal.GetLoginUrlSuccessData();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.GetLoginUrlSuccessData);
    });
    ...
    it('should have the property onlyUseImplicitFlow (base name: "onlyUseImplicitFlow")', function() {
      // uncomment below and update the code to test the property onlyUseImplicitFlow
      //var instance = new RainbowAuthenticationPortal.GetLoginUrlSuccessData();
      //expect(instance).to.be();
    });
