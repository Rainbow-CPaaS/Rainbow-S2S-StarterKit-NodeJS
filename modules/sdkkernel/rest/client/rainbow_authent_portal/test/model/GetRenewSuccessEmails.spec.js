...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthentPortal.GetRenewSuccessEmails();
  });
  ...
  describe('GetRenewSuccessEmails', function() {
    it('should create an instance of GetRenewSuccessEmails', function() {
      // uncomment below and update the code to test GetRenewSuccessEmails
      //var instance = new RainbowAuthentPortal.GetRenewSuccessEmails();
      //expect(instance).to.be.a(RainbowAuthentPortal.GetRenewSuccessEmails);
    });
