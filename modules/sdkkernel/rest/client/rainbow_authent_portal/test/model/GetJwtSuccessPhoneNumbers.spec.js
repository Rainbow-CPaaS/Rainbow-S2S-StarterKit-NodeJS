...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.GetJwtSuccessPhoneNumbers();
  });
  ...
  describe('GetJwtSuccessPhoneNumbers', function() {
    it('should create an instance of GetJwtSuccessPhoneNumbers', function() {
      // uncomment below and update the code to test GetJwtSuccessPhoneNumbers
      //var instance = new RainbowAuthenticationPortal.GetJwtSuccessPhoneNumbers();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.GetJwtSuccessPhoneNumbers);
    });
