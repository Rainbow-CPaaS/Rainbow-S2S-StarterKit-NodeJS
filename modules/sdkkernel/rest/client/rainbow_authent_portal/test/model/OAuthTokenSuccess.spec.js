...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.OAuthTokenSuccess();
  });
  ...
  describe('OAuthTokenSuccess', function() {
    it('should create an instance of OAuthTokenSuccess', function() {
      // uncomment below and update the code to test OAuthTokenSuccess
      //var instance = new RainbowAuthenticationPortal.OAuthTokenSuccess();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.OAuthTokenSuccess);
    });
