...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.PutApiRainbowLogsLevels();
  });
  ...
  describe('PutApiRainbowLogsLevels', function() {
    it('should create an instance of PutApiRainbowLogsLevels', function() {
      // uncomment below and update the code to test PutApiRainbowLogsLevels
      //var instance = new RainbowAuthenticationPortal.PutApiRainbowLogsLevels();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.PutApiRainbowLogsLevels);
    });
