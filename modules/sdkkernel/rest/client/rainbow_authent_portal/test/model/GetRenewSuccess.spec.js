...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthentPortal.GetRenewSuccess();
  });
  ...
  describe('GetRenewSuccess', function() {
    it('should create an instance of GetRenewSuccess', function() {
      // uncomment below and update the code to test GetRenewSuccess
      //var instance = new RainbowAuthentPortal.GetRenewSuccess();
      //expect(instance).to.be.a(RainbowAuthentPortal.GetRenewSuccess);
    });
