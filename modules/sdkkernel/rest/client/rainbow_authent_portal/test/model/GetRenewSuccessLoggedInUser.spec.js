...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthentPortal.GetRenewSuccessLoggedInUser();
  });
  ...
  describe('GetRenewSuccessLoggedInUser', function() {
    it('should create an instance of GetRenewSuccessLoggedInUser', function() {
      ...
      //var instance = new RainbowAuthentPortal.GetRenewSuccessLoggedInUser();
      //expect(instance).to.be.a(RainbowAuthentPortal.GetRenewSuccessLoggedInUser);
    });
