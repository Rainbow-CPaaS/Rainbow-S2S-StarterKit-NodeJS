...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.GetRenewSuccessLoggedInUser();
  });
  ...
  describe('GetRenewSuccessLoggedInUser', function() {
    it('should create an instance of GetRenewSuccessLoggedInUser', function() {
      // uncomment below and update the code to test GetRenewSuccessLoggedInUser
      //var instance = new RainbowAuthenticationPortal.GetRenewSuccessLoggedInUser();
      //expect(instance).to.be.a(RainbowAuthenticationPortal.GetRenewSuccessLoggedInUser);
    });
