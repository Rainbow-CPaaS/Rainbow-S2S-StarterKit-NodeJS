...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthentPortal.GetBasicLoginSuccessEmails();
  });
  ...
  describe('GetBasicLoginSuccessEmails', function() {
    it('should create an instance of GetBasicLoginSuccessEmails', function() {
      // uncomment below and update the code to test GetBasicLoginSuccessEmails
      //var instance = new RainbowAuthentPortal.GetBasicLoginSuccessEmails();
      //expect(instance).to.be.a(RainbowAuthentPortal.GetBasicLoginSuccessEmails);
    });
