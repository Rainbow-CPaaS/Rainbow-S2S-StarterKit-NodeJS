...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthentPortal.GetBasicLoginSuccessLoggedInUser();
  });
  ...
  describe('GetBasicLoginSuccessLoggedInUser', function() {
    it('should create an instance of GetBasicLoginSuccessLoggedInUser', function() {
      ...
      //var instance = new RainbowAuthentPortal.GetBasicLoginSuccessLoggedInUser();
      //expect(instance).to.be.a(RainbowAuthentPortal.GetBasicLoginSuccessLoggedInUser);
    });
