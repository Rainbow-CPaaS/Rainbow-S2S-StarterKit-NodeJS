...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthentPortal.GetBasicLoginSuccess();
  });
  ...
  describe('GetBasicLoginSuccess', function() {
    it('should create an instance of GetBasicLoginSuccess', function() {
      // uncomment below and update the code to test GetBasicLoginSuccess
      //var instance = new RainbowAuthentPortal.GetBasicLoginSuccess();
      //expect(instance).to.be.a(RainbowAuthentPortal.GetBasicLoginSuccess);
    });
