...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthentPortal.GetRenewSuccessPhoneNumbers();
  });
  ...
  describe('GetRenewSuccessPhoneNumbers', function() {
    it('should create an instance of GetRenewSuccessPhoneNumbers', function() {
      // uncomment below and update the code to test GetRenewSuccessPhoneNumbers
      //var instance = new RainbowAuthentPortal.GetRenewSuccessPhoneNumbers();
      //expect(instance).to.be.a(RainbowAuthentPortal.GetRenewSuccessPhoneNumbers);
    });
