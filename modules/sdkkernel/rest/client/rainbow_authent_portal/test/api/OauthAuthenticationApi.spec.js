...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAuthenticationPortal.OauthAuthenticationApi();
  });
  ...
  describe('OauthAuthenticationApi', function() {
    describe('oAuthAuthorize', function() {
      it('should call oAuthAuthorize successfully', function(done) {
        //uncomment below and update the code to test oAuthAuthorize
        //instance.oAuthAuthorize(function(error) {
