...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAuthenticationPortal.GetRenewSuccessProfiles = factory(root.RainbowAuthenticationPortal.ApiClient, root.RainbowAuthenticationPortal.GetRenewSuccessProvisioningNeeded);
  }
  ...
  /**
   * The GetRenewSuccessProfiles model module.
   * @module model/GetRenewSuccessProfiles
   * @version 1.104.0
   */

  /**
   * Constructs a new <code>GetRenewSuccessProfiles</code>.
   * @alias module:model/GetRenewSuccessProfiles
   * @class
  ...
  /**
   * Constructs a <code>GetRenewSuccessProfiles</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetRenewSuccessProfiles} obj Optional instance to populate.
   * @return {module:model/GetRenewSuccessProfiles} The populated <code>GetRenewSuccessProfiles</code> instance.
   */
   ...
   * @member {module:model/GetRenewSuccessProfiles.BusinessModelEnum} businessModel
   * @default 'none'
   */
