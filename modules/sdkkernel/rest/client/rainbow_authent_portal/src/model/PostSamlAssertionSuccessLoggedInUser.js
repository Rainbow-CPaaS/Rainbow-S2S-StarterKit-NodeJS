...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetBasicLoginSuccessLoggedInUserCreatedByAdmin', 'model/PostSamlAssertionSuccessEmails', 'model/PostSamlAssertionSuccessPhoneNumbers', 'model/PostSamlAssertionSuccessProfiles'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetBasicLoginSuccessLoggedInUserCreatedByAdmin'), require('./PostSamlAssertionSuccessEmails'), require('./PostSamlAssertionSuccessPhoneNumbers'), require('./PostSamlAssertionSuccessProfiles'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAuthenticationPortal) {
      root.RainbowAuthenticationPortal = {};
    }
    root.RainbowAuthenticationPortal.PostSamlAssertionSuccessLoggedInUser = factory(root.RainbowAuthenticationPortal.ApiClient, root.RainbowAuthenticationPortal.GetBasicLoginSuccessLoggedInUserCreatedByAdmin, root.RainbowAuthenticationPortal.PostSamlAssertionSuccessEmails, root.RainbowAuthenticationPortal.PostSamlAssertionSuccessPhoneNumbers, root.RainbowAuthenticationPortal.PostSamlAssertionSuccessProfiles);
  }
}(this, function(ApiClient, GetBasicLoginSuccessLoggedInUserCreatedByAdmin, PostSamlAssertionSuccessEmails, PostSamlAssertionSuccessPhoneNumbers, PostSamlAssertionSuccessProfiles) {
  'use strict';



  /**
   * The PostSamlAssertionSuccessLoggedInUser model module.
   * @module model/PostSamlAssertionSuccessLoggedInUser
   * @version 1.104.0
   */

  /**
   * Constructs a new <code>PostSamlAssertionSuccessLoggedInUser</code>.
   * @alias module:model/PostSamlAssertionSuccessLoggedInUser
   * @class
   ...
   * @param phoneNumbers {Array.<module:model/PostSamlAssertionSuccessPhoneNumbers>} Array of user phone numbers objects. <br/> Phone number objects can: <ul>     <li> be created by user (information filled by user),</li>     <li> come from association with a system (pbx) device (association is done by admin).</li> </ul>
   * @param emails {Array.<module:model/PostSamlAssertionSuccessEmails>} Array of user emails addresses objects
  ...
  /**
   * Constructs a <code>PostSamlAssertionSuccessLoggedInUser</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostSamlAssertionSuccessLoggedInUser} obj Optional instance to populate.
   * @return {module:model/PostSamlAssertionSuccessLoggedInUser} The populated <code>PostSamlAssertionSuccessLoggedInUser</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('phoneNumbers')) {
        obj['phoneNumbers'] = ApiClient.convertToType(data['phoneNumbers'], [PostSamlAssertionSuccessPhoneNumbers]);
      }
      if (data.hasOwnProperty('emails')) {
        obj['emails'] = ApiClient.convertToType(data['emails'], [PostSamlAssertionSuccessEmails]);
      }
      ...
      if (data.hasOwnProperty('profiles')) {
        obj['profiles'] = ApiClient.convertToType(data['profiles'], [PostSamlAssertionSuccessProfiles]);
      }
   ...
   * @member {Array.<module:model/PostSamlAssertionSuccessPhoneNumbers>} phoneNumbers
   */
  exports.prototype['phoneNumbers'] = undefined;
  /**
   * Array of user emails addresses objects
   * @member {Array.<module:model/PostSamlAssertionSuccessEmails>} emails
   */
  ...
  /**
   * User visibility </br> Define if the user can be searched by users being in other companies and if the user can search users being in other companies. <br/> Visibility can be: - `same_than_company`: The same visibility than the user's company's is applied to the user. When this user visibility is used, if the visibility of the company is changed the user's visibility will use this company new visibility. - `public`: User can be searched by external users / can search external users. User can invite external users / can be invited by external users - `private`: User **can't** be searched by external users / can search external users. User can invite external users / can be invited by external users - `closed`: User **can't** be searched by external users / **can't** search external users. User can invite external users / can be invited by external users - `isolated`: User **can't** be searched by external users / **can't** search external users. User **can't** invite external users / **can't** be invited by external users - `none`:  Default value reserved for guest. User **can't** be searched by **any users** (even within the same company) / can search external users. User can invite external users / can be invited by external users  External users mean public user not being in user's company nor user's organisation nor a company visible by user's company.
   * @member {module:model/PostSamlAssertionSuccessLoggedInUser.VisibilityEnum} visibility
   */
   ...
   * @member {Array.<module:model/PostSamlAssertionSuccessProfiles>} profiles
   */
