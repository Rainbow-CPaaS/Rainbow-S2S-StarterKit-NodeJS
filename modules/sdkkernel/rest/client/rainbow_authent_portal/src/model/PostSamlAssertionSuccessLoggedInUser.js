...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetBasicLoginSuccessLoggedInUserCreatedByAdmin', 'model/PostSamlAssertionSuccessEmails', 'model/PostSamlAssertionSuccessLoggedInUserProfiles', 'model/PostSamlAssertionSuccessPhoneNumbers'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetBasicLoginSuccessLoggedInUserCreatedByAdmin'), require('./PostSamlAssertionSuccessEmails'), require('./PostSamlAssertionSuccessLoggedInUserProfiles'), require('./PostSamlAssertionSuccessPhoneNumbers'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAuthenticationPortal) {
      root.RainbowAuthenticationPortal = {};
    }
    root.RainbowAuthenticationPortal.PostSamlAssertionSuccessLoggedInUser = factory(root.RainbowAuthenticationPortal.ApiClient, root.RainbowAuthenticationPortal.GetBasicLoginSuccessLoggedInUserCreatedByAdmin, root.RainbowAuthenticationPortal.PostSamlAssertionSuccessEmails, root.RainbowAuthenticationPortal.PostSamlAssertionSuccessLoggedInUserProfiles, root.RainbowAuthenticationPortal.PostSamlAssertionSuccessPhoneNumbers);
  }
}(this, function(ApiClient, GetBasicLoginSuccessLoggedInUserCreatedByAdmin, PostSamlAssertionSuccessEmails, PostSamlAssertionSuccessLoggedInUserProfiles, PostSamlAssertionSuccessPhoneNumbers) {
  'use strict';
   ...
   * @param profiles {module:model/PostSamlAssertionSuccessLoggedInUserProfiles} 
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('profiles')) {
        obj['profiles'] = PostSamlAssertionSuccessLoggedInUserProfiles.constructFromObject(data['profiles']);
      }
  ...
  /**
   * @member {module:model/PostSamlAssertionSuccessLoggedInUserProfiles} profiles
   */
