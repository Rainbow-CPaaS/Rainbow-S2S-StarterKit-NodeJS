...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetBasicLoginSuccessLoggedInUserCreatedByAdmin', 'model/GetRenewSuccessEmails', 'model/GetRenewSuccessLoggedInUserProfiles', 'model/GetRenewSuccessPhoneNumbers'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetBasicLoginSuccessLoggedInUserCreatedByAdmin'), require('./GetRenewSuccessEmails'), require('./GetRenewSuccessLoggedInUserProfiles'), require('./GetRenewSuccessPhoneNumbers'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAuthenticationPortal) {
      root.RainbowAuthenticationPortal = {};
    }
    root.RainbowAuthenticationPortal.GetRenewSuccessLoggedInUser = factory(root.RainbowAuthenticationPortal.ApiClient, root.RainbowAuthenticationPortal.GetBasicLoginSuccessLoggedInUserCreatedByAdmin, root.RainbowAuthenticationPortal.GetRenewSuccessEmails, root.RainbowAuthenticationPortal.GetRenewSuccessLoggedInUserProfiles, root.RainbowAuthenticationPortal.GetRenewSuccessPhoneNumbers);
  }
}(this, function(ApiClient, GetBasicLoginSuccessLoggedInUserCreatedByAdmin, GetRenewSuccessEmails, GetRenewSuccessLoggedInUserProfiles, GetRenewSuccessPhoneNumbers) {
  'use strict';
   ...
   * @param profiles {module:model/GetRenewSuccessLoggedInUserProfiles} 
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('profiles')) {
        obj['profiles'] = GetRenewSuccessLoggedInUserProfiles.constructFromObject(data['profiles']);
      }
  ...
  /**
   * @member {module:model/GetRenewSuccessLoggedInUserProfiles} profiles
   */
