...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAuthenticationPortal.PostSamlAssertionSuccessPhoneNumbers = factory(root.RainbowAuthenticationPortal.ApiClient);
  }
  ...
  /**
   * The PostSamlAssertionSuccessPhoneNumbers model module.
   * @module model/PostSamlAssertionSuccessPhoneNumbers
   * @version 1.104.0
   */

  /**
   * Constructs a new <code>PostSamlAssertionSuccessPhoneNumbers</code>.
   * @alias module:model/PostSamlAssertionSuccessPhoneNumbers
   * @class
  ...
  /**
   * Constructs a <code>PostSamlAssertionSuccessPhoneNumbers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostSamlAssertionSuccessPhoneNumbers} obj Optional instance to populate.
   * @return {module:model/PostSamlAssertionSuccessPhoneNumbers} The populated <code>PostSamlAssertionSuccessPhoneNumbers</code> instance.
   */
