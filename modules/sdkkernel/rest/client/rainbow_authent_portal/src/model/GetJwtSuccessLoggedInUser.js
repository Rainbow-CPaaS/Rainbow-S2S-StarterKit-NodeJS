...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetBasicLoginSuccessLoggedInUserCreatedByAdmin', 'model/GetJwtSuccessEmails', 'model/GetJwtSuccessPhoneNumbers', 'model/GetJwtSuccessProfiles'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetBasicLoginSuccessLoggedInUserCreatedByAdmin'), require('./GetJwtSuccessEmails'), require('./GetJwtSuccessPhoneNumbers'), require('./GetJwtSuccessProfiles'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAuthenticationPortal) {
      root.RainbowAuthenticationPortal = {};
    }
    root.RainbowAuthenticationPortal.GetJwtSuccessLoggedInUser = factory(root.RainbowAuthenticationPortal.ApiClient, root.RainbowAuthenticationPortal.GetBasicLoginSuccessLoggedInUserCreatedByAdmin, root.RainbowAuthenticationPortal.GetJwtSuccessEmails, root.RainbowAuthenticationPortal.GetJwtSuccessPhoneNumbers, root.RainbowAuthenticationPortal.GetJwtSuccessProfiles);
  }
}(this, function(ApiClient, GetBasicLoginSuccessLoggedInUserCreatedByAdmin, GetJwtSuccessEmails, GetJwtSuccessPhoneNumbers, GetJwtSuccessProfiles) {
  'use strict';



  /**
   * The GetJwtSuccessLoggedInUser model module.
   * @module model/GetJwtSuccessLoggedInUser
   * @version 1.104.0
   */

  /**
   * Constructs a new <code>GetJwtSuccessLoggedInUser</code>.
   * @alias module:model/GetJwtSuccessLoggedInUser
   * @class
   ...
   * @param phoneNumbers {Array.<module:model/GetJwtSuccessPhoneNumbers>} Array of user phone numbers objects. <br/> Phone number objects can: <ul>     <li> be created by user (information filled by user),</li>     <li> come from association with a system (pbx) device (association is done by admin).</li> </ul>
   * @param emails {Array.<module:model/GetJwtSuccessEmails>} Array of user emails addresses objects
  ...
  /**
   * Constructs a <code>GetJwtSuccessLoggedInUser</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetJwtSuccessLoggedInUser} obj Optional instance to populate.
   * @return {module:model/GetJwtSuccessLoggedInUser} The populated <code>GetJwtSuccessLoggedInUser</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('phoneNumbers')) {
        obj['phoneNumbers'] = ApiClient.convertToType(data['phoneNumbers'], [GetJwtSuccessPhoneNumbers]);
      }
      if (data.hasOwnProperty('emails')) {
        obj['emails'] = ApiClient.convertToType(data['emails'], [GetJwtSuccessEmails]);
      }
      ...
      if (data.hasOwnProperty('profiles')) {
        obj['profiles'] = ApiClient.convertToType(data['profiles'], [GetJwtSuccessProfiles]);
      }
   ...
   * @member {Array.<module:model/GetJwtSuccessPhoneNumbers>} phoneNumbers
   */
  exports.prototype['phoneNumbers'] = undefined;
  /**
   * Array of user emails addresses objects
   * @member {Array.<module:model/GetJwtSuccessEmails>} emails
   */
   ...
   * @member {module:model/GetJwtSuccessLoggedInUser.VisibilityEnum} visibility
   */
   ...
   * @member {Array.<module:model/GetJwtSuccessProfiles>} profiles
   */
