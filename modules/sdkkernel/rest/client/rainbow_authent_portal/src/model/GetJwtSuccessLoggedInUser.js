...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetBasicLoginSuccessLoggedInUserCreatedByAdmin', 'model/GetJwtSuccessEmails', 'model/GetJwtSuccessLoggedInUserProfiles', 'model/GetJwtSuccessPhoneNumbers'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetBasicLoginSuccessLoggedInUserCreatedByAdmin'), require('./GetJwtSuccessEmails'), require('./GetJwtSuccessLoggedInUserProfiles'), require('./GetJwtSuccessPhoneNumbers'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAuthenticationPortal) {
      root.RainbowAuthenticationPortal = {};
    }
    root.RainbowAuthenticationPortal.GetJwtSuccessLoggedInUser = factory(root.RainbowAuthenticationPortal.ApiClient, root.RainbowAuthenticationPortal.GetBasicLoginSuccessLoggedInUserCreatedByAdmin, root.RainbowAuthenticationPortal.GetJwtSuccessEmails, root.RainbowAuthenticationPortal.GetJwtSuccessLoggedInUserProfiles, root.RainbowAuthenticationPortal.GetJwtSuccessPhoneNumbers);
  }
}(this, function(ApiClient, GetBasicLoginSuccessLoggedInUserCreatedByAdmin, GetJwtSuccessEmails, GetJwtSuccessLoggedInUserProfiles, GetJwtSuccessPhoneNumbers) {
  'use strict';
   ...
   * @param profiles {module:model/GetJwtSuccessLoggedInUserProfiles} 
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('profiles')) {
        obj['profiles'] = GetJwtSuccessLoggedInUserProfiles.constructFromObject(data['profiles']);
      }
  ...
  /**
   * @member {module:model/GetJwtSuccessLoggedInUserProfiles} profiles
   */
