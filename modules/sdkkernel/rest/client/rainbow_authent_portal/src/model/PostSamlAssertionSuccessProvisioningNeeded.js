...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAuthenticationPortal.PostSamlAssertionSuccessProvisioningNeeded = factory(root.RainbowAuthenticationPortal.ApiClient);
  }
  ...
  /**
   * The PostSamlAssertionSuccessProvisioningNeeded model module.
   * @module model/PostSamlAssertionSuccessProvisioningNeeded
   * @version 1.95.0
   */

  /**
   * Constructs a new <code>PostSamlAssertionSuccessProvisioningNeeded</code>.
   * @alias module:model/PostSamlAssertionSuccessProvisioningNeeded
   * @class
   * @param providerType {module:model/PostSamlAssertionSuccessProvisioningNeeded.ProviderTypeEnum} If provisioningNeeded is set, each element of the array must contain providerType. providerType defines the internal component on which the provisioning is needed when subscribing to this offer (provisioning is launched asynchronously when the subscription is created).
   */
  ...
  /**
   * Constructs a <code>PostSamlAssertionSuccessProvisioningNeeded</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostSamlAssertionSuccessProvisioningNeeded} obj Optional instance to populate.
   * @return {module:model/PostSamlAssertionSuccessProvisioningNeeded} The populated <code>PostSamlAssertionSuccessProvisioningNeeded</code> instance.
   */
   ...
   * @member {module:model/PostSamlAssertionSuccessProvisioningNeeded.MediaTypeEnum} mediaType
   */
   ...
   * @member {module:model/PostSamlAssertionSuccessProvisioningNeeded.PgiEnterpriseIdEnum} pgiEnterpriseId
   */
   ...
   * @member {module:model/PostSamlAssertionSuccessProvisioningNeeded.ProviderTypeEnum} providerType
   */
