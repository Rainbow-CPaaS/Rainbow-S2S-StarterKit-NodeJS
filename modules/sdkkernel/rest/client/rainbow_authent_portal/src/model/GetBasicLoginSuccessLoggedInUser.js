...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetBasicLoginSuccessEmails', 'model/GetBasicLoginSuccessLoggedInUserCreatedByAdmin', 'model/GetBasicLoginSuccessPhoneNumbers'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetBasicLoginSuccessEmails'), require('./GetBasicLoginSuccessLoggedInUserCreatedByAdmin'), require('./GetBasicLoginSuccessPhoneNumbers'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAuthentPortal) {
      root.RainbowAuthentPortal = {};
    }
    root.RainbowAuthentPortal.GetBasicLoginSuccessLoggedInUser = factory(root.RainbowAuthentPortal.ApiClient, root.RainbowAuthentPortal.GetBasicLoginSuccessEmails, root.RainbowAuthentPortal.GetBasicLoginSuccessLoggedInUserCreatedByAdmin, root.RainbowAuthentPortal.GetBasicLoginSuccessPhoneNumbers);
  }
}(this, function(ApiClient, GetBasicLoginSuccessEmails, GetBasicLoginSuccessLoggedInUserCreatedByAdmin, GetBasicLoginSuccessPhoneNumbers) {
  'use strict';
   ...
   * @param phoneNumbers {Array.<module:model/GetBasicLoginSuccessPhoneNumbers>} Array of user phone numbers objects.    Phone number objects can:   * be created by user (information filled by user), * come from association with a system (pbx) device (association is done by admin).  
