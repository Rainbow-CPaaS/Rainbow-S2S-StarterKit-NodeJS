...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetRenewSuccessProvisioningNeeded'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetRenewSuccessProvisioningNeeded'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAuthenticationPortal) {
      root.RainbowAuthenticationPortal = {};
    }
    root.RainbowAuthenticationPortal.GetRenewSuccessLoggedInUserProfiles = factory(root.RainbowAuthenticationPortal.ApiClient, root.RainbowAuthenticationPortal.GetRenewSuccessProvisioningNeeded);
  }
}(this, function(ApiClient, GetRenewSuccessProvisioningNeeded) {
  'use strict';



  /**
   * The GetRenewSuccessLoggedInUserProfiles model module.
   * @module model/GetRenewSuccessLoggedInUserProfiles
   * @version 1.95.0
   */

  /**
   * Constructs a new <code>GetRenewSuccessLoggedInUserProfiles</code>.
   * @alias module:model/GetRenewSuccessLoggedInUserProfiles
   * @class
  ...
  /**
   * Constructs a <code>GetRenewSuccessLoggedInUserProfiles</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetRenewSuccessLoggedInUserProfiles} obj Optional instance to populate.
   * @return {module:model/GetRenewSuccessLoggedInUserProfiles} The populated <code>GetRenewSuccessLoggedInUserProfiles</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('provisioningNeeded')) {
        obj['provisioningNeeded'] = ApiClient.convertToType(data['provisioningNeeded'], [GetRenewSuccessProvisioningNeeded]);
      }
   ...
   * @member {module:model/GetRenewSuccessLoggedInUserProfiles.BusinessModelEnum} businessModel
   * @default 'none'
   */
   ...
   * @member {Array.<module:model/GetRenewSuccessProvisioningNeeded>} provisioningNeeded
   */
