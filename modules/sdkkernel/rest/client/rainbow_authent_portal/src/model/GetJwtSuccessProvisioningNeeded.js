...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAuthenticationPortal.GetJwtSuccessProvisioningNeeded = factory(root.RainbowAuthenticationPortal.ApiClient);
  }
  ...
  /**
   * The GetJwtSuccessProvisioningNeeded model module.
   * @module model/GetJwtSuccessProvisioningNeeded
   * @version 1.104.0
   */

  /**
   * Constructs a new <code>GetJwtSuccessProvisioningNeeded</code>.
   * @alias module:model/GetJwtSuccessProvisioningNeeded
   * @class
   * @param providerType {module:model/GetJwtSuccessProvisioningNeeded.ProviderTypeEnum} If provisioningNeeded is set, each element of the array must contain providerType. providerType defines the internal component on which the provisioning is needed when subscribing to this offer (provisioning is launched asynchronously when the subscription is created).
   */
  ...
  /**
   * Constructs a <code>GetJwtSuccessProvisioningNeeded</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetJwtSuccessProvisioningNeeded} obj Optional instance to populate.
   * @return {module:model/GetJwtSuccessProvisioningNeeded} The populated <code>GetJwtSuccessProvisioningNeeded</code> instance.
   */
   ...
   * @member {module:model/GetJwtSuccessProvisioningNeeded.MediaTypeEnum} mediaType
   */
   ...
   * @member {module:model/GetJwtSuccessProvisioningNeeded.PgiEnterpriseIdEnum} pgiEnterpriseId
   */
   ...
   * @member {module:model/GetJwtSuccessProvisioningNeeded.ProviderTypeEnum} providerType
   */
