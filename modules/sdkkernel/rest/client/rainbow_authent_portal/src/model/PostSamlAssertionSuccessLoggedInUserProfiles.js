...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PostSamlAssertionSuccessProvisioningNeeded'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PostSamlAssertionSuccessProvisioningNeeded'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAuthenticationPortal) {
      root.RainbowAuthenticationPortal = {};
    }
    root.RainbowAuthenticationPortal.PostSamlAssertionSuccessLoggedInUserProfiles = factory(root.RainbowAuthenticationPortal.ApiClient, root.RainbowAuthenticationPortal.PostSamlAssertionSuccessProvisioningNeeded);
  }
}(this, function(ApiClient, PostSamlAssertionSuccessProvisioningNeeded) {
  'use strict';



  /**
   * The PostSamlAssertionSuccessLoggedInUserProfiles model module.
   * @module model/PostSamlAssertionSuccessLoggedInUserProfiles
   * @version 1.95.0
   */

  /**
   * Constructs a new <code>PostSamlAssertionSuccessLoggedInUserProfiles</code>.
   * @alias module:model/PostSamlAssertionSuccessLoggedInUserProfiles
   * @class
  ...
  /**
   * Constructs a <code>PostSamlAssertionSuccessLoggedInUserProfiles</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostSamlAssertionSuccessLoggedInUserProfiles} obj Optional instance to populate.
   * @return {module:model/PostSamlAssertionSuccessLoggedInUserProfiles} The populated <code>PostSamlAssertionSuccessLoggedInUserProfiles</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('provisioningNeeded')) {
        obj['provisioningNeeded'] = ApiClient.convertToType(data['provisioningNeeded'], [PostSamlAssertionSuccessProvisioningNeeded]);
      }
   ...
   * @member {module:model/PostSamlAssertionSuccessLoggedInUserProfiles.BusinessModelEnum} businessModel
   * @default 'none'
   */
   ...
   * @member {Array.<module:model/PostSamlAssertionSuccessProvisioningNeeded>} provisioningNeeded
   */
