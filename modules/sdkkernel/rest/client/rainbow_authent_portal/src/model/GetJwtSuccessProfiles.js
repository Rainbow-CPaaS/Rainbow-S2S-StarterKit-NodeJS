...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAuthenticationPortal.GetJwtSuccessProfiles = factory(root.RainbowAuthenticationPortal.ApiClient, root.RainbowAuthenticationPortal.GetJwtSuccessProvisioningNeeded);
  }
  ...
  /**
   * The GetJwtSuccessProfiles model module.
   * @module model/GetJwtSuccessProfiles
   * @version 1.104.0
   */

  /**
   * Constructs a new <code>GetJwtSuccessProfiles</code>.
   * @alias module:model/GetJwtSuccessProfiles
   * @class
  ...
  /**
   * Constructs a <code>GetJwtSuccessProfiles</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetJwtSuccessProfiles} obj Optional instance to populate.
   * @return {module:model/GetJwtSuccessProfiles} The populated <code>GetJwtSuccessProfiles</code> instance.
   */
   ...
   * @member {module:model/GetJwtSuccessProfiles.BusinessModelEnum} businessModel
   * @default 'none'
   */
