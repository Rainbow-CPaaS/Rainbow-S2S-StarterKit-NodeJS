...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAuthenticationPortal.GetJwtSuccessPhoneNumbers = factory(root.RainbowAuthenticationPortal.ApiClient);
  }
  ...
  /**
   * The GetJwtSuccessPhoneNumbers model module.
   * @module model/GetJwtSuccessPhoneNumbers
   * @version 1.104.0
   */

  /**
   * Constructs a new <code>GetJwtSuccessPhoneNumbers</code>.
   * @alias module:model/GetJwtSuccessPhoneNumbers
   * @class
  ...
  /**
   * Constructs a <code>GetJwtSuccessPhoneNumbers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetJwtSuccessPhoneNumbers} obj Optional instance to populate.
   * @return {module:model/GetJwtSuccessPhoneNumbers} The populated <code>GetJwtSuccessPhoneNumbers</code> instance.
   */
