...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetJwtSuccessProvisioningNeeded'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetJwtSuccessProvisioningNeeded'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAuthenticationPortal) {
      root.RainbowAuthenticationPortal = {};
    }
    root.RainbowAuthenticationPortal.GetJwtSuccessLoggedInUserProfiles = factory(root.RainbowAuthenticationPortal.ApiClient, root.RainbowAuthenticationPortal.GetJwtSuccessProvisioningNeeded);
  }
}(this, function(ApiClient, GetJwtSuccessProvisioningNeeded) {
  'use strict';



  /**
   * The GetJwtSuccessLoggedInUserProfiles model module.
   * @module model/GetJwtSuccessLoggedInUserProfiles
   * @version 1.95.0
   */

  /**
   * Constructs a new <code>GetJwtSuccessLoggedInUserProfiles</code>.
   * @alias module:model/GetJwtSuccessLoggedInUserProfiles
   * @class
  ...
  /**
   * Constructs a <code>GetJwtSuccessLoggedInUserProfiles</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetJwtSuccessLoggedInUserProfiles} obj Optional instance to populate.
   * @return {module:model/GetJwtSuccessLoggedInUserProfiles} The populated <code>GetJwtSuccessLoggedInUserProfiles</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('provisioningNeeded')) {
        obj['provisioningNeeded'] = ApiClient.convertToType(data['provisioningNeeded'], [GetJwtSuccessProvisioningNeeded]);
      }
   ...
   * @member {module:model/GetJwtSuccessLoggedInUserProfiles.BusinessModelEnum} businessModel
   * @default 'none'
   */
   ...
   * @member {Array.<module:model/GetJwtSuccessProvisioningNeeded>} provisioningNeeded
   */
