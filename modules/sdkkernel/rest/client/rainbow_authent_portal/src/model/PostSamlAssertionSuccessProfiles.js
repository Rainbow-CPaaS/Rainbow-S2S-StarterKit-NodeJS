...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAuthenticationPortal.PostSamlAssertionSuccessProfiles = factory(root.RainbowAuthenticationPortal.ApiClient, root.RainbowAuthenticationPortal.PostSamlAssertionSuccessProvisioningNeeded);
  }
  ...
  /**
   * The PostSamlAssertionSuccessProfiles model module.
   * @module model/PostSamlAssertionSuccessProfiles
   * @version 1.104.0
   */

  /**
   * Constructs a new <code>PostSamlAssertionSuccessProfiles</code>.
   * @alias module:model/PostSamlAssertionSuccessProfiles
   * @class
  ...
  /**
   * Constructs a <code>PostSamlAssertionSuccessProfiles</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostSamlAssertionSuccessProfiles} obj Optional instance to populate.
   * @return {module:model/PostSamlAssertionSuccessProfiles} The populated <code>PostSamlAssertionSuccessProfiles</code> instance.
   */
   ...
   * @member {module:model/PostSamlAssertionSuccessProfiles.BusinessModelEnum} businessModel
   * @default 'none'
   */
