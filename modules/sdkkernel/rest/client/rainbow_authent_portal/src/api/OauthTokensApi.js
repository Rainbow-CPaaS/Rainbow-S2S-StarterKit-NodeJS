...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Number} opts.limit Allow to specify the number of OAuth tokens to retrieve.
     ...
     * @param {module:model/Number} opts.sortOrder Specify order when sorting OAuth tokens list.
