...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.CommonApi();
  });
  ...
  describe('CommonApi', function() {
    ...
    describe('getApiRainbowAdminV10About', function() {
      it('should call getApiRainbowAdminV10About successfully', function(done) {
        //uncomment below and update the code to test getApiRainbowAdminV10About
        //instance.getApiRainbowAdminV10About(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getApiRainbowPcgV10About', function() {
      it('should call getApiRainbowPcgV10About successfully', function(done) {
        //uncomment below and update the code to test getApiRainbowPcgV10About
        //instance.getApiRainbowPcgV10About(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
