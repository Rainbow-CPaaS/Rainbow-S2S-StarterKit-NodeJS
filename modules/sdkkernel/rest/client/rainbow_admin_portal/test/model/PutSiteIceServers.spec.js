...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PutSiteIceServers();
  });
  ...
  describe('PutSiteIceServers', function() {
    it('should create an instance of PutSiteIceServers', function() {
      // uncomment below and update the code to test PutSiteIceServers
      //var instance = new RainbowAdminPortal.PutSiteIceServers();
      //expect(instance).to.be.a(RainbowAdminPortal.PutSiteIceServers);
    });
