...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.GetSystemPhoneNumbersSuccess();
  });
  ...
  describe('GetSystemPhoneNumbersSuccess', function() {
    it('should create an instance of GetSystemPhoneNumbersSuccess', function() {
      // uncomment below and update the code to test GetSystemPhoneNumbersSuccess
      //var instance = new RainbowAdminPortal.GetSystemPhoneNumbersSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.GetSystemPhoneNumbersSuccess);
    });
