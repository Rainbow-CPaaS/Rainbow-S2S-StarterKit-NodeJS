...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.GetPcgPbxPhoneNbShortNbSuccess();
  });
  ...
  describe('GetPcgPbxPhoneNbShortNbSuccess', function() {
    it('should create an instance of GetPcgPbxPhoneNbShortNbSuccess', function() {
      // uncomment below and update the code to test GetPcgPbxPhoneNbShortNbSuccess
      //var instance = new RainbowAdminPortal.GetPcgPbxPhoneNbShortNbSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.GetPcgPbxPhoneNbShortNbSuccess);
    });
