...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PutCompanyIceServers();
  });
  ...
  describe('PutCompanyIceServers', function() {
    it('should create an instance of PutCompanyIceServers', function() {
      // uncomment below and update the code to test PutCompanyIceServers
      //var instance = new RainbowAdminPortal.PutCompanyIceServers();
      //expect(instance).to.be.a(RainbowAdminPortal.PutCompanyIceServers);
    });
