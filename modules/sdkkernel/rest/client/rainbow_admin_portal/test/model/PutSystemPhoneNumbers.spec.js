...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PutSystemPhoneNumbers();
  });
  ...
  describe('PutSystemPhoneNumbers', function() {
    it('should create an instance of PutSystemPhoneNumbers', function() {
      // uncomment below and update the code to test PutSystemPhoneNumbers
      //var instance = new RainbowAdminPortal.PutSystemPhoneNumbers();
      //expect(instance).to.be.a(RainbowAdminPortal.PutSystemPhoneNumbers);
    });
