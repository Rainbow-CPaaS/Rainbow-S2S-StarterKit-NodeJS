...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PutUsersSuccess();
  });
  ...
  describe('PutUsersSuccess', function() {
    it('should create an instance of PutUsersSuccess', function() {
      // uncomment below and update the code to test PutUsersSuccess
      //var instance = new RainbowAdminPortal.PutUsersSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.PutUsersSuccess);
    });
