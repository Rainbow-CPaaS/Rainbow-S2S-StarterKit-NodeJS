...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PutUsersSuccessPhoneNumbers();
  });
  ...
  describe('PutUsersSuccessPhoneNumbers', function() {
    it('should create an instance of PutUsersSuccessPhoneNumbers', function() {
      // uncomment below and update the code to test PutUsersSuccessPhoneNumbers
      //var instance = new RainbowAdminPortal.PutUsersSuccessPhoneNumbers();
      //expect(instance).to.be.a(RainbowAdminPortal.PutUsersSuccessPhoneNumbers);
    });
