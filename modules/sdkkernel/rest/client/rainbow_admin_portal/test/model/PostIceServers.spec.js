...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PostIceServers();
  });
  ...
  describe('PostIceServers', function() {
    it('should create an instance of PostIceServers', function() {
      // uncomment below and update the code to test PostIceServers
      //var instance = new RainbowAdminPortal.PostIceServers();
      //expect(instance).to.be.a(RainbowAdminPortal.PostIceServers);
    });
