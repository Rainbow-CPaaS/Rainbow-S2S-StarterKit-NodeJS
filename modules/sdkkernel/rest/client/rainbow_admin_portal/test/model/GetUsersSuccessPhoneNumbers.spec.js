...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.GetUsersSuccessPhoneNumbers();
  });
  ...
  describe('GetUsersSuccessPhoneNumbers', function() {
    it('should create an instance of GetUsersSuccessPhoneNumbers', function() {
      // uncomment below and update the code to test GetUsersSuccessPhoneNumbers
      //var instance = new RainbowAdminPortal.GetUsersSuccessPhoneNumbers();
      //expect(instance).to.be.a(RainbowAdminPortal.GetUsersSuccessPhoneNumbers);
    });
