...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PutIceServersSuccess();
  });
  ...
  describe('PutIceServersSuccess', function() {
    it('should create an instance of PutIceServersSuccess', function() {
      // uncomment below and update the code to test PutIceServersSuccess
      //var instance = new RainbowAdminPortal.PutIceServersSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.PutIceServersSuccess);
    });
