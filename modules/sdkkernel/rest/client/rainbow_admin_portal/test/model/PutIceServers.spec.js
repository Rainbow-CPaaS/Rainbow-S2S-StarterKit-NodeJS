...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PutIceServers();
  });
  ...
  describe('PutIceServers', function() {
    it('should create an instance of PutIceServers', function() {
      // uncomment below and update the code to test PutIceServers
      //var instance = new RainbowAdminPortal.PutIceServers();
      //expect(instance).to.be.a(RainbowAdminPortal.PutIceServers);
    });
