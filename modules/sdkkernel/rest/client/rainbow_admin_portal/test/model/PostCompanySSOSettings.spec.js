...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PostCompanySSOSettings();
  });
  ...
  describe('PostCompanySSOSettings', function() {
    it('should create an instance of PostCompanySSOSettings', function() {
      // uncomment below and update the code to test PostCompanySSOSettings
      //var instance = new RainbowAdminPortal.PostCompanySSOSettings();
      //expect(instance).to.be.a(RainbowAdminPortal.PostCompanySSOSettings);
    });
