...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.AdminUsersPostUserProfilesSuccess();
  });
  ...
  describe('AdminUsersPostUserProfilesSuccess', function() {
    it('should create an instance of AdminUsersPostUserProfilesSuccess', function() {
      // uncomment below and update the code to test AdminUsersPostUserProfilesSuccess
      //var instance = new RainbowAdminPortal.AdminUsersPostUserProfilesSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.AdminUsersPostUserProfilesSuccess);
    });
