...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PostCompaniesSuccess();
  });
  ...
  describe('PostCompaniesSuccess', function() {
    it('should create an instance of PostCompaniesSuccess', function() {
      // uncomment below and update the code to test PostCompaniesSuccess
      //var instance = new RainbowAdminPortal.PostCompaniesSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.PostCompaniesSuccess);
    });
