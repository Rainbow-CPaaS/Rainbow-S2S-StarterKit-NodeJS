...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PutUsersPhoneNumbers();
  });
  ...
  describe('PutUsersPhoneNumbers', function() {
    it('should create an instance of PutUsersPhoneNumbers', function() {
      // uncomment below and update the code to test PutUsersPhoneNumbers
      //var instance = new RainbowAdminPortal.PutUsersPhoneNumbers();
      //expect(instance).to.be.a(RainbowAdminPortal.PutUsersPhoneNumbers);
    });
