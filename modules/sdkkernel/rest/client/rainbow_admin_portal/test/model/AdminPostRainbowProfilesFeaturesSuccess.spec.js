...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.AdminPostRainbowProfilesFeaturesSuccess();
  });
  ...
  describe('AdminPostRainbowProfilesFeaturesSuccess', function() {
    it('should create an instance of AdminPostRainbowProfilesFeaturesSuccess', function() {
      // uncomment below and update the code to test AdminPostRainbowProfilesFeaturesSuccess
      //var instance = new RainbowAdminPortal.AdminPostRainbowProfilesFeaturesSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.AdminPostRainbowProfilesFeaturesSuccess);
    });
