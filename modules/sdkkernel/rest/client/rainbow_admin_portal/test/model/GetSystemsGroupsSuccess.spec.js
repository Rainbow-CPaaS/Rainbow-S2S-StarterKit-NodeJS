...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.GetSystemsGroupsSuccess();
  });
  ...
  describe('GetSystemsGroupsSuccess', function() {
    it('should create an instance of GetSystemsGroupsSuccess', function() {
      // uncomment below and update the code to test GetSystemsGroupsSuccess
      //var instance = new RainbowAdminPortal.GetSystemsGroupsSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.GetSystemsGroupsSuccess);
    });
