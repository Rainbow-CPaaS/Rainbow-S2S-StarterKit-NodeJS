...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PostUsers();
  });
  ...
  describe('PostUsers', function() {
    it('should create an instance of PostUsers', function() {
      // uncomment below and update the code to test PostUsers
      //var instance = new RainbowAdminPortal.PostUsers();
      //expect(instance).to.be.a(RainbowAdminPortal.PostUsers);
    });
