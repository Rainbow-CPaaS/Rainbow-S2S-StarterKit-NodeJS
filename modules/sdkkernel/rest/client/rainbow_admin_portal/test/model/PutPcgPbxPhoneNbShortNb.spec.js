...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PutPcgPbxPhoneNbShortNb();
  });
  ...
  describe('PutPcgPbxPhoneNbShortNb', function() {
    it('should create an instance of PutPcgPbxPhoneNbShortNb', function() {
      // uncomment below and update the code to test PutPcgPbxPhoneNbShortNb
      //var instance = new RainbowAdminPortal.PutPcgPbxPhoneNbShortNb();
      //expect(instance).to.be.a(RainbowAdminPortal.PutPcgPbxPhoneNbShortNb);
    });
