...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PostIceServersSuccess();
  });
  ...
  describe('PostIceServersSuccess', function() {
    it('should create an instance of PostIceServersSuccess', function() {
      // uncomment below and update the code to test PostIceServersSuccess
      //var instance = new RainbowAdminPortal.PostIceServersSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.PostIceServersSuccess);
    });
