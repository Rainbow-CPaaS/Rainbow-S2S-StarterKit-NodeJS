...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PutCompanySSOSettings();
  });
  ...
  describe('PutCompanySSOSettings', function() {
    it('should create an instance of PutCompanySSOSettings', function() {
      // uncomment below and update the code to test PutCompanySSOSettings
      //var instance = new RainbowAdminPortal.PutCompanySSOSettings();
      //expect(instance).to.be.a(RainbowAdminPortal.PutCompanySSOSettings);
    });
