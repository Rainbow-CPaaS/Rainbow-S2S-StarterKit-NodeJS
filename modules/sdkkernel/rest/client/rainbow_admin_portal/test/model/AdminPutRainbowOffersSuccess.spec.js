...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.AdminPutRainbowOffersSuccess();
  });
  ...
  describe('AdminPutRainbowOffersSuccess', function() {
    it('should create an instance of AdminPutRainbowOffersSuccess', function() {
      // uncomment below and update the code to test AdminPutRainbowOffersSuccess
      //var instance = new RainbowAdminPortal.AdminPutRainbowOffersSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.AdminPutRainbowOffersSuccess);
    });
