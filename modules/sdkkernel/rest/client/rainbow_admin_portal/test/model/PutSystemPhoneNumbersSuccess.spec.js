...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PutSystemPhoneNumbersSuccess();
  });
  ...
  describe('PutSystemPhoneNumbersSuccess', function() {
    it('should create an instance of PutSystemPhoneNumbersSuccess', function() {
      // uncomment below and update the code to test PutSystemPhoneNumbersSuccess
      //var instance = new RainbowAdminPortal.PutSystemPhoneNumbersSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.PutSystemPhoneNumbersSuccess);
    });
