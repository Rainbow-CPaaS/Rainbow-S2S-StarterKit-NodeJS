...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.AdminPostRainbowOffers();
  });
  ...
  describe('AdminPostRainbowOffers', function() {
    it('should create an instance of AdminPostRainbowOffers', function() {
      // uncomment below and update the code to test AdminPostRainbowOffers
      //var instance = new RainbowAdminPortal.AdminPostRainbowOffers();
      //expect(instance).to.be.a(RainbowAdminPortal.AdminPostRainbowOffers);
    });
