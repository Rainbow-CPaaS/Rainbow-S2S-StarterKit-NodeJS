...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.DeleteCompaniesVisibilitySuccess();
  });
  ...
  describe('DeleteCompaniesVisibilitySuccess', function() {
    it('should create an instance of DeleteCompaniesVisibilitySuccess', function() {
      // uncomment below and update the code to test DeleteCompaniesVisibilitySuccess
      //var instance = new RainbowAdminPortal.DeleteCompaniesVisibilitySuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.DeleteCompaniesVisibilitySuccess);
    });
