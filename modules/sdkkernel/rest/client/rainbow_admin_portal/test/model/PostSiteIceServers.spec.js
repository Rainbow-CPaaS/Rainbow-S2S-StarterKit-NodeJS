...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PostSiteIceServers();
  });
  ...
  describe('PostSiteIceServers', function() {
    it('should create an instance of PostSiteIceServers', function() {
      // uncomment below and update the code to test PostSiteIceServers
      //var instance = new RainbowAdminPortal.PostSiteIceServers();
      //expect(instance).to.be.a(RainbowAdminPortal.PostSiteIceServers);
    });
