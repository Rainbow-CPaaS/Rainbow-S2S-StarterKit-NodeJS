...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PostCompanyIceServers();
  });
  ...
  describe('PostCompanyIceServers', function() {
    it('should create an instance of PostCompanyIceServers', function() {
      // uncomment below and update the code to test PostCompanyIceServers
      //var instance = new RainbowAdminPortal.PostCompanyIceServers();
      //expect(instance).to.be.a(RainbowAdminPortal.PostCompanyIceServers);
    });
    ...
    it('should have the property adminLogin (base name: "adminLogin")', function() {
      // uncomment below and update the code to test the property adminLogin
      //var instance = new RainbowAdminPortal.PostCompanyIceServers();
      //expect(instance).to.be();
    });
    ...
    it('should have the property dc (base name: "dc")', function() {
      // uncomment below and update the code to test the property dc
      //var instance = new RainbowAdminPortal.PostCompanyIceServers();
      //expect(instance).to.be();
    });
