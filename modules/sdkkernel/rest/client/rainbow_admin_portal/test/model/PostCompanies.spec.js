...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PostCompanies();
  });
  ...
  describe('PostCompanies', function() {
    it('should create an instance of PostCompanies', function() {
      // uncomment below and update the code to test PostCompanies
      //var instance = new RainbowAdminPortal.PostCompanies();
      //expect(instance).to.be.a(RainbowAdminPortal.PostCompanies);
    });
    ...
    it('should have the property privateDC (base name: "privateDC")', function() {
      // uncomment below and update the code to test the property privateDC
      //var instance = new RainbowAdminPortal.PostCompanies();
      //expect(instance).to.be();
    });
