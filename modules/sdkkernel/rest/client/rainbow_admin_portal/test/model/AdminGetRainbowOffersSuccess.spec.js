...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.AdminGetRainbowOffersSuccess();
  });
  ...
  describe('AdminGetRainbowOffersSuccess', function() {
    it('should create an instance of AdminGetRainbowOffersSuccess', function() {
      // uncomment below and update the code to test AdminGetRainbowOffersSuccess
      //var instance = new RainbowAdminPortal.AdminGetRainbowOffersSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.AdminGetRainbowOffersSuccess);
    });
