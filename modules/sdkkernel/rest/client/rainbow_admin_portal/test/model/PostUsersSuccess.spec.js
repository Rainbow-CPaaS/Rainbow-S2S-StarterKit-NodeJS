...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PostUsersSuccess();
  });
  ...
  describe('PostUsersSuccess', function() {
    it('should create an instance of PostUsersSuccess', function() {
      // uncomment below and update the code to test PostUsersSuccess
      //var instance = new RainbowAdminPortal.PostUsersSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.PostUsersSuccess);
    });
