...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.GetDefaultCompanySuccess();
  });
  ...
  describe('GetDefaultCompanySuccess', function() {
    it('should create an instance of GetDefaultCompanySuccess', function() {
      // uncomment below and update the code to test GetDefaultCompanySuccess
      //var instance = new RainbowAdminPortal.GetDefaultCompanySuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.GetDefaultCompanySuccess);
    });
