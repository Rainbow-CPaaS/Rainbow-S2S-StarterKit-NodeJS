...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.GetSystemsGroupIdSuccess();
  });
  ...
  describe('GetSystemsGroupIdSuccess', function() {
    it('should create an instance of GetSystemsGroupIdSuccess', function() {
      // uncomment below and update the code to test GetSystemsGroupIdSuccess
      //var instance = new RainbowAdminPortal.GetSystemsGroupIdSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.GetSystemsGroupIdSuccess);
    });
