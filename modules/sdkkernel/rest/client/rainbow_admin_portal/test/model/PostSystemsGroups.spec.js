...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PostSystemsGroups();
  });
  ...
  describe('PostSystemsGroups', function() {
    it('should create an instance of PostSystemsGroups', function() {
      // uncomment below and update the code to test PostSystemsGroups
      //var instance = new RainbowAdminPortal.PostSystemsGroups();
      //expect(instance).to.be.a(RainbowAdminPortal.PostSystemsGroups);
    });
