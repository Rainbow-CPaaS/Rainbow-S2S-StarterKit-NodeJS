...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.GetUsersIdSuccessPhoneNumbers();
  });
  ...
  describe('GetUsersIdSuccessPhoneNumbers', function() {
    it('should create an instance of GetUsersIdSuccessPhoneNumbers', function() {
      // uncomment below and update the code to test GetUsersIdSuccessPhoneNumbers
      //var instance = new RainbowAdminPortal.GetUsersIdSuccessPhoneNumbers();
      //expect(instance).to.be.a(RainbowAdminPortal.GetUsersIdSuccessPhoneNumbers);
    });
