...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.GetSystemPhoneNumbersIdSuccess();
  });
  ...
  describe('GetSystemPhoneNumbersIdSuccess', function() {
    it('should create an instance of GetSystemPhoneNumbersIdSuccess', function() {
      // uncomment below and update the code to test GetSystemPhoneNumbersIdSuccess
      //var instance = new RainbowAdminPortal.GetSystemPhoneNumbersIdSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.GetSystemPhoneNumbersIdSuccess);
    });
