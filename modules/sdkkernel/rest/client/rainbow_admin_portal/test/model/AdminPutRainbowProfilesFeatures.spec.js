...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.AdminPutRainbowProfilesFeatures();
  });
  ...
  describe('AdminPutRainbowProfilesFeatures', function() {
    it('should create an instance of AdminPutRainbowProfilesFeatures', function() {
      // uncomment below and update the code to test AdminPutRainbowProfilesFeatures
      //var instance = new RainbowAdminPortal.AdminPutRainbowProfilesFeatures();
      //expect(instance).to.be.a(RainbowAdminPortal.AdminPutRainbowProfilesFeatures);
    });
