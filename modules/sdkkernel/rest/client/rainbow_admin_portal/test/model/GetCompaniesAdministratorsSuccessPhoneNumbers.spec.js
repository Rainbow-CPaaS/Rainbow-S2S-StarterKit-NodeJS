...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.GetCompaniesAdministratorsSuccessPhoneNumbers();
  });
  ...
  describe('GetCompaniesAdministratorsSuccessPhoneNumbers', function() {
    it('should create an instance of GetCompaniesAdministratorsSuccessPhoneNumbers', function() {
      // uncomment below and update the code to test GetCompaniesAdministratorsSuccessPhoneNumbers
      //var instance = new RainbowAdminPortal.GetCompaniesAdministratorsSuccessPhoneNumbers();
      //expect(instance).to.be.a(RainbowAdminPortal.GetCompaniesAdministratorsSuccessPhoneNumbers);
    });
