...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.PostCompaniesVisibilitySuccess();
  });
  ...
  describe('PostCompaniesVisibilitySuccess', function() {
    it('should create an instance of PostCompaniesVisibilitySuccess', function() {
      // uncomment below and update the code to test PostCompaniesVisibilitySuccess
      //var instance = new RainbowAdminPortal.PostCompaniesVisibilitySuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.PostCompaniesVisibilitySuccess);
    });
