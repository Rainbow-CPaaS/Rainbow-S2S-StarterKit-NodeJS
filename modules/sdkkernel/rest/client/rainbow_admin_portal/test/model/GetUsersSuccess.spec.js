...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.GetUsersSuccess();
  });
  ...
  describe('GetUsersSuccess', function() {
    it('should create an instance of GetUsersSuccess', function() {
      // uncomment below and update the code to test GetUsersSuccess
      //var instance = new RainbowAdminPortal.GetUsersSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.GetUsersSuccess);
    });
