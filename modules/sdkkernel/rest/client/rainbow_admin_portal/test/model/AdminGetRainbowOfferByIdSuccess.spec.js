...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.AdminGetRainbowOfferByIdSuccess();
  });
  ...
  describe('AdminGetRainbowOfferByIdSuccess', function() {
    it('should create an instance of AdminGetRainbowOfferByIdSuccess', function() {
      // uncomment below and update the code to test AdminGetRainbowOfferByIdSuccess
      //var instance = new RainbowAdminPortal.AdminGetRainbowOfferByIdSuccess();
      //expect(instance).to.be.a(RainbowAdminPortal.AdminGetRainbowOfferByIdSuccess);
    });
