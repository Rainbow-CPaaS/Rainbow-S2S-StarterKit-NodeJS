...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.AdminPostRainbowProfilesFeatures();
  });
  ...
  describe('AdminPostRainbowProfilesFeatures', function() {
    it('should create an instance of AdminPostRainbowProfilesFeatures', function() {
      // uncomment below and update the code to test AdminPostRainbowProfilesFeatures
      //var instance = new RainbowAdminPortal.AdminPostRainbowProfilesFeatures();
      //expect(instance).to.be.a(RainbowAdminPortal.AdminPostRainbowProfilesFeatures);
    });
