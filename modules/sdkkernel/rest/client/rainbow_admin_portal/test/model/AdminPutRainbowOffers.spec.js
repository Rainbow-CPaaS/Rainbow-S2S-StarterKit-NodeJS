...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowAdminPortal.AdminPutRainbowOffers();
  });
  ...
  describe('AdminPutRainbowOffers', function() {
    it('should create an instance of AdminPutRainbowOffers', function() {
      // uncomment below and update the code to test AdminPutRainbowOffers
      //var instance = new RainbowAdminPortal.AdminPutRainbowOffers();
      //expect(instance).to.be.a(RainbowAdminPortal.AdminPutRainbowOffers);
    });
