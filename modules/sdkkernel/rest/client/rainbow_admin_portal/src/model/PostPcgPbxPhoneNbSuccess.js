...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PostPcgPbxPhoneNbSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PostPcgPbxPhoneNbSuccess model module.
   * @module model/PostPcgPbxPhoneNbSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PostPcgPbxPhoneNbSuccess</code>.
   * @alias module:model/PostPcgPbxPhoneNbSuccess
   * @class
  ...
  /**
   * Constructs a <code>PostPcgPbxPhoneNbSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostPcgPbxPhoneNbSuccess} obj Optional instance to populate.
   * @return {module:model/PostPcgPbxPhoneNbSuccess} The populated <code>PostPcgPbxPhoneNbSuccess</code> instance.
   */
