...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.GetSystemPhoneNumbersSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The GetSystemPhoneNumbersSuccess model module.
   * @module model/GetSystemPhoneNumbersSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetSystemPhoneNumbersSuccess</code>.
   * @alias module:model/GetSystemPhoneNumbersSuccess
   * @class
  ...
  /**
   * Constructs a <code>GetSystemPhoneNumbersSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetSystemPhoneNumbersSuccess} obj Optional instance to populate.
   * @return {module:model/GetSystemPhoneNumbersSuccess} The populated <code>GetSystemPhoneNumbersSuccess</code> instance.
   */
