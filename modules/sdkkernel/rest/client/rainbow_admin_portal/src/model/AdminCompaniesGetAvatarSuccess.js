...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminCompaniesGetAvatarSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminCompaniesGetAvatarSuccess model module.
   * @module model/AdminCompaniesGetAvatarSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminCompaniesGetAvatarSuccess</code>.
   * @alias module:model/AdminCompaniesGetAvatarSuccess
   * @class
   * @param contentType {module:model/AdminCompaniesGetAvatarSuccess.ContentTypeEnum} Avatar content-type.
  ...
  /**
   * Constructs a <code>AdminCompaniesGetAvatarSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminCompaniesGetAvatarSuccess} obj Optional instance to populate.
   * @return {module:model/AdminCompaniesGetAvatarSuccess} The populated <code>AdminCompaniesGetAvatarSuccess</code> instance.
   */
  ...
  /**
   * Avatar content-type.
   * @member {module:model/AdminCompaniesGetAvatarSuccess.ContentTypeEnum} Content-Type
   */
