...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.GetCompanyIceServers = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The GetCompanyIceServers model module.
   * @module model/GetCompanyIceServers
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetCompanyIceServers</code>.
   * @alias module:model/GetCompanyIceServers
   * @class
   */
  ...
  /**
   * Constructs a <code>GetCompanyIceServers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetCompanyIceServers} obj Optional instance to populate.
   * @return {module:model/GetCompanyIceServers} The populated <code>GetCompanyIceServers</code> instance.
   */
