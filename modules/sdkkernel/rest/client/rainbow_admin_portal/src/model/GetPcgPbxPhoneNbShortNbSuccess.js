...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.GetPcgPbxPhoneNbShortNbSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The GetPcgPbxPhoneNbShortNbSuccess model module.
   * @module model/GetPcgPbxPhoneNbShortNbSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetPcgPbxPhoneNbShortNbSuccess</code>.
   * @alias module:model/GetPcgPbxPhoneNbShortNbSuccess
   * @class
  ...
  /**
   * Constructs a <code>GetPcgPbxPhoneNbShortNbSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetPcgPbxPhoneNbShortNbSuccess} obj Optional instance to populate.
   * @return {module:model/GetPcgPbxPhoneNbShortNbSuccess} The populated <code>GetPcgPbxPhoneNbShortNbSuccess</code> instance.
   */
