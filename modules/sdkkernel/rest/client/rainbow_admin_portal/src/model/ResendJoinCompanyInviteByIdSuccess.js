...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.ResendJoinCompanyInviteByIdSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The ResendJoinCompanyInviteByIdSuccess model module.
   * @module model/ResendJoinCompanyInviteByIdSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>ResendJoinCompanyInviteByIdSuccess</code>.
   * @alias module:model/ResendJoinCompanyInviteByIdSuccess
   * @class
  ...
  /**
   * Constructs a <code>ResendJoinCompanyInviteByIdSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResendJoinCompanyInviteByIdSuccess} obj Optional instance to populate.
   * @return {module:model/ResendJoinCompanyInviteByIdSuccess} The populated <code>ResendJoinCompanyInviteByIdSuccess</code> instance.
   */
