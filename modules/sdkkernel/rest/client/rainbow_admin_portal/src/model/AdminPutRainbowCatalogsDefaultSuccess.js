...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminPutRainbowCatalogsDefaultSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminPutRainbowCatalogsDefaultSuccess model module.
   * @module model/AdminPutRainbowCatalogsDefaultSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPutRainbowCatalogsDefaultSuccess</code>.
   * @alias module:model/AdminPutRainbowCatalogsDefaultSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPutRainbowCatalogsDefaultSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPutRainbowCatalogsDefaultSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPutRainbowCatalogsDefaultSuccess} The populated <code>AdminPutRainbowCatalogsDefaultSuccess</code> instance.
   */
