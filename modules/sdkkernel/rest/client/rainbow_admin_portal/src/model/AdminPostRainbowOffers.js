...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AdminPostRainbowOffersProvisioningNeeded'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AdminPostRainbowOffersProvisioningNeeded'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.AdminPostRainbowOffers = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.AdminPostRainbowOffersProvisioningNeeded);
  }
}(this, function(ApiClient, AdminPostRainbowOffersProvisioningNeeded) {
  'use strict';



  /**
   * The AdminPostRainbowOffers model module.
   * @module model/AdminPostRainbowOffers
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPostRainbowOffers</code>.
   * @alias module:model/AdminPostRainbowOffers
   * @class
   * @param name {String} Offer name.
   * @param profileId {String} Id of the profile linked to this offer.
   */
  var exports = function(name, profileId) {
    var _this = this;
  ...
  /**
   * Constructs a <code>AdminPostRainbowOffers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPostRainbowOffers} obj Optional instance to populate.
   * @return {module:model/AdminPostRainbowOffers} The populated <code>AdminPostRainbowOffers</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('provisioningNeeded')) {
        obj['provisioningNeeded'] = ApiClient.convertToType(data['provisioningNeeded'], [AdminPostRainbowOffersProvisioningNeeded]);
      }
   ...
   * @member {module:model/AdminPostRainbowOffers.BusinessModelEnum} businessModel
   * @default 'none'
   */
   ...
   * @member {Array.<module:model/AdminPostRainbowOffersProvisioningNeeded>} provisioningNeeded
   */
