...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AdminPostRainbowOffersSuccessProvisioningNeeded'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AdminPostRainbowOffersSuccessProvisioningNeeded'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.AdminPostRainbowOffersSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.AdminPostRainbowOffersSuccessProvisioningNeeded);
  }
}(this, function(ApiClient, AdminPostRainbowOffersSuccessProvisioningNeeded) {
  'use strict';



  /**
   * The AdminPostRainbowOffersSuccess model module.
   * @module model/AdminPostRainbowOffersSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPostRainbowOffersSuccess</code>.
   * @alias module:model/AdminPostRainbowOffersSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPostRainbowOffersSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPostRainbowOffersSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPostRainbowOffersSuccess} The populated <code>AdminPostRainbowOffersSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('provisioningNeeded')) {
        obj['provisioningNeeded'] = ApiClient.convertToType(data['provisioningNeeded'], [AdminPostRainbowOffersSuccessProvisioningNeeded]);
      }
   ...
   * @member {module:model/AdminPostRainbowOffersSuccess.BusinessModelEnum} businessModel
   */
   ...
   * @member {Array.<module:model/AdminPostRainbowOffersSuccessProvisioningNeeded>} provisioningNeeded
   */
