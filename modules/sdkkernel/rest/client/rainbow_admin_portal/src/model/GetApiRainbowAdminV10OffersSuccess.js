...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetApiRainbowAdminV10OffersSuccessProvisioningNeeded'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetApiRainbowAdminV10OffersSuccessProvisioningNeeded'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.GetApiRainbowAdminV10OffersSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.GetApiRainbowAdminV10OffersSuccessProvisioningNeeded);
  }
}(this, function(ApiClient, GetApiRainbowAdminV10OffersSuccessProvisioningNeeded) {
  'use strict';



  /**
   * The GetApiRainbowAdminV10OffersSuccess model module.
   * @module model/GetApiRainbowAdminV10OffersSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetApiRainbowAdminV10OffersSuccess</code>.
   * @alias module:model/GetApiRainbowAdminV10OffersSuccess
   * @class
  ...
  /**
   * Constructs a <code>GetApiRainbowAdminV10OffersSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetApiRainbowAdminV10OffersSuccess} obj Optional instance to populate.
   * @return {module:model/GetApiRainbowAdminV10OffersSuccess} The populated <code>GetApiRainbowAdminV10OffersSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('provisioningNeeded')) {
        obj['provisioningNeeded'] = ApiClient.convertToType(data['provisioningNeeded'], [GetApiRainbowAdminV10OffersSuccessProvisioningNeeded]);
      }
   ...
   * @member {module:model/GetApiRainbowAdminV10OffersSuccess.BusinessModelEnum} businessModel
   */
   ...
   * @member {Array.<module:model/GetApiRainbowAdminV10OffersSuccessProvisioningNeeded>} provisioningNeeded
   */
