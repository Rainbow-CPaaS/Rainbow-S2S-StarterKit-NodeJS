...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PostSiteIceServers = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PostSiteIceServers model module.
   * @module model/PostSiteIceServers
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PostSiteIceServers</code>.
   * @alias module:model/PostSiteIceServers
   * @class
  ...
  /**
   * Constructs a <code>PostSiteIceServers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostSiteIceServers} obj Optional instance to populate.
   * @return {module:model/PostSiteIceServers} The populated <code>PostSiteIceServers</code> instance.
   */
