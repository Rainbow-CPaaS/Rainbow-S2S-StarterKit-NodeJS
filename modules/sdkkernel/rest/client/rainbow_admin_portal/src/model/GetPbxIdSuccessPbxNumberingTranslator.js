...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.GetPbxIdSuccessPbxNumberingTranslator = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The GetPbxIdSuccessPbxNumberingTranslator model module.
   * @module model/GetPbxIdSuccessPbxNumberingTranslator
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetPbxIdSuccessPbxNumberingTranslator</code>.
   * @alias module:model/GetPbxIdSuccessPbxNumberingTranslator
   * @class
  ...
  /**
   * Constructs a <code>GetPbxIdSuccessPbxNumberingTranslator</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetPbxIdSuccessPbxNumberingTranslator} obj Optional instance to populate.
   * @return {module:model/GetPbxIdSuccessPbxNumberingTranslator} The populated <code>GetPbxIdSuccessPbxNumberingTranslator</code> instance.
   */
