...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminPutRainbowProfilesSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminPutRainbowProfilesSuccess model module.
   * @module model/AdminPutRainbowProfilesSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPutRainbowProfilesSuccess</code>.
   * @alias module:model/AdminPutRainbowProfilesSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPutRainbowProfilesSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPutRainbowProfilesSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPutRainbowProfilesSuccess} The populated <code>AdminPutRainbowProfilesSuccess</code> instance.
   */
