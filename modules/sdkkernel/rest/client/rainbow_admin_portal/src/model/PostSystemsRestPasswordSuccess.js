...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PostSystemsRestPasswordSuccessPbxNumberingTranslator'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PostSystemsRestPasswordSuccessPbxNumberingTranslator'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.PostSystemsRestPasswordSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.PostSystemsRestPasswordSuccessPbxNumberingTranslator);
  }
}(this, function(ApiClient, PostSystemsRestPasswordSuccessPbxNumberingTranslator) {
  'use strict';



  /**
   * The PostSystemsRestPasswordSuccess model module.
   * @module model/PostSystemsRestPasswordSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PostSystemsRestPasswordSuccess</code>.
   * @alias module:model/PostSystemsRestPasswordSuccess
   * @class
  ...
  /**
   * Constructs a <code>PostSystemsRestPasswordSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostSystemsRestPasswordSuccess} obj Optional instance to populate.
   * @return {module:model/PostSystemsRestPasswordSuccess} The populated <code>PostSystemsRestPasswordSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('pbxNumberingTranslator')) {
        obj['pbxNumberingTranslator'] = ApiClient.convertToType(data['pbxNumberingTranslator'], [PostSystemsRestPasswordSuccessPbxNumberingTranslator]);
      }
   ...
   * @member {module:model/PostSystemsRestPasswordSuccess.StatusEnum} status
   * @default 'created'
   */
   ...
   * @member {Array.<module:model/PostSystemsRestPasswordSuccessPbxNumberingTranslator>} pbxNumberingTranslator
   */
