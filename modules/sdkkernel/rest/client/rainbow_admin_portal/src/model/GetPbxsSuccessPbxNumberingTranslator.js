...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.GetPbxsSuccessPbxNumberingTranslator = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The GetPbxsSuccessPbxNumberingTranslator model module.
   * @module model/GetPbxsSuccessPbxNumberingTranslator
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetPbxsSuccessPbxNumberingTranslator</code>.
   * @alias module:model/GetPbxsSuccessPbxNumberingTranslator
   * @class
  ...
  /**
   * Constructs a <code>GetPbxsSuccessPbxNumberingTranslator</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetPbxsSuccessPbxNumberingTranslator} obj Optional instance to populate.
   * @return {module:model/GetPbxsSuccessPbxNumberingTranslator} The populated <code>GetPbxsSuccessPbxNumberingTranslator</code> instance.
   */
