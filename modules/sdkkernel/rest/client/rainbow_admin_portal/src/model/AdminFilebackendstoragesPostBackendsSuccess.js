...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminFilebackendstoragesPostBackendsSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminFilebackendstoragesPostBackendsSuccess model module.
   * @module model/AdminFilebackendstoragesPostBackendsSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminFilebackendstoragesPostBackendsSuccess</code>.
   * @alias module:model/AdminFilebackendstoragesPostBackendsSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminFilebackendstoragesPostBackendsSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminFilebackendstoragesPostBackendsSuccess} obj Optional instance to populate.
   * @return {module:model/AdminFilebackendstoragesPostBackendsSuccess} The populated <code>AdminFilebackendstoragesPostBackendsSuccess</code> instance.
   */
