...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PostUsersEmails', 'model/PostUsersPhoneNumbers'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PostUsersEmails'), require('./PostUsersPhoneNumbers'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.PostUsers = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.PostUsersEmails, root.RainbowAdminPortal.PostUsersPhoneNumbers);
  }
}(this, function(ApiClient, PostUsersEmails, PostUsersPhoneNumbers) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('emails')) {
        obj['emails'] = ApiClient.convertToType(data['emails'], [PostUsersEmails]);
      }
      if (data.hasOwnProperty('phoneNumbers')) {
        obj['phoneNumbers'] = ApiClient.convertToType(data['phoneNumbers'], [PostUsersPhoneNumbers]);
      }
   ...
   * @member {module:model/PostUsers.StateEnum} state
   */
   ...
   * @member {module:model/PostUsers.AccountTypeEnum} accountType
   * @default 'free'
   */
   ...
   * @member {module:model/PostUsers.AdminTypeEnum} adminType
   */
   ...
   * @member {module:model/PostUsers.VisibilityEnum} visibility
   */
   ...
   * @member {module:model/PostUsers.AuthenticationTypeEnum} authenticationType
   */
