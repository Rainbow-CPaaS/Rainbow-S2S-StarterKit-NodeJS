...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminGetRainbowFeaturesSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminGetRainbowFeaturesSuccess model module.
   * @module model/AdminGetRainbowFeaturesSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminGetRainbowFeaturesSuccess</code>.
   * @alias module:model/AdminGetRainbowFeaturesSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminGetRainbowFeaturesSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminGetRainbowFeaturesSuccess} obj Optional instance to populate.
   * @return {module:model/AdminGetRainbowFeaturesSuccess} The populated <code>AdminGetRainbowFeaturesSuccess</code> instance.
   */
