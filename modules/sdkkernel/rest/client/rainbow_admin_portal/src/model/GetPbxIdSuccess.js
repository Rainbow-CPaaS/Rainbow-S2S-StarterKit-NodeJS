...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetPbxIdSuccessPbxGroup', 'model/GetPbxIdSuccessPbxNumberingTranslator'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetPbxIdSuccessPbxGroup'), require('./GetPbxIdSuccessPbxNumberingTranslator'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.GetPbxIdSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.GetPbxIdSuccessPbxGroup, root.RainbowAdminPortal.GetPbxIdSuccessPbxNumberingTranslator);
  }
}(this, function(ApiClient, GetPbxIdSuccessPbxGroup, GetPbxIdSuccessPbxNumberingTranslator) {
  'use strict';



  /**
   * The GetPbxIdSuccess model module.
   * @module model/GetPbxIdSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetPbxIdSuccess</code>.
   * @alias module:model/GetPbxIdSuccess
   * @class
   * @param country {String} System country (ISO 3166-1 alpha2 format)
   * @param pbxGroup {Array.<module:model/GetPbxIdSuccessPbxGroup>} Set of pabx sharing the same unified dial plan. List of object (systemId, pbxId)
   ...
   * @param status {module:model/GetPbxIdSuccess.StatusEnum} CCA status report. (read only) > - `created`: CCA uses a public access code to join rainbow infrastructure (see jid_pbxagent_password field) > - `activating`: Rainbow infrastructure has proposed a private access code to replace the former public access code > - `activated`: CCA has accepted the new access code, that will be used for the next initialization.
   * @param serverPingTimeout {String} CCA config data
   * @param pbxMainBundlePrefix {Array.<String>} CCA config data
   * @param pbxNumberingTranslator {Array.<module:model/GetPbxIdSuccessPbxNumberingTranslator>} list of several regular expressions used to validate internal or external phone numbers. Up to 100 regular expressions are allowed. (64 max char by regexp). To reset the list, use []
  ...
  /**
   * Constructs a <code>GetPbxIdSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetPbxIdSuccess} obj Optional instance to populate.
   * @return {module:model/GetPbxIdSuccess} The populated <code>GetPbxIdSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('pbxGroup')) {
        obj['pbxGroup'] = ApiClient.convertToType(data['pbxGroup'], [GetPbxIdSuccessPbxGroup]);
      }
      ...
      if (data.hasOwnProperty('pbxNumberingTranslator')) {
        obj['pbxNumberingTranslator'] = ApiClient.convertToType(data['pbxNumberingTranslator'], [GetPbxIdSuccessPbxNumberingTranslator]);
      }
  ...
  /**
   * System country (ISO 3166-1 alpha2 format)
   * @member {String} country
   */
  exports.prototype['country'] = undefined;
  /**
   * Set of pabx sharing the same unified dial plan. List of object (systemId, pbxId)
   * @member {Array.<module:model/GetPbxIdSuccessPbxGroup>} pbxGroup
   */
  exports.prototype['pbxGroup'] = undefined;
  /**
   ...
   * @member {module:model/GetPbxIdSuccess.StatusEnum} status
   * @default 'created'
   */
   ...
   * @member {Array.<module:model/GetPbxIdSuccessPbxNumberingTranslator>} pbxNumberingTranslator
   */
