...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminPostRainbowCatalogsFeaturesSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminPostRainbowCatalogsFeaturesSuccess model module.
   * @module model/AdminPostRainbowCatalogsFeaturesSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPostRainbowCatalogsFeaturesSuccess</code>.
   * @alias module:model/AdminPostRainbowCatalogsFeaturesSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPostRainbowCatalogsFeaturesSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPostRainbowCatalogsFeaturesSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPostRainbowCatalogsFeaturesSuccess} The populated <code>AdminPostRainbowCatalogsFeaturesSuccess</code> instance.
   */
