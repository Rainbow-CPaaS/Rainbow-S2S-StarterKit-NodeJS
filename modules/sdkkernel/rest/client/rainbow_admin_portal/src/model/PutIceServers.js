...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PutIceServers = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PutIceServers model module.
   * @module model/PutIceServers
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PutIceServers</code>.
   * @alias module:model/PutIceServers
   * @class
  ...
  /**
   * Constructs a <code>PutIceServers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PutIceServers} obj Optional instance to populate.
   * @return {module:model/PutIceServers} The populated <code>PutIceServers</code> instance.
   */
