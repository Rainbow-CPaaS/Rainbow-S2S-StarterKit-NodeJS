...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminPostLinkEcToBpInviteSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminPostLinkEcToBpInviteSuccess model module.
   * @module model/AdminPostLinkEcToBpInviteSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPostLinkEcToBpInviteSuccess</code>.
   * @alias module:model/AdminPostLinkEcToBpInviteSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPostLinkEcToBpInviteSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPostLinkEcToBpInviteSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPostLinkEcToBpInviteSuccess} The populated <code>AdminPostLinkEcToBpInviteSuccess</code> instance.
   */
