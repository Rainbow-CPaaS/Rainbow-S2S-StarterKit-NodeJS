...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PutPcgPbxPhoneNbShortNbSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PutPcgPbxPhoneNbShortNbSuccess model module.
   * @module model/PutPcgPbxPhoneNbShortNbSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PutPcgPbxPhoneNbShortNbSuccess</code>.
   * @alias module:model/PutPcgPbxPhoneNbShortNbSuccess
   * @class
  ...
  /**
   * Constructs a <code>PutPcgPbxPhoneNbShortNbSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PutPcgPbxPhoneNbShortNbSuccess} obj Optional instance to populate.
   * @return {module:model/PutPcgPbxPhoneNbShortNbSuccess} The populated <code>PutPcgPbxPhoneNbShortNbSuccess</code> instance.
   */
