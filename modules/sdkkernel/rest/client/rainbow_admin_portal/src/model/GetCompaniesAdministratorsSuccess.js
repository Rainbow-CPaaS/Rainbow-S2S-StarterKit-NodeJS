...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetCompaniesAdministratorsSuccessCreatedByAdmin', 'model/GetCompaniesAdministratorsSuccessEmails', 'model/GetCompaniesAdministratorsSuccessPhoneNumbers'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetCompaniesAdministratorsSuccessCreatedByAdmin'), require('./GetCompaniesAdministratorsSuccessEmails'), require('./GetCompaniesAdministratorsSuccessPhoneNumbers'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.GetCompaniesAdministratorsSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.GetCompaniesAdministratorsSuccessCreatedByAdmin, root.RainbowAdminPortal.GetCompaniesAdministratorsSuccessEmails, root.RainbowAdminPortal.GetCompaniesAdministratorsSuccessPhoneNumbers);
  }
}(this, function(ApiClient, GetCompaniesAdministratorsSuccessCreatedByAdmin, GetCompaniesAdministratorsSuccessEmails, GetCompaniesAdministratorsSuccessPhoneNumbers) {
  'use strict';



  /**
   * The GetCompaniesAdministratorsSuccess model module.
   * @module model/GetCompaniesAdministratorsSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetCompaniesAdministratorsSuccess</code>.
   * @alias module:model/GetCompaniesAdministratorsSuccess
   * @class
   ...
   * @param emails {Array.<module:model/GetCompaniesAdministratorsSuccessEmails>} Array of user emails addresses objects
   * @param phoneNumbers {Array.<module:model/GetCompaniesAdministratorsSuccessPhoneNumbers>} Array of user phone numbers objects.    Phone number objects can:   * be created by user (information filled by user), * come from association with a system (pbx) device (association is done by admin).  
  ...
  /**
   * Constructs a <code>GetCompaniesAdministratorsSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetCompaniesAdministratorsSuccess} obj Optional instance to populate.
   * @return {module:model/GetCompaniesAdministratorsSuccess} The populated <code>GetCompaniesAdministratorsSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('emails')) {
        obj['emails'] = ApiClient.convertToType(data['emails'], [GetCompaniesAdministratorsSuccessEmails]);
      }
      if (data.hasOwnProperty('phoneNumbers')) {
        obj['phoneNumbers'] = ApiClient.convertToType(data['phoneNumbers'], [GetCompaniesAdministratorsSuccessPhoneNumbers]);
      }
   ...
   * @member {Array.<module:model/GetCompaniesAdministratorsSuccessEmails>} emails
   */
   ...
   * @member {Array.<module:model/GetCompaniesAdministratorsSuccessPhoneNumbers>} phoneNumbers
   */
   ...
   * @member {module:model/GetCompaniesAdministratorsSuccess.StateEnum} state
   */
