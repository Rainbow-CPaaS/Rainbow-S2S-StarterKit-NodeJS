...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminGetDefaultRainbowCatalogSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminGetDefaultRainbowCatalogSuccess model module.
   * @module model/AdminGetDefaultRainbowCatalogSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminGetDefaultRainbowCatalogSuccess</code>.
   * @alias module:model/AdminGetDefaultRainbowCatalogSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminGetDefaultRainbowCatalogSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminGetDefaultRainbowCatalogSuccess} obj Optional instance to populate.
   * @return {module:model/AdminGetDefaultRainbowCatalogSuccess} The populated <code>AdminGetDefaultRainbowCatalogSuccess</code> instance.
   */
