...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminBotsPostBotsSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminBotsPostBotsSuccess model module.
   * @module model/AdminBotsPostBotsSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminBotsPostBotsSuccess</code>.
   * @alias module:model/AdminBotsPostBotsSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminBotsPostBotsSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminBotsPostBotsSuccess} obj Optional instance to populate.
   * @return {module:model/AdminBotsPostBotsSuccess} The populated <code>AdminBotsPostBotsSuccess</code> instance.
   */
