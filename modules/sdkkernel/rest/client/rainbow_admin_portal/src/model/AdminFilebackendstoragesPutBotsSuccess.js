...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminFilebackendstoragesPutBotsSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminFilebackendstoragesPutBotsSuccess model module.
   * @module model/AdminFilebackendstoragesPutBotsSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminFilebackendstoragesPutBotsSuccess</code>.
   * @alias module:model/AdminFilebackendstoragesPutBotsSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminFilebackendstoragesPutBotsSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminFilebackendstoragesPutBotsSuccess} obj Optional instance to populate.
   * @return {module:model/AdminFilebackendstoragesPutBotsSuccess} The populated <code>AdminFilebackendstoragesPutBotsSuccess</code> instance.
   */
