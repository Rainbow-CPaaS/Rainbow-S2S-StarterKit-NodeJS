...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminBotsPutBotsSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminBotsPutBotsSuccess model module.
   * @module model/AdminBotsPutBotsSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminBotsPutBotsSuccess</code>.
   * @alias module:model/AdminBotsPutBotsSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminBotsPutBotsSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminBotsPutBotsSuccess} obj Optional instance to populate.
   * @return {module:model/AdminBotsPutBotsSuccess} The populated <code>AdminBotsPutBotsSuccess</code> instance.
   */
