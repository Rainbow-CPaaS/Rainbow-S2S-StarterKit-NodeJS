...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.GetLinkECToBPRequestsSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The GetLinkECToBPRequestsSuccess model module.
   * @module model/GetLinkECToBPRequestsSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetLinkECToBPRequestsSuccess</code>.
   * @alias module:model/GetLinkECToBPRequestsSuccess
   * @class
  ...
  /**
   * Constructs a <code>GetLinkECToBPRequestsSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetLinkECToBPRequestsSuccess} obj Optional instance to populate.
   * @return {module:model/GetLinkECToBPRequestsSuccess} The populated <code>GetLinkECToBPRequestsSuccess</code> instance.
   */
