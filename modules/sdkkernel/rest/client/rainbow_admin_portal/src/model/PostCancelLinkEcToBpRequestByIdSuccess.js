...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PostCancelLinkEcToBpRequestByIdSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PostCancelLinkEcToBpRequestByIdSuccess model module.
   * @module model/PostCancelLinkEcToBpRequestByIdSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PostCancelLinkEcToBpRequestByIdSuccess</code>.
   * @alias module:model/PostCancelLinkEcToBpRequestByIdSuccess
   * @class
  ...
  /**
   * Constructs a <code>PostCancelLinkEcToBpRequestByIdSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostCancelLinkEcToBpRequestByIdSuccess} obj Optional instance to populate.
   * @return {module:model/PostCancelLinkEcToBpRequestByIdSuccess} The populated <code>PostCancelLinkEcToBpRequestByIdSuccess</code> instance.
   */
