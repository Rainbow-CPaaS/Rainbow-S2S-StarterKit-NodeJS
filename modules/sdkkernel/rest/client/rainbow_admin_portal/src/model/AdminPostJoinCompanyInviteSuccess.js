...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminPostJoinCompanyInviteSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminPostJoinCompanyInviteSuccess model module.
   * @module model/AdminPostJoinCompanyInviteSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPostJoinCompanyInviteSuccess</code>.
   * @alias module:model/AdminPostJoinCompanyInviteSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPostJoinCompanyInviteSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPostJoinCompanyInviteSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPostJoinCompanyInviteSuccess} The populated <code>AdminPostJoinCompanyInviteSuccess</code> instance.
   */
