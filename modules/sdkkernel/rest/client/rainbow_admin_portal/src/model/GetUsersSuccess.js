...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetCompaniesAdministratorsSuccessCreatedByAdmin', 'model/GetUsersSuccessEmails', 'model/GetUsersSuccessPhoneNumbers'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetCompaniesAdministratorsSuccessCreatedByAdmin'), require('./GetUsersSuccessEmails'), require('./GetUsersSuccessPhoneNumbers'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.GetUsersSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.GetCompaniesAdministratorsSuccessCreatedByAdmin, root.RainbowAdminPortal.GetUsersSuccessEmails, root.RainbowAdminPortal.GetUsersSuccessPhoneNumbers);
  }
}(this, function(ApiClient, GetCompaniesAdministratorsSuccessCreatedByAdmin, GetUsersSuccessEmails, GetUsersSuccessPhoneNumbers) {
  'use strict';



  /**
   * The GetUsersSuccess model module.
   * @module model/GetUsersSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetUsersSuccess</code>.
   * @alias module:model/GetUsersSuccess
   * @class
   ...
   * @param emails {Array.<module:model/GetUsersSuccessEmails>} Array of user emails addresses objects
   * @param phoneNumbers {Array.<module:model/GetUsersSuccessPhoneNumbers>} Array of user phone numbers objects.    Phone number objects can:   * be created by user (information filled by user), * come from association with a system (pbx) device (association is done by admin).  
  ...
  /**
   * Constructs a <code>GetUsersSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetUsersSuccess} obj Optional instance to populate.
   * @return {module:model/GetUsersSuccess} The populated <code>GetUsersSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('emails')) {
        obj['emails'] = ApiClient.convertToType(data['emails'], [GetUsersSuccessEmails]);
      }
      if (data.hasOwnProperty('phoneNumbers')) {
        obj['phoneNumbers'] = ApiClient.convertToType(data['phoneNumbers'], [GetUsersSuccessPhoneNumbers]);
      }
   ...
   * @member {Array.<module:model/GetUsersSuccessEmails>} emails
   */
   ...
   * @member {Array.<module:model/GetUsersSuccessPhoneNumbers>} phoneNumbers
   */
   ...
   * @member {module:model/GetUsersSuccess.StateEnum} state
   */
