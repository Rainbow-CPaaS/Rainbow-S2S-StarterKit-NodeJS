...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AdminGetRainbowOfferByIdSuccessProvisioningNeeded'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AdminGetRainbowOfferByIdSuccessProvisioningNeeded'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.AdminGetRainbowOfferByIdSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.AdminGetRainbowOfferByIdSuccessProvisioningNeeded);
  }
}(this, function(ApiClient, AdminGetRainbowOfferByIdSuccessProvisioningNeeded) {
  'use strict';



  /**
   * The AdminGetRainbowOfferByIdSuccess model module.
   * @module model/AdminGetRainbowOfferByIdSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminGetRainbowOfferByIdSuccess</code>.
   * @alias module:model/AdminGetRainbowOfferByIdSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminGetRainbowOfferByIdSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminGetRainbowOfferByIdSuccess} obj Optional instance to populate.
   * @return {module:model/AdminGetRainbowOfferByIdSuccess} The populated <code>AdminGetRainbowOfferByIdSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('provisioningNeeded')) {
        obj['provisioningNeeded'] = ApiClient.convertToType(data['provisioningNeeded'], [AdminGetRainbowOfferByIdSuccessProvisioningNeeded]);
      }
   ...
   * @member {module:model/AdminGetRainbowOfferByIdSuccess.BusinessModelEnum} businessModel
   */
   ...
   * @member {Array.<module:model/AdminGetRainbowOfferByIdSuccessProvisioningNeeded>} provisioningNeeded
   */
