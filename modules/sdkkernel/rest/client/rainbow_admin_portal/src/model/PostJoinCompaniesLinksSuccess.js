...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PostJoinCompaniesLinksSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PostJoinCompaniesLinksSuccess model module.
   * @module model/PostJoinCompaniesLinksSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PostJoinCompaniesLinksSuccess</code>.
   * @alias module:model/PostJoinCompaniesLinksSuccess
   * @class
  ...
  /**
   * Constructs a <code>PostJoinCompaniesLinksSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostJoinCompaniesLinksSuccess} obj Optional instance to populate.
   * @return {module:model/PostJoinCompaniesLinksSuccess} The populated <code>PostJoinCompaniesLinksSuccess</code> instance.
   */
