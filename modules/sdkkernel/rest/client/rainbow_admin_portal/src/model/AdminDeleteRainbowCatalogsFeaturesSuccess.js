...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminDeleteRainbowCatalogsFeaturesSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminDeleteRainbowCatalogsFeaturesSuccess model module.
   * @module model/AdminDeleteRainbowCatalogsFeaturesSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminDeleteRainbowCatalogsFeaturesSuccess</code>.
   * @alias module:model/AdminDeleteRainbowCatalogsFeaturesSuccess
   * @class
   ...
   */
  var exports = function(status, id, name, description, isDefault, creationDate, offersList) {
    var _this = this;
  ...
  /**
   * Constructs a <code>AdminDeleteRainbowCatalogsFeaturesSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminDeleteRainbowCatalogsFeaturesSuccess} obj Optional instance to populate.
   * @return {module:model/AdminDeleteRainbowCatalogsFeaturesSuccess} The populated <code>AdminDeleteRainbowCatalogsFeaturesSuccess</code> instance.
   */
