...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminPostAcceptLinkEcToBpInvitationSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminPostAcceptLinkEcToBpInvitationSuccess model module.
   * @module model/AdminPostAcceptLinkEcToBpInvitationSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPostAcceptLinkEcToBpInvitationSuccess</code>.
   * @alias module:model/AdminPostAcceptLinkEcToBpInvitationSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPostAcceptLinkEcToBpInvitationSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPostAcceptLinkEcToBpInvitationSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPostAcceptLinkEcToBpInvitationSuccess} The populated <code>AdminPostAcceptLinkEcToBpInvitationSuccess</code> instance.
   */
