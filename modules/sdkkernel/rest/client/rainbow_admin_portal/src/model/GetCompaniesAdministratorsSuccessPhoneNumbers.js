...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.GetCompaniesAdministratorsSuccessPhoneNumbers = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The GetCompaniesAdministratorsSuccessPhoneNumbers model module.
   * @module model/GetCompaniesAdministratorsSuccessPhoneNumbers
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetCompaniesAdministratorsSuccessPhoneNumbers</code>.
   * @alias module:model/GetCompaniesAdministratorsSuccessPhoneNumbers
   * @class
  ...
  /**
   * Constructs a <code>GetCompaniesAdministratorsSuccessPhoneNumbers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetCompaniesAdministratorsSuccessPhoneNumbers} obj Optional instance to populate.
   * @return {module:model/GetCompaniesAdministratorsSuccessPhoneNumbers} The populated <code>GetCompaniesAdministratorsSuccessPhoneNumbers</code> instance.
   */
