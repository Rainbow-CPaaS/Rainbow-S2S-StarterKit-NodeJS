...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminCompaniesGetBannerSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminCompaniesGetBannerSuccess model module.
   * @module model/AdminCompaniesGetBannerSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminCompaniesGetBannerSuccess</code>.
   * @alias module:model/AdminCompaniesGetBannerSuccess
   * @class
   * @param contentType {module:model/AdminCompaniesGetBannerSuccess.ContentTypeEnum} Avatar content-type.
   * @param dimsCached {String} Whether or not the resize avatar file has been cached by nginx.
   * @param lastModified {Date} Last avatar update date.
  ...
  /**
   * Constructs a <code>AdminCompaniesGetBannerSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminCompaniesGetBannerSuccess} obj Optional instance to populate.
   * @return {module:model/AdminCompaniesGetBannerSuccess} The populated <code>AdminCompaniesGetBannerSuccess</code> instance.
   */
  ...
  /**
   * Avatar content-type.
   * @member {module:model/AdminCompaniesGetBannerSuccess.ContentTypeEnum} Content-Type
   */
