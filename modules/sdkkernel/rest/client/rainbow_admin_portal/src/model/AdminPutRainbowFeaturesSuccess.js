...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminPutRainbowFeaturesSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminPutRainbowFeaturesSuccess model module.
   * @module model/AdminPutRainbowFeaturesSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPutRainbowFeaturesSuccess</code>.
   * @alias module:model/AdminPutRainbowFeaturesSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPutRainbowFeaturesSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPutRainbowFeaturesSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPutRainbowFeaturesSuccess} The populated <code>AdminPutRainbowFeaturesSuccess</code> instance.
   */
