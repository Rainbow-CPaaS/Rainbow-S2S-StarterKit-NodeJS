...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminPostRainbowProfilesSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminPostRainbowProfilesSuccess model module.
   * @module model/AdminPostRainbowProfilesSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPostRainbowProfilesSuccess</code>.
   * @alias module:model/AdminPostRainbowProfilesSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPostRainbowProfilesSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPostRainbowProfilesSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPostRainbowProfilesSuccess} The populated <code>AdminPostRainbowProfilesSuccess</code> instance.
   */
