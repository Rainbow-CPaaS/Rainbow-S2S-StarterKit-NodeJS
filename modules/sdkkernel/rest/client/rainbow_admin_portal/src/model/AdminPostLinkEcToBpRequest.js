...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminPostLinkEcToBpRequest = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminPostLinkEcToBpRequest model module.
   * @module model/AdminPostLinkEcToBpRequest
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPostLinkEcToBpRequest</code>.
   * @alias module:model/AdminPostLinkEcToBpRequest
   * @class
   * @param requestedCompanyId {String} Id of the BP company to link End Customer company to.
   */
  var exports = function(requestedCompanyId) {
    var _this = this;
  ...
  /**
   * Constructs a <code>AdminPostLinkEcToBpRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPostLinkEcToBpRequest} obj Optional instance to populate.
   * @return {module:model/AdminPostLinkEcToBpRequest} The populated <code>AdminPostLinkEcToBpRequest</code> instance.
   */
  ...
  /**
   * Id of the BP company to link End Customer company to.
  ...
  /**
   * Custom message that requesting admin can add in email body
   * @member {String} customMessage
   */
  exports.prototype['customMessage'] = undefined;
  /**
   * if requestedToBeBpIr is set to true, when accepting request, the requesting end customer company will become a BP company with type `IR`. Note : To use requestedToBeBpIr, the requested company should be a BP company with type `VAD`.
