...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PutCancelLinkEcToBpInviteByIdSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PutCancelLinkEcToBpInviteByIdSuccess model module.
   * @module model/PutCancelLinkEcToBpInviteByIdSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PutCancelLinkEcToBpInviteByIdSuccess</code>.
   * @alias module:model/PutCancelLinkEcToBpInviteByIdSuccess
   * @class
  ...
  /**
   * Constructs a <code>PutCancelLinkEcToBpInviteByIdSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PutCancelLinkEcToBpInviteByIdSuccess} obj Optional instance to populate.
   * @return {module:model/PutCancelLinkEcToBpInviteByIdSuccess} The populated <code>PutCancelLinkEcToBpInviteByIdSuccess</code> instance.
   */
