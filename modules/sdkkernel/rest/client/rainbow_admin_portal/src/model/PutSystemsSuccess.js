...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PutSystemsSuccessPbxNumberingTranslator'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PutSystemsSuccessPbxNumberingTranslator'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.PutSystemsSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.PutSystemsSuccessPbxNumberingTranslator);
  }
}(this, function(ApiClient, PutSystemsSuccessPbxNumberingTranslator) {
  'use strict';



  /**
   * The PutSystemsSuccess model module.
   * @module model/PutSystemsSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PutSystemsSuccess</code>.
   * @alias module:model/PutSystemsSuccess
   * @class
   ...
   * @param status {module:model/PutSystemsSuccess.StatusEnum} CCA status report. (read only) > - `created`: CCA uses a public access code to join rainbow infrastructure (see jid_pbxagent_password field) > - `activating`: Rainbow infrastructure has proposed a private access code to replace the former public access code > - `activated`: CCA has accepted the new access code, that will be used for the next initialization.
   * @param serverPingTimeout {String} CCA config data
   * @param pbxMainBundlePrefix {Array.<String>} CCA config data
   * @param pbxNumberingTranslator {Array.<module:model/PutSystemsSuccessPbxNumberingTranslator>} list of several regular expressions used to validate internal or external phone numbers. Up to 100 regular expressions are allowed. (64 max char by regexp). To reset the list, use []
  ...
  /**
   * Constructs a <code>PutSystemsSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PutSystemsSuccess} obj Optional instance to populate.
   * @return {module:model/PutSystemsSuccess} The populated <code>PutSystemsSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('pbxNumberingTranslator')) {
        obj['pbxNumberingTranslator'] = ApiClient.convertToType(data['pbxNumberingTranslator'], [PutSystemsSuccessPbxNumberingTranslator]);
      }
   ...
   * @member {module:model/PutSystemsSuccess.StatusEnum} status
   * @default 'created'
   */
   ...
   * @member {Array.<module:model/PutSystemsSuccessPbxNumberingTranslator>} pbxNumberingTranslator
   */
