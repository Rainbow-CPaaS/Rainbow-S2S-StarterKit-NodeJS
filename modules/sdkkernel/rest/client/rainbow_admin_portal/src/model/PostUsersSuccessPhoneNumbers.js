...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PostUsersSuccessPhoneNumbers = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PostUsersSuccessPhoneNumbers model module.
   * @module model/PostUsersSuccessPhoneNumbers
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PostUsersSuccessPhoneNumbers</code>.
   * @alias module:model/PostUsersSuccessPhoneNumbers
   * @class
  ...
  /**
   * Constructs a <code>PostUsersSuccessPhoneNumbers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostUsersSuccessPhoneNumbers} obj Optional instance to populate.
   * @return {module:model/PostUsersSuccessPhoneNumbers} The populated <code>PostUsersSuccessPhoneNumbers</code> instance.
   */
