...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PostSystemsSuccessPbxNumberingTranslator = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PostSystemsSuccessPbxNumberingTranslator model module.
   * @module model/PostSystemsSuccessPbxNumberingTranslator
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PostSystemsSuccessPbxNumberingTranslator</code>.
   * @alias module:model/PostSystemsSuccessPbxNumberingTranslator
   * @class
  ...
  /**
   * Constructs a <code>PostSystemsSuccessPbxNumberingTranslator</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostSystemsSuccessPbxNumberingTranslator} obj Optional instance to populate.
   * @return {module:model/PostSystemsSuccessPbxNumberingTranslator} The populated <code>PostSystemsSuccessPbxNumberingTranslator</code> instance.
   */
