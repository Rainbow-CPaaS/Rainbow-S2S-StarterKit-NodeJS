...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminBotsGetBotIdSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminBotsGetBotIdSuccess model module.
   * @module model/AdminBotsGetBotIdSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminBotsGetBotIdSuccess</code>.
   * @alias module:model/AdminBotsGetBotIdSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminBotsGetBotIdSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminBotsGetBotIdSuccess} obj Optional instance to populate.
   * @return {module:model/AdminBotsGetBotIdSuccess} The populated <code>AdminBotsGetBotIdSuccess</code> instance.
   */
