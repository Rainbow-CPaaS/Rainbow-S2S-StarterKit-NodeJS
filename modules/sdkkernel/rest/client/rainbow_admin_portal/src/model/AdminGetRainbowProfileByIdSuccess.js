...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminGetRainbowProfileByIdSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminGetRainbowProfileByIdSuccess model module.
   * @module model/AdminGetRainbowProfileByIdSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminGetRainbowProfileByIdSuccess</code>.
   * @alias module:model/AdminGetRainbowProfileByIdSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminGetRainbowProfileByIdSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminGetRainbowProfileByIdSuccess} obj Optional instance to populate.
   * @return {module:model/AdminGetRainbowProfileByIdSuccess} The populated <code>AdminGetRainbowProfileByIdSuccess</code> instance.
   */
