...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PutFailedJoinCompanyInviteByIdSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PutFailedJoinCompanyInviteByIdSuccess model module.
   * @module model/PutFailedJoinCompanyInviteByIdSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PutFailedJoinCompanyInviteByIdSuccess</code>.
   * @alias module:model/PutFailedJoinCompanyInviteByIdSuccess
   * @class
  ...
  /**
   * Constructs a <code>PutFailedJoinCompanyInviteByIdSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PutFailedJoinCompanyInviteByIdSuccess} obj Optional instance to populate.
   * @return {module:model/PutFailedJoinCompanyInviteByIdSuccess} The populated <code>PutFailedJoinCompanyInviteByIdSuccess</code> instance.
   */
