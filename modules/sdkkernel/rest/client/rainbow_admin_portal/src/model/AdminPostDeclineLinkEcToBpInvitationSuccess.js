...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminPostDeclineLinkEcToBpInvitationSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminPostDeclineLinkEcToBpInvitationSuccess model module.
   * @module model/AdminPostDeclineLinkEcToBpInvitationSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPostDeclineLinkEcToBpInvitationSuccess</code>.
   * @alias module:model/AdminPostDeclineLinkEcToBpInvitationSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPostDeclineLinkEcToBpInvitationSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPostDeclineLinkEcToBpInvitationSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPostDeclineLinkEcToBpInvitationSuccess} The populated <code>AdminPostDeclineLinkEcToBpInvitationSuccess</code> instance.
   */
