...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.ResendLinkEcToBpRequestByIdSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The ResendLinkEcToBpRequestByIdSuccess model module.
   * @module model/ResendLinkEcToBpRequestByIdSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>ResendLinkEcToBpRequestByIdSuccess</code>.
   * @alias module:model/ResendLinkEcToBpRequestByIdSuccess
   * @class
  ...
  /**
   * Constructs a <code>ResendLinkEcToBpRequestByIdSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResendLinkEcToBpRequestByIdSuccess} obj Optional instance to populate.
   * @return {module:model/ResendLinkEcToBpRequestByIdSuccess} The populated <code>ResendLinkEcToBpRequestByIdSuccess</code> instance.
   */
