...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.GetLinkECToBPInvitationsSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The GetLinkECToBPInvitationsSuccess model module.
   * @module model/GetLinkECToBPInvitationsSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetLinkECToBPInvitationsSuccess</code>.
   * @alias module:model/GetLinkECToBPInvitationsSuccess
   * @class
  ...
  /**
   * Constructs a <code>GetLinkECToBPInvitationsSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetLinkECToBPInvitationsSuccess} obj Optional instance to populate.
   * @return {module:model/GetLinkECToBPInvitationsSuccess} The populated <code>GetLinkECToBPInvitationsSuccess</code> instance.
   */
