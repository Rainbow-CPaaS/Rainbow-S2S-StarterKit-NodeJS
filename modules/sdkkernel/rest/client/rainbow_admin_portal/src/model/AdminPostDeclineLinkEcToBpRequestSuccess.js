...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminPostDeclineLinkEcToBpRequestSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminPostDeclineLinkEcToBpRequestSuccess model module.
   * @module model/AdminPostDeclineLinkEcToBpRequestSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPostDeclineLinkEcToBpRequestSuccess</code>.
   * @alias module:model/AdminPostDeclineLinkEcToBpRequestSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPostDeclineLinkEcToBpRequestSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPostDeclineLinkEcToBpRequestSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPostDeclineLinkEcToBpRequestSuccess} The populated <code>AdminPostDeclineLinkEcToBpRequestSuccess</code> instance.
   */
