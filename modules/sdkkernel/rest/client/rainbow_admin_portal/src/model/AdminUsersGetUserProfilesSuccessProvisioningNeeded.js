...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminUsersGetUserProfilesSuccessProvisioningNeeded = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminUsersGetUserProfilesSuccessProvisioningNeeded model module.
   * @module model/AdminUsersGetUserProfilesSuccessProvisioningNeeded
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminUsersGetUserProfilesSuccessProvisioningNeeded</code>.
   * @alias module:model/AdminUsersGetUserProfilesSuccessProvisioningNeeded
   * @class
   * @param providerType {module:model/AdminUsersGetUserProfilesSuccessProvisioningNeeded.ProviderTypeEnum} If provisioningNeeded is set, each element of the array must contain providerType. providerType defines the component on which the provisioning is needed when subscribing to this offer (provisioning is launched asynchronously when Business Store confirms through the callback that the subscription is created).
  ...
  /**
   * Constructs a <code>AdminUsersGetUserProfilesSuccessProvisioningNeeded</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminUsersGetUserProfilesSuccessProvisioningNeeded} obj Optional instance to populate.
   * @return {module:model/AdminUsersGetUserProfilesSuccessProvisioningNeeded} The populated <code>AdminUsersGetUserProfilesSuccessProvisioningNeeded</code> instance.
   */
   ...
   * @member {module:model/AdminUsersGetUserProfilesSuccessProvisioningNeeded.ProviderTypeEnum} providerType
   */
   ...
   * @member {module:model/AdminUsersGetUserProfilesSuccessProvisioningNeeded.MediaTypeEnum} mediaType
   */
