...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminFilebackendstoragesPostBackends = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminFilebackendstoragesPostBackends model module.
   * @module model/AdminFilebackendstoragesPostBackends
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminFilebackendstoragesPostBackends</code>.
   * @alias module:model/AdminFilebackendstoragesPostBackends
   * @class
   ...
   */
  var exports = function(endPoint, tenantId, tenantName, userName, password, regionName, rootStorageURL) {
    var _this = this;
  ...
  /**
   * Constructs a <code>AdminFilebackendstoragesPostBackends</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminFilebackendstoragesPostBackends} obj Optional instance to populate.
   * @return {module:model/AdminFilebackendstoragesPostBackends} The populated <code>AdminFilebackendstoragesPostBackends</code> instance.
   */
  ...
  /**
   * This value has to be used inside the zone.json file managed by Rainbow operation team. If not set during File Backend creation, the domain name of the endPoint URL is replicated in this field.
   * @member {String} hostName
   * @default 'domainNameOfTheEndPointURL'
   */
  exports.prototype['hostName'] = 'domainNameOfTheEndPointURL';
