...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetSystemsIdSuccessPbxNumberingTranslator'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetSystemsIdSuccessPbxNumberingTranslator'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.GetSystemsIdSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.GetSystemsIdSuccessPbxNumberingTranslator);
  }
}(this, function(ApiClient, GetSystemsIdSuccessPbxNumberingTranslator) {
  'use strict';



  /**
   * The GetSystemsIdSuccess model module.
   * @module model/GetSystemsIdSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetSystemsIdSuccess</code>.
   * @alias module:model/GetSystemsIdSuccess
   * @class
   ...
   * @param status {module:model/GetSystemsIdSuccess.StatusEnum} CCA status report. (read only) > - `created`: CCA uses a public access code to join rainbow infrastructure (see jid_pbxagent_password field) > - `activating`: Rainbow infrastructure has proposed a private access code to replace the former public access code > - `activated`: CCA has accepted the new access code, that will be used for the next initialization.
   * @param serverPingTimeout {String} CCA config data
   * @param pbxMainBundlePrefix {Array.<String>} CCA config data
   * @param pbxNumberingTranslator {Array.<module:model/GetSystemsIdSuccessPbxNumberingTranslator>} list of several regular expressions used to validate internal or external phone numbers. Up to 100 regular expressions are allowed. (64 max char by regexp). To reset the list, use []
  ...
  /**
   * Constructs a <code>GetSystemsIdSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetSystemsIdSuccess} obj Optional instance to populate.
   * @return {module:model/GetSystemsIdSuccess} The populated <code>GetSystemsIdSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('pbxNumberingTranslator')) {
        obj['pbxNumberingTranslator'] = ApiClient.convertToType(data['pbxNumberingTranslator'], [GetSystemsIdSuccessPbxNumberingTranslator]);
      }
   ...
   * @member {module:model/GetSystemsIdSuccess.StatusEnum} status
   * @default 'created'
   */
   ...
   * @member {Array.<module:model/GetSystemsIdSuccessPbxNumberingTranslator>} pbxNumberingTranslator
   */
