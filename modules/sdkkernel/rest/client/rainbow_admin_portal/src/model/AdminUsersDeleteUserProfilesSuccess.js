...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AdminUsersDeleteUserProfilesSuccessProvisioningNeeded'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AdminUsersDeleteUserProfilesSuccessProvisioningNeeded'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.AdminUsersDeleteUserProfilesSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.AdminUsersDeleteUserProfilesSuccessProvisioningNeeded);
  }
}(this, function(ApiClient, AdminUsersDeleteUserProfilesSuccessProvisioningNeeded) {
  'use strict';



  /**
   * The AdminUsersDeleteUserProfilesSuccess model module.
   * @module model/AdminUsersDeleteUserProfilesSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminUsersDeleteUserProfilesSuccess</code>.
   * @alias module:model/AdminUsersDeleteUserProfilesSuccess
   * @class
   ...
   * @param provisioningNeeded {Array.<module:model/AdminUsersDeleteUserProfilesSuccessProvisioningNeeded>} Indicates if provisioning is needed on other component when assigning the user profile to this subscription (depends of thus subscribed offer)
  ...
  /**
   * Constructs a <code>AdminUsersDeleteUserProfilesSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminUsersDeleteUserProfilesSuccess} obj Optional instance to populate.
   * @return {module:model/AdminUsersDeleteUserProfilesSuccess} The populated <code>AdminUsersDeleteUserProfilesSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('provisioningNeeded')) {
        obj['provisioningNeeded'] = ApiClient.convertToType(data['provisioningNeeded'], [AdminUsersDeleteUserProfilesSuccessProvisioningNeeded]);
      }
   ...
   * @member {module:model/AdminUsersDeleteUserProfilesSuccess.BusinessModelEnum} businessModel
   */
   ...
   * @member {Array.<module:model/AdminUsersDeleteUserProfilesSuccessProvisioningNeeded>} provisioningNeeded
   */
