...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AdminPutRainbowOffersSuccessProvisioningNeeded'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AdminPutRainbowOffersSuccessProvisioningNeeded'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.AdminPutRainbowOffersSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.AdminPutRainbowOffersSuccessProvisioningNeeded);
  }
}(this, function(ApiClient, AdminPutRainbowOffersSuccessProvisioningNeeded) {
  'use strict';



  /**
   * The AdminPutRainbowOffersSuccess model module.
   * @module model/AdminPutRainbowOffersSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPutRainbowOffersSuccess</code>.
   * @alias module:model/AdminPutRainbowOffersSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPutRainbowOffersSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPutRainbowOffersSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPutRainbowOffersSuccess} The populated <code>AdminPutRainbowOffersSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('provisioningNeeded')) {
        obj['provisioningNeeded'] = ApiClient.convertToType(data['provisioningNeeded'], [AdminPutRainbowOffersSuccessProvisioningNeeded]);
      }
  ...
  /**
   * Indicates the business model associated to this offer (number of users, usage, flat fee...)   * `nb_users`: Licencing business model. Offers having this business model are billed according to the number of users bought for it. This should be the business model for Business and Enterprise offers. * `usage`: Offers having this business model are billed based on service consumption (whatever the number of users assigned to the subscription of this offer). This should be the business model for Conference offer. * `flat_fee`: Offers having this business model are billed based on a flat fee (same price each month for the company which subscribe to this offer). This should be the business model for some specific business offers like HDS. * `none`: no business model. Should be used for offers which are not sold (like Essential, Beta, ...).  
   * @member {module:model/AdminPutRainbowOffersSuccess.BusinessModelEnum} businessModel
   */
   ...
   * @member {Array.<module:model/AdminPutRainbowOffersSuccessProvisioningNeeded>} provisioningNeeded
   */
