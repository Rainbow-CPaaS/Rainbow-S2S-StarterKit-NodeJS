...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PostCompanyIceServers = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PostCompanyIceServers model module.
   * @module model/PostCompanyIceServers
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PostCompanyIceServers</code>.
   * @alias module:model/PostCompanyIceServers
   * @class
  ...
  /**
   * Constructs a <code>PostCompanyIceServers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostCompanyIceServers} obj Optional instance to populate.
   * @return {module:model/PostCompanyIceServers} The populated <code>PostCompanyIceServers</code> instance.
   */
