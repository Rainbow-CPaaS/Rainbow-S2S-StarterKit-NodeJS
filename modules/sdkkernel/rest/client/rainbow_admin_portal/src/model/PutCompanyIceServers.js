...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PutCompanyIceServers = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PutCompanyIceServers model module.
   * @module model/PutCompanyIceServers
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PutCompanyIceServers</code>.
   * @alias module:model/PutCompanyIceServers
   * @class
  ...
  /**
   * Constructs a <code>PutCompanyIceServers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PutCompanyIceServers} obj Optional instance to populate.
   * @return {module:model/PutCompanyIceServers} The populated <code>PutCompanyIceServers</code> instance.
   */
