...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.GetJoinCompaniesLinksSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The GetJoinCompaniesLinksSuccess model module.
   * @module model/GetJoinCompaniesLinksSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetJoinCompaniesLinksSuccess</code>.
   * @alias module:model/GetJoinCompaniesLinksSuccess
   * @class
  ...
  /**
   * Constructs a <code>GetJoinCompaniesLinksSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetJoinCompaniesLinksSuccess} obj Optional instance to populate.
   * @return {module:model/GetJoinCompaniesLinksSuccess} The populated <code>GetJoinCompaniesLinksSuccess</code> instance.
   */
