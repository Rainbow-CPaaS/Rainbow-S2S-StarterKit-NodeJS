...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetCompaniesAdministratorsSuccessCreatedByAdmin', 'model/PutUsersSuccessEmails', 'model/PutUsersSuccessPhoneNumbers'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetCompaniesAdministratorsSuccessCreatedByAdmin'), require('./PutUsersSuccessEmails'), require('./PutUsersSuccessPhoneNumbers'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.PutUsersSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.GetCompaniesAdministratorsSuccessCreatedByAdmin, root.RainbowAdminPortal.PutUsersSuccessEmails, root.RainbowAdminPortal.PutUsersSuccessPhoneNumbers);
  }
}(this, function(ApiClient, GetCompaniesAdministratorsSuccessCreatedByAdmin, PutUsersSuccessEmails, PutUsersSuccessPhoneNumbers) {
  'use strict';



  /**
   * The PutUsersSuccess model module.
   * @module model/PutUsersSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PutUsersSuccess</code>.
   * @alias module:model/PutUsersSuccess
   * @class
   ...
   * @param emails {Array.<module:model/PutUsersSuccessEmails>} Array of user emails addresses objects
   * @param phoneNumbers {Array.<module:model/PutUsersSuccessPhoneNumbers>} Array of user phone numbers objects.    Phone number objects can:   * be created by user (information filled by user), * come from association with a system (pbx) device (association is done by admin).  
  ...
  /**
   * Constructs a <code>PutUsersSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PutUsersSuccess} obj Optional instance to populate.
   * @return {module:model/PutUsersSuccess} The populated <code>PutUsersSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('emails')) {
        obj['emails'] = ApiClient.convertToType(data['emails'], [PutUsersSuccessEmails]);
      }
      if (data.hasOwnProperty('phoneNumbers')) {
        obj['phoneNumbers'] = ApiClient.convertToType(data['phoneNumbers'], [PutUsersSuccessPhoneNumbers]);
      }
   ...
   * @member {Array.<module:model/PutUsersSuccessEmails>} emails
   */
   ...
   * @member {Array.<module:model/PutUsersSuccessPhoneNumbers>} phoneNumbers
   */
   ...
   * @member {module:model/PutUsersSuccess.StateEnum} state
   */
