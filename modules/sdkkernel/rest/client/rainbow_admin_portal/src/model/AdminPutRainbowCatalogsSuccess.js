...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminPutRainbowCatalogsSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminPutRainbowCatalogsSuccess model module.
   * @module model/AdminPutRainbowCatalogsSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPutRainbowCatalogsSuccess</code>.
   * @alias module:model/AdminPutRainbowCatalogsSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPutRainbowCatalogsSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPutRainbowCatalogsSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPutRainbowCatalogsSuccess} The populated <code>AdminPutRainbowCatalogsSuccess</code> instance.
   */
