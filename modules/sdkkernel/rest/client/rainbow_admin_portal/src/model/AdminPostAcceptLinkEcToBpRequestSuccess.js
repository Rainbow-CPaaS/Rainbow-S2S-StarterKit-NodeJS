...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminPostAcceptLinkEcToBpRequestSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminPostAcceptLinkEcToBpRequestSuccess model module.
   * @module model/AdminPostAcceptLinkEcToBpRequestSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPostAcceptLinkEcToBpRequestSuccess</code>.
   * @alias module:model/AdminPostAcceptLinkEcToBpRequestSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPostAcceptLinkEcToBpRequestSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPostAcceptLinkEcToBpRequestSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPostAcceptLinkEcToBpRequestSuccess} The populated <code>AdminPostAcceptLinkEcToBpRequestSuccess</code> instance.
   */
