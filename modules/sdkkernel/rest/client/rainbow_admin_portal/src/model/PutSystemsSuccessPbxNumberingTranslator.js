...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PutSystemsSuccessPbxNumberingTranslator = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PutSystemsSuccessPbxNumberingTranslator model module.
   * @module model/PutSystemsSuccessPbxNumberingTranslator
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PutSystemsSuccessPbxNumberingTranslator</code>.
   * @alias module:model/PutSystemsSuccessPbxNumberingTranslator
   * @class
  ...
  /**
   * Constructs a <code>PutSystemsSuccessPbxNumberingTranslator</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PutSystemsSuccessPbxNumberingTranslator} obj Optional instance to populate.
   * @return {module:model/PutSystemsSuccessPbxNumberingTranslator} The populated <code>PutSystemsSuccessPbxNumberingTranslator</code> instance.
   */
