...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetJoinCompanyRequestByIdSuccessRequestedToCompanyAdmin', 'model/PostAcceptJoinCompanyReqSuccessAcceptationInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetJoinCompanyRequestByIdSuccessRequestedToCompanyAdmin'), require('./PostAcceptJoinCompanyReqSuccessAcceptationInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.PostAcceptJoinCompanyReqSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.GetJoinCompanyRequestByIdSuccessRequestedToCompanyAdmin, root.RainbowAdminPortal.PostAcceptJoinCompanyReqSuccessAcceptationInfo);
  }
}(this, function(ApiClient, GetJoinCompanyRequestByIdSuccessRequestedToCompanyAdmin, PostAcceptJoinCompanyReqSuccessAcceptationInfo) {
  'use strict';



  /**
   * The PostAcceptJoinCompanyReqSuccess model module.
   * @module model/PostAcceptJoinCompanyReqSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PostAcceptJoinCompanyReqSuccess</code>.
   * @alias module:model/PostAcceptJoinCompanyReqSuccess
   * @class
   * @param acceptationInfo {module:model/PostAcceptJoinCompanyReqSuccessAcceptationInfo} 
   ...
   */
  var exports = function(acceptationInfo, id, requestingUserId, requestingUserLoginEmail, requestedCompanyId, requestedCompanyName, status, requestingDate, requestedNotificationLanguage, lastNotificationDate, requestedCompanyInvitationId) {
    var _this = this;

    _this['acceptationInfo'] = acceptationInfo;
    _this['id'] = id;
  ...
  /**
   * Constructs a <code>PostAcceptJoinCompanyReqSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostAcceptJoinCompanyReqSuccess} obj Optional instance to populate.
   * @return {module:model/PostAcceptJoinCompanyReqSuccess} The populated <code>PostAcceptJoinCompanyReqSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('acceptationInfo')) {
        obj['acceptationInfo'] = PostAcceptJoinCompanyReqSuccessAcceptationInfo.constructFromObject(data['acceptationInfo']);
      }
  ...
  /**
   * @member {module:model/PostAcceptJoinCompanyReqSuccessAcceptationInfo} acceptationInfo
   */
  exports.prototype['acceptationInfo'] = undefined;
  /**
