...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminPostRainbowCatalogsSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminPostRainbowCatalogsSuccess model module.
   * @module model/AdminPostRainbowCatalogsSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminPostRainbowCatalogsSuccess</code>.
   * @alias module:model/AdminPostRainbowCatalogsSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminPostRainbowCatalogsSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminPostRainbowCatalogsSuccess} obj Optional instance to populate.
   * @return {module:model/AdminPostRainbowCatalogsSuccess} The populated <code>AdminPostRainbowCatalogsSuccess</code> instance.
   */
