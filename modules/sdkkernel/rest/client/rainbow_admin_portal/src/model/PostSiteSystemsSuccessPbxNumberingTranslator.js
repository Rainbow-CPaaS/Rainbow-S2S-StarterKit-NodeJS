...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PostSiteSystemsSuccessPbxNumberingTranslator = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PostSiteSystemsSuccessPbxNumberingTranslator model module.
   * @module model/PostSiteSystemsSuccessPbxNumberingTranslator
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PostSiteSystemsSuccessPbxNumberingTranslator</code>.
   * @alias module:model/PostSiteSystemsSuccessPbxNumberingTranslator
   * @class
  ...
  /**
   * Constructs a <code>PostSiteSystemsSuccessPbxNumberingTranslator</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostSiteSystemsSuccessPbxNumberingTranslator} obj Optional instance to populate.
   * @return {module:model/PostSiteSystemsSuccessPbxNumberingTranslator} The populated <code>PostSiteSystemsSuccessPbxNumberingTranslator</code> instance.
   */
