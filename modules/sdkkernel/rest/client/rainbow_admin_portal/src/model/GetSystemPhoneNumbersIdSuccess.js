...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.GetSystemPhoneNumbersIdSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The GetSystemPhoneNumbersIdSuccess model module.
   * @module model/GetSystemPhoneNumbersIdSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetSystemPhoneNumbersIdSuccess</code>.
   * @alias module:model/GetSystemPhoneNumbersIdSuccess
   * @class
  ...
  /**
   * Constructs a <code>GetSystemPhoneNumbersIdSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetSystemPhoneNumbersIdSuccess} obj Optional instance to populate.
   * @return {module:model/GetSystemPhoneNumbersIdSuccess} The populated <code>GetSystemPhoneNumbersIdSuccess</code> instance.
   */
