...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AdminGetRainbowOffersSuccessProvisioningNeeded'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AdminGetRainbowOffersSuccessProvisioningNeeded'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.AdminGetRainbowOffersSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.AdminGetRainbowOffersSuccessProvisioningNeeded);
  }
}(this, function(ApiClient, AdminGetRainbowOffersSuccessProvisioningNeeded) {
  'use strict';



  /**
   * The AdminGetRainbowOffersSuccess model module.
   * @module model/AdminGetRainbowOffersSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminGetRainbowOffersSuccess</code>.
   * @alias module:model/AdminGetRainbowOffersSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminGetRainbowOffersSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminGetRainbowOffersSuccess} obj Optional instance to populate.
   * @return {module:model/AdminGetRainbowOffersSuccess} The populated <code>AdminGetRainbowOffersSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('provisioningNeeded')) {
        obj['provisioningNeeded'] = ApiClient.convertToType(data['provisioningNeeded'], [AdminGetRainbowOffersSuccessProvisioningNeeded]);
      }
   ...
   * @member {module:model/AdminGetRainbowOffersSuccess.BusinessModelEnum} businessModel
   */
   ...
   * @member {Array.<module:model/AdminGetRainbowOffersSuccessProvisioningNeeded>} provisioningNeeded
   */
