...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.PostIceServers = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The PostIceServers model module.
   * @module model/PostIceServers
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>PostIceServers</code>.
   * @alias module:model/PostIceServers
   * @class
  ...
  /**
   * Constructs a <code>PostIceServers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PostIceServers} obj Optional instance to populate.
   * @return {module:model/PostIceServers} The populated <code>PostIceServers</code> instance.
   */
