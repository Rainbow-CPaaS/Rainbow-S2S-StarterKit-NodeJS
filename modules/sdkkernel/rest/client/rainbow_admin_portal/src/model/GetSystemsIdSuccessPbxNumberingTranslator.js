...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.GetSystemsIdSuccessPbxNumberingTranslator = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The GetSystemsIdSuccessPbxNumberingTranslator model module.
   * @module model/GetSystemsIdSuccessPbxNumberingTranslator
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetSystemsIdSuccessPbxNumberingTranslator</code>.
   * @alias module:model/GetSystemsIdSuccessPbxNumberingTranslator
   * @class
  ...
  /**
   * Constructs a <code>GetSystemsIdSuccessPbxNumberingTranslator</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetSystemsIdSuccessPbxNumberingTranslator} obj Optional instance to populate.
   * @return {module:model/GetSystemsIdSuccessPbxNumberingTranslator} The populated <code>GetSystemsIdSuccessPbxNumberingTranslator</code> instance.
   */
