...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.GetUsersIdSuccessPhoneNumbers = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The GetUsersIdSuccessPhoneNumbers model module.
   * @module model/GetUsersIdSuccessPhoneNumbers
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetUsersIdSuccessPhoneNumbers</code>.
   * @alias module:model/GetUsersIdSuccessPhoneNumbers
   * @class
  ...
  /**
   * Constructs a <code>GetUsersIdSuccessPhoneNumbers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetUsersIdSuccessPhoneNumbers} obj Optional instance to populate.
   * @return {module:model/GetUsersIdSuccessPhoneNumbers} The populated <code>GetUsersIdSuccessPhoneNumbers</code> instance.
   */
