...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminFilebackendstoragesPutBots = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminFilebackendstoragesPutBots model module.
   * @module model/AdminFilebackendstoragesPutBots
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminFilebackendstoragesPutBots</code>.
   * @alias module:model/AdminFilebackendstoragesPutBots
   * @class
   */
  ...
  /**
   * Constructs a <code>AdminFilebackendstoragesPutBots</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminFilebackendstoragesPutBots} obj Optional instance to populate.
   * @return {module:model/AdminFilebackendstoragesPutBots} The populated <code>AdminFilebackendstoragesPutBots</code> instance.
   */
  ...
  /**
   * This value has to be used inside the zone.json file managed by Rainbow operation team.
