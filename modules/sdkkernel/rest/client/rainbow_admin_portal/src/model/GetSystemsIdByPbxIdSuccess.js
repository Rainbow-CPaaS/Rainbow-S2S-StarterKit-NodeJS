...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetSystemsIdByPbxIdSuccessPbxNumberingTranslator'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetSystemsIdByPbxIdSuccessPbxNumberingTranslator'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowAdminPortal) {
      root.RainbowAdminPortal = {};
    }
    root.RainbowAdminPortal.GetSystemsIdByPbxIdSuccess = factory(root.RainbowAdminPortal.ApiClient, root.RainbowAdminPortal.GetSystemsIdByPbxIdSuccessPbxNumberingTranslator);
  }
}(this, function(ApiClient, GetSystemsIdByPbxIdSuccessPbxNumberingTranslator) {
  'use strict';



  /**
   * The GetSystemsIdByPbxIdSuccess model module.
   * @module model/GetSystemsIdByPbxIdSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetSystemsIdByPbxIdSuccess</code>.
   * @alias module:model/GetSystemsIdByPbxIdSuccess
   * @class
   * @param activatingTransactionId {String} CCA Jabber Id
   * @param jidPbxagentPasswordActivating {String} CCA Jabber Id access code. The value of this field is depending on status field. The value of this field is depending on 'status' field.    - `activating`: This is a proposal of private access code sent to CCA and not yet acknowledged.    - `created, activated`: Empty string
   ...
   * @param status {module:model/GetSystemsIdByPbxIdSuccess.StatusEnum} CCA status report. (read only) > - `created`: CCA uses a public access code to join rainbow infrastructure (see jid_pbxagent_password field) > - `activating`: Rainbow infrastructure has proposed a private access code to replace the former public access code > - `activated`: CCA has accepted the new access code, that will be used for the next initialization.
   * @param serverPingTimeout {String} CCA config data
   * @param pbxMainBundlePrefix {Array.<String>} CCA config data
   * @param pbxNumberingTranslator {Array.<module:model/GetSystemsIdByPbxIdSuccessPbxNumberingTranslator>} list of several regular expressions used to validate internal or external phone numbers. Up to 100 regular expressions are allowed. (64 max char by regexp). To reset the list, use []
  ...
  /**
   * Constructs a <code>GetSystemsIdByPbxIdSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetSystemsIdByPbxIdSuccess} obj Optional instance to populate.
   * @return {module:model/GetSystemsIdByPbxIdSuccess} The populated <code>GetSystemsIdByPbxIdSuccess</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('activatingTransactionId')) {
        obj['activatingTransactionId'] = ApiClient.convertToType(data['activatingTransactionId'], 'String');
      }
      if (data.hasOwnProperty('jid_pbxagent_password_activating')) {
        obj['jid_pbxagent_password_activating'] = ApiClient.convertToType(data['jid_pbxagent_password_activating'], 'String');
      }
      ...
      if (data.hasOwnProperty('pbxNumberingTranslator')) {
        obj['pbxNumberingTranslator'] = ApiClient.convertToType(data['pbxNumberingTranslator'], [GetSystemsIdByPbxIdSuccessPbxNumberingTranslator]);
      }
  ...
  /**
   * CCA Jabber Id
   * @member {String} activatingTransactionId
   */
  exports.prototype['activatingTransactionId'] = undefined;
  /**
   * CCA Jabber Id access code. The value of this field is depending on status field. The value of this field is depending on 'status' field.    - `activating`: This is a proposal of private access code sent to CCA and not yet acknowledged.    - `created, activated`: Empty string
   * @member {String} jid_pbxagent_password_activating
   */
  exports.prototype['jid_pbxagent_password_activating'] = undefined;
  /**
   ...
   * @member {module:model/GetSystemsIdByPbxIdSuccess.StatusEnum} status
   * @default 'created'
   */
   ...
   * @member {Array.<module:model/GetSystemsIdByPbxIdSuccessPbxNumberingTranslator>} pbxNumberingTranslator
   */
