...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.AdminBotsGetBotsSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The AdminBotsGetBotsSuccess model module.
   * @module model/AdminBotsGetBotsSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>AdminBotsGetBotsSuccess</code>.
   * @alias module:model/AdminBotsGetBotsSuccess
   * @class
  ...
  /**
   * Constructs a <code>AdminBotsGetBotsSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdminBotsGetBotsSuccess} obj Optional instance to populate.
   * @return {module:model/AdminBotsGetBotsSuccess} The populated <code>AdminBotsGetBotsSuccess</code> instance.
   */
