...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowAdminPortal.GetJoinCompaniesLinksByIdSuccess = factory(root.RainbowAdminPortal.ApiClient);
  }
  ...
  /**
   * The GetJoinCompaniesLinksByIdSuccess model module.
   * @module model/GetJoinCompaniesLinksByIdSuccess
   * @version 1.82.0
   */

  /**
   * Constructs a new <code>GetJoinCompaniesLinksByIdSuccess</code>.
   * @alias module:model/GetJoinCompaniesLinksByIdSuccess
   * @class
   ...
   */
  var exports = function(id, creationDate, createdByAdminId, createdByAdminLoginEmail, maxNumberUsers, expirationDate) {
    var _this = this;
  ...
  /**
   * Constructs a <code>GetJoinCompaniesLinksByIdSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetJoinCompaniesLinksByIdSuccess} obj Optional instance to populate.
   * @return {module:model/GetJoinCompaniesLinksByIdSuccess} The populated <code>GetJoinCompaniesLinksByIdSuccess</code> instance.
   */
