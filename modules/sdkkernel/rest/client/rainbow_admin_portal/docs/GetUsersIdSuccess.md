# RainbowAdminPortal.GetUsersIdSuccess
...
**calendars** | [**[GetUsersIdSuccessCalendars]**](GetUsersIdSuccessCalendars.md) | List of associated calendars from external providers configured by the user (office365, google calendar, ...)    Only returned if the requested user is the logged in user. | 
...
**emails** | [**[GetUsersIdSuccessEmails]**](GetUsersIdSuccessEmails.md) | Array of user emails addresses objects | 
**phoneNumbers** | [**[GetUsersIdSuccessPhoneNumbers]**](GetUsersIdSuccessPhoneNumbers.md) | Array of user phone numbers objects.    Phone number objects can:   * be created by user (information filled by user), * come from association with a system (pbx) device (association is done by admin).   | 
