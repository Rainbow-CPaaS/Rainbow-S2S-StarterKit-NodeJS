...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.UpdateUserPhoneNumbers();
  });
  ...
  describe('UpdateUserPhoneNumbers', function() {
    it('should create an instance of UpdateUserPhoneNumbers', function() {
      // uncomment below and update the code to test UpdateUserPhoneNumbers
      //var instance = new RainbowEnduserPortal.UpdateUserPhoneNumbers();
      //expect(instance).to.be.a(RainbowEnduserPortal.UpdateUserPhoneNumbers);
    });
