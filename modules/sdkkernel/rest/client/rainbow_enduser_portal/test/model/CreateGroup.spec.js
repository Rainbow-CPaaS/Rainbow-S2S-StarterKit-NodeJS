...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.CreateGroup();
  });
  ...
  describe('CreateGroup', function() {
    it('should create an instance of CreateGroup', function() {
      ...
      //var instance = new RainbowEnduserPortal.CreateGroup();
      //expect(instance).to.be.a(RainbowEnduserPortal.CreateGroup);
    });
