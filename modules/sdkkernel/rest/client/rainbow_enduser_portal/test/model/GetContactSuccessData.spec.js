...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetContactSuccessData();
  });
  ...
  describe('GetContactSuccessData', function() {
    it('should create an instance of GetContactSuccessData', function() {
      // uncomment below and update the code to test GetContactSuccessData
      //var instance = new RainbowEnduserPortal.GetContactSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetContactSuccessData);
    });
