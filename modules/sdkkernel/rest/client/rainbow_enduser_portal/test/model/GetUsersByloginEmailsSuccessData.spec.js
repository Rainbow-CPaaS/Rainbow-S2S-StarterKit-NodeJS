...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetUsersByloginEmailsSuccessData();
  });
  ...
  describe('GetUsersByloginEmailsSuccessData', function() {
    it('should create an instance of GetUsersByloginEmailsSuccessData', function() {
      // uncomment below and update the code to test GetUsersByloginEmailsSuccessData
      //var instance = new RainbowEnduserPortal.GetUsersByloginEmailsSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetUsersByloginEmailsSuccessData);
    });
