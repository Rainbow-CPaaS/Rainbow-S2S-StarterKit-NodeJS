...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.UpdateRoom();
  });
  ...
  describe('UpdateRoom', function() {
    it('should create an instance of UpdateRoom', function() {
      // uncomment below and update the code to test UpdateRoom
      //var instance = new RainbowEnduserPortal.UpdateRoom();
      //expect(instance).to.be.a(RainbowEnduserPortal.UpdateRoom);
    });
