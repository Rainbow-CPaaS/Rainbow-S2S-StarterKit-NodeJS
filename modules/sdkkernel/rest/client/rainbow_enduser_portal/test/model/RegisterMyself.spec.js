...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.RegisterMyself();
  });
  ...
  describe('RegisterMyself', function() {
    it('should create an instance of RegisterMyself', function() {
      // uncomment below and update the code to test RegisterMyself
      //var instance = new RainbowEnduserPortal.RegisterMyself();
      //expect(instance).to.be.a(RainbowEnduserPortal.RegisterMyself);
    });
    ...
    it('should have the property temporaryToken (base name: "temporaryToken")', function() {
      // uncomment below and update the code to test the property temporaryToken
      //var instance = new RainbowEnduserPortal.RegisterMyself();
      //expect(instance).to.be();
    });
    ...
    it('should have the property joinCompanyInvitationId (base name: "joinCompanyInvitationId")', function() {
      // uncomment below and update the code to test the property joinCompanyInvitationId
      //var instance = new RainbowEnduserPortal.RegisterMyself();
      //expect(instance).to.be();
    });
