...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.UpdateContactSuccessData();
  });
  ...
  describe('UpdateContactSuccessData', function() {
    it('should create an instance of UpdateContactSuccessData', function() {
      // uncomment below and update the code to test UpdateContactSuccessData
      //var instance = new RainbowEnduserPortal.UpdateContactSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.UpdateContactSuccessData);
    });
    ...
    it('should have the property otherData (base name: "otherData")', function() {
      // uncomment below and update the code to test the property otherData
      //var instance = new RainbowEnduserPortal.UpdateContactSuccessData();
      //expect(instance).to.be();
    });
