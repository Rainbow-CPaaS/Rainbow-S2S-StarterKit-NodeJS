...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.CreateConversation();
  });
  ...
  describe('CreateConversation', function() {
    it('should create an instance of CreateConversation', function() {
      // uncomment below and update the code to test CreateConversation
      //var instance = new RainbowEnduserPortal.CreateConversation();
      //expect(instance).to.be.a(RainbowEnduserPortal.CreateConversation);
    });
