...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.CreateCompany();
  });
  ...
  describe('CreateCompany', function() {
    it('should create an instance of CreateCompany', function() {
      ...
      //var instance = new RainbowEnduserPortal.CreateCompany();
      //expect(instance).to.be.a(RainbowEnduserPortal.CreateCompany);
    });
