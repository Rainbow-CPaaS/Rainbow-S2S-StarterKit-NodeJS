...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.CreateFavorite();
  });
  ...
  describe('CreateFavorite', function() {
    it('should create an instance of CreateFavorite', function() {
      // uncomment below and update the code to test CreateFavorite
      //var instance = new RainbowEnduserPortal.CreateFavorite();
      //expect(instance).to.be.a(RainbowEnduserPortal.CreateFavorite);
    });
