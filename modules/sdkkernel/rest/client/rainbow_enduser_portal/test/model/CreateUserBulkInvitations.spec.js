...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.CreateUserBulkInvitations();
  });
  ...
  describe('CreateUserBulkInvitations', function() {
    it('should create an instance of CreateUserBulkInvitations', function() {
      // uncomment below and update the code to test CreateUserBulkInvitations
      //var instance = new RainbowEnduserPortal.CreateUserBulkInvitations();
      //expect(instance).to.be.a(RainbowEnduserPortal.CreateUserBulkInvitations);
    });
