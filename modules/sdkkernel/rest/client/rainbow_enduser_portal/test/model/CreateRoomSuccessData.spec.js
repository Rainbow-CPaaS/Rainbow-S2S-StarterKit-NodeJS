...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.CreateRoomSuccessData();
  });
  ...
  describe('CreateRoomSuccessData', function() {
    it('should create an instance of CreateRoomSuccessData', function() {
      // uncomment below and update the code to test CreateRoomSuccessData
      //var instance = new RainbowEnduserPortal.CreateRoomSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.CreateRoomSuccessData);
    });
