...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.UpdateContact();
  });
  ...
  describe('UpdateContact', function() {
    it('should create an instance of UpdateContact', function() {
      ...
      //var instance = new RainbowEnduserPortal.UpdateContact();
      //expect(instance).to.be.a(RainbowEnduserPortal.UpdateContact);
    });
