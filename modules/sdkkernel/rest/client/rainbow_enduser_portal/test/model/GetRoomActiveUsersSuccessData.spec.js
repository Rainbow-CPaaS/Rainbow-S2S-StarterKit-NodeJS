...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetRoomActiveUsersSuccessData();
  });
  ...
  describe('GetRoomActiveUsersSuccessData', function() {
    it('should create an instance of GetRoomActiveUsersSuccessData', function() {
      // uncomment below and update the code to test GetRoomActiveUsersSuccessData
      //var instance = new RainbowEnduserPortal.GetRoomActiveUsersSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetRoomActiveUsersSuccessData);
    });
    ...
    it('should have the property additionDate (base name: "additionDate")', function() {
      // uncomment below and update the code to test the property additionDate
      //var instance = new RainbowEnduserPortal.GetRoomActiveUsersSuccessData();
      //expect(instance).to.be();
    });
