...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetUserProfilesFeaturesSuccessData();
  });
  ...
  describe('GetUserProfilesFeaturesSuccessData', function() {
    it('should create an instance of GetUserProfilesFeaturesSuccessData', function() {
      // uncomment below and update the code to test GetUserProfilesFeaturesSuccessData
      //var instance = new RainbowEnduserPortal.GetUserProfilesFeaturesSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetUserProfilesFeaturesSuccessData);
    });
