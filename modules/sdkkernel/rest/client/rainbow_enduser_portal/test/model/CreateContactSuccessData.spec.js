...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.CreateContactSuccessData();
  });
  ...
  describe('CreateContactSuccessData', function() {
    it('should create an instance of CreateContactSuccessData', function() {
      // uncomment below and update the code to test CreateContactSuccessData
      //var instance = new RainbowEnduserPortal.CreateContactSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.CreateContactSuccessData);
    });
