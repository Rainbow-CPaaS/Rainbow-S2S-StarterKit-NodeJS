...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.SearchUsersByJidsSuccessData();
  });
  ...
  describe('SearchUsersByJidsSuccessData', function() {
    it('should create an instance of SearchUsersByJidsSuccessData', function() {
      // uncomment below and update the code to test SearchUsersByJidsSuccessData
      //var instance = new RainbowEnduserPortal.SearchUsersByJidsSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.SearchUsersByJidsSuccessData);
    });
