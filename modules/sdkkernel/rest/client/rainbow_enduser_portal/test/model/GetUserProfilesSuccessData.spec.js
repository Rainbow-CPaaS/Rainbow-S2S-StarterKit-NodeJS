...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetUserProfilesSuccessData();
  });
  ...
  describe('GetUserProfilesSuccessData', function() {
    it('should create an instance of GetUserProfilesSuccessData', function() {
      // uncomment below and update the code to test GetUserProfilesSuccessData
      //var instance = new RainbowEnduserPortal.GetUserProfilesSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetUserProfilesSuccessData);
    });
