...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.AcceptPresenceSharingSuccessData();
  });
  ...
  describe('AcceptPresenceSharingSuccessData', function() {
    it('should create an instance of AcceptPresenceSharingSuccessData', function() {
      // uncomment below and update the code to test AcceptPresenceSharingSuccessData
      //var instance = new RainbowEnduserPortal.AcceptPresenceSharingSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.AcceptPresenceSharingSuccessData);
    });
