...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.UpdateConversation();
  });
  ...
  describe('UpdateConversation', function() {
    it('should create an instance of UpdateConversation', function() {
      // uncomment below and update the code to test UpdateConversation
      //var instance = new RainbowEnduserPortal.UpdateConversation();
      //expect(instance).to.be.a(RainbowEnduserPortal.UpdateConversation);
    });
