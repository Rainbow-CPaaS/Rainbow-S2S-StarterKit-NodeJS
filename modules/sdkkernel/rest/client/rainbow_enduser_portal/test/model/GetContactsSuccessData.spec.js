...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetContactsSuccessData();
  });
  ...
  describe('GetContactsSuccessData', function() {
    it('should create an instance of GetContactsSuccessData', function() {
      // uncomment below and update the code to test GetContactsSuccessData
      //var instance = new RainbowEnduserPortal.GetContactsSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetContactsSuccessData);
    });
