...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.UpdateConversationSuccessData();
  });
  ...
  describe('UpdateConversationSuccessData', function() {
    it('should create an instance of UpdateConversationSuccessData', function() {
      // uncomment below and update the code to test UpdateConversationSuccessData
      //var instance = new RainbowEnduserPortal.UpdateConversationSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.UpdateConversationSuccessData);
    });
