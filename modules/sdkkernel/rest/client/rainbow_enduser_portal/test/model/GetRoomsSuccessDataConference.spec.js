...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetRoomsSuccessDataConference();
  });
  ...
  describe('GetRoomsSuccessDataConference', function() {
    it('should create an instance of GetRoomsSuccessDataConference', function() {
      // uncomment below and update the code to test GetRoomsSuccessDataConference
      //var instance = new RainbowEnduserPortal.GetRoomsSuccessDataConference();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetRoomsSuccessDataConference);
    });
    ...
    it('should have the property scheduledDuration (base name: "scheduledDuration")', function() {
      // uncomment below and update the code to test the property scheduledDuration
      //var instance = new RainbowEnduserPortal.GetRoomsSuccessDataConference();
      //expect(instance).to.be();
    });
