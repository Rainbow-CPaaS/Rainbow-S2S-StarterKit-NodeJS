...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetSentPresenceSharingRequestsSuccessData();
  });
  ...
  describe('GetSentPresenceSharingRequestsSuccessData', function() {
    it('should create an instance of GetSentPresenceSharingRequestsSuccessData', function() {
      // uncomment below and update the code to test GetSentPresenceSharingRequestsSuccessData
      //var instance = new RainbowEnduserPortal.GetSentPresenceSharingRequestsSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetSentPresenceSharingRequestsSuccessData);
    });
