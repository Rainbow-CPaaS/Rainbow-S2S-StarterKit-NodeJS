...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetUserByJidSuccessPhoneNumbers();
  });
  ...
  describe('GetUserByJidSuccessPhoneNumbers', function() {
    it('should create an instance of GetUserByJidSuccessPhoneNumbers', function() {
      // uncomment below and update the code to test GetUserByJidSuccessPhoneNumbers
      //var instance = new RainbowEnduserPortal.GetUserByJidSuccessPhoneNumbers();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetUserByJidSuccessPhoneNumbers);
    });
