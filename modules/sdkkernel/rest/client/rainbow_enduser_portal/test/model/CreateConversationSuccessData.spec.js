...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.CreateConversationSuccessData();
  });
  ...
  describe('CreateConversationSuccessData', function() {
    it('should create an instance of CreateConversationSuccessData', function() {
      // uncomment below and update the code to test CreateConversationSuccessData
      //var instance = new RainbowEnduserPortal.CreateConversationSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.CreateConversationSuccessData);
    });
