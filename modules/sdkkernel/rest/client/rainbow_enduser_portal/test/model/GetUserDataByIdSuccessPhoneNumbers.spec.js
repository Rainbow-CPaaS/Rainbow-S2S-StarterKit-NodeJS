...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetUserDataByIdSuccessPhoneNumbers();
  });
  ...
  describe('GetUserDataByIdSuccessPhoneNumbers', function() {
    it('should create an instance of GetUserDataByIdSuccessPhoneNumbers', function() {
      // uncomment below and update the code to test GetUserDataByIdSuccessPhoneNumbers
      //var instance = new RainbowEnduserPortal.GetUserDataByIdSuccessPhoneNumbers();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetUserDataByIdSuccessPhoneNumbers);
    });
