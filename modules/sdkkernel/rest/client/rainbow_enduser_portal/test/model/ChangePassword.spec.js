...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.ChangePassword();
  });
  ...
  describe('ChangePassword', function() {
    it('should create an instance of ChangePassword', function() {
      ...
      //var instance = new RainbowEnduserPortal.ChangePassword();
      //expect(instance).to.be.a(RainbowEnduserPortal.ChangePassword);
    });
