...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetUserByJidSuccessData();
  });
  ...
  describe('GetUserByJidSuccessData', function() {
    it('should create an instance of GetUserByJidSuccessData', function() {
      // uncomment below and update the code to test GetUserByJidSuccessData
      //var instance = new RainbowEnduserPortal.GetUserByJidSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetUserByJidSuccessData);
    });
