...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.UpdateGroupById();
  });
  ...
  describe('UpdateGroupById', function() {
    it('should create an instance of UpdateGroupById', function() {
      // uncomment below and update the code to test UpdateGroupById
      //var instance = new RainbowEnduserPortal.UpdateGroupById();
      //expect(instance).to.be.a(RainbowEnduserPortal.UpdateGroupById);
    });
