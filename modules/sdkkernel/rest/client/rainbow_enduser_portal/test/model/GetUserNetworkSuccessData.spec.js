...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetUserNetworkSuccessData();
  });
  ...
  describe('GetUserNetworkSuccessData', function() {
    it('should create an instance of GetUserNetworkSuccessData', function() {
      // uncomment below and update the code to test GetUserNetworkSuccessData
      //var instance = new RainbowEnduserPortal.GetUserNetworkSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetUserNetworkSuccessData);
    });

    it('should have the property showPresence (base name: "showPresence")', function() {
      // uncomment below and update the code to test the property showPresence
      //var instance = new RainbowEnduserPortal.GetUserNetworkSuccessData();
    ...
    it('should have the property lastOfflineMailReceivedDate (base name: "lastOfflineMailReceivedDate")', function() {
      // uncomment below and update the code to test the property lastOfflineMailReceivedDate
      //var instance = new RainbowEnduserPortal.GetUserNetworkSuccessData();
      //expect(instance).to.be();
    });
