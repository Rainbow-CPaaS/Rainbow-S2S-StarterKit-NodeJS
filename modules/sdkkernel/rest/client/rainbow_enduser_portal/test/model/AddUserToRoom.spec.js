...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.AddUserToRoom();
  });
  ...
  describe('AddUserToRoom', function() {
    it('should create an instance of AddUserToRoom', function() {
      // uncomment below and update the code to test AddUserToRoom
      //var instance = new RainbowEnduserPortal.AddUserToRoom();
      //expect(instance).to.be.a(RainbowEnduserPortal.AddUserToRoom);
    });
