...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetUserNetworkSuccessPhoneNumbers();
  });
  ...
  describe('GetUserNetworkSuccessPhoneNumbers', function() {
    it('should create an instance of GetUserNetworkSuccessPhoneNumbers', function() {
      // uncomment below and update the code to test GetUserNetworkSuccessPhoneNumbers
      //var instance = new RainbowEnduserPortal.GetUserNetworkSuccessPhoneNumbers();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetUserNetworkSuccessPhoneNumbers);
    });
