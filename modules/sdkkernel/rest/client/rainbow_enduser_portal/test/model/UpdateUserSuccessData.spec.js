...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.UpdateUserSuccessData();
  });
  ...
  describe('UpdateUserSuccessData', function() {
    it('should create an instance of UpdateUserSuccessData', function() {
      // uncomment below and update the code to test UpdateUserSuccessData
      //var instance = new RainbowEnduserPortal.UpdateUserSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.UpdateUserSuccessData);
    });
