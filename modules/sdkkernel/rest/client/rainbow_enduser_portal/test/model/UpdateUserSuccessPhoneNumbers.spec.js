...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.UpdateUserSuccessPhoneNumbers();
  });
  ...
  describe('UpdateUserSuccessPhoneNumbers', function() {
    it('should create an instance of UpdateUserSuccessPhoneNumbers', function() {
      // uncomment below and update the code to test UpdateUserSuccessPhoneNumbers
      //var instance = new RainbowEnduserPortal.UpdateUserSuccessPhoneNumbers();
      //expect(instance).to.be.a(RainbowEnduserPortal.UpdateUserSuccessPhoneNumbers);
    });
