...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetUserDataByIdSuccessData();
  });
  ...
  describe('GetUserDataByIdSuccessData', function() {
    it('should create an instance of GetUserDataByIdSuccessData', function() {
      // uncomment below and update the code to test GetUserDataByIdSuccessData
      //var instance = new RainbowEnduserPortal.GetUserDataByIdSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetUserDataByIdSuccessData);
    });
