...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetRoomByIdSuccessData();
  });
  ...
  describe('GetRoomByIdSuccessData', function() {
    it('should create an instance of GetRoomByIdSuccessData', function() {
      // uncomment below and update the code to test GetRoomByIdSuccessData
      //var instance = new RainbowEnduserPortal.GetRoomByIdSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetRoomByIdSuccessData);
    });
