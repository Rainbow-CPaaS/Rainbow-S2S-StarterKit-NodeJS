...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GetRoomByJidSuccessData();
  });
  ...
  describe('GetRoomByJidSuccessData', function() {
    it('should create an instance of GetRoomByJidSuccessData', function() {
      // uncomment below and update the code to test GetRoomByJidSuccessData
      //var instance = new RainbowEnduserPortal.GetRoomByJidSuccessData();
      //expect(instance).to.be.a(RainbowEnduserPortal.GetRoomByJidSuccessData);
    });
