...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.UpdateUserData();
  });
  ...
  describe('UpdateUserData', function() {
    it('should create an instance of UpdateUserData', function() {
      ...
      //var instance = new RainbowEnduserPortal.UpdateUserData();
      //expect(instance).to.be.a(RainbowEnduserPortal.UpdateUserData);
    });
