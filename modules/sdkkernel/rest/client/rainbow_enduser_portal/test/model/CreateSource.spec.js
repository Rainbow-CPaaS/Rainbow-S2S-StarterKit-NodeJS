...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.CreateSource();
  });
  ...
  describe('CreateSource', function() {
    it('should create an instance of CreateSource', function() {
      // uncomment below and update the code to test CreateSource
      //var instance = new RainbowEnduserPortal.CreateSource();
      //expect(instance).to.be.a(RainbowEnduserPortal.CreateSource);
    });
