...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.RoomsApi();
  });
  ...
  describe('RoomsApi', function() {
    ...
    describe('getRoomByJid', function() {
      it('should call getRoomByJid successfully', function(done) {
        //uncomment below and update the code to test getRoomByJid
        //instance.getRoomByJid(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
