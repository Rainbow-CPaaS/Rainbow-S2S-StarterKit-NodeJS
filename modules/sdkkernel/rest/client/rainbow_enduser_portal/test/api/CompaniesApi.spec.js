...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.CompaniesApi();
  });
  ...
  describe('CompaniesApi', function() {
    ...
    describe('getCompanyAdministrators', function() {
      it('should call getCompanyAdministrators successfully', function(done) {
        //uncomment below and update the code to test getCompanyAdministrators
        //instance.getCompanyAdministrators(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
