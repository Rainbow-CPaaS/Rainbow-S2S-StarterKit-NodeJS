...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.GroupsApi();
  });
  ...
  describe('GroupsApi', function() {
    ...
    describe('getUserGroupsById', function() {
      it('should call getUserGroupsById successfully', function(done) {
        //uncomment below and update the code to test getUserGroupsById
        //instance.getUserGroupsById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
