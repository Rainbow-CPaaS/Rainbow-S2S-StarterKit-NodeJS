...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.BotsApi();
  });
  ...
  describe('BotsApi', function() {
    describe('getBotById', function() {
      it('should call getBotById successfully', function(done) {
        //uncomment below and update the code to test getBotById
        //instance.getBotById(function(error) {
