...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RainbowEnduserPortal.CommonApi();
  });
  ...
  describe('CommonApi', function() {
    ...
    describe('getApiRainbowEnduserV10About', function() {
      it('should call getApiRainbowEnduserV10About successfully', function(done) {
        //uncomment below and update the code to test getApiRainbowEnduserV10About
        //instance.getApiRainbowEnduserV10About(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
