# RainbowEnduserPortal.UpdateUserSuccessData
...
**emails** | [**[UpdateUserSuccessEmails]**](UpdateUserSuccessEmails.md) | Array of user emails addresses objects | 
**phoneNumbers** | [**[UpdateUserSuccessPhoneNumbers]**](UpdateUserSuccessPhoneNumbers.md) | Array of user phone numbers objects.    Phone number objects can:   * be created by user (information filled by user), * come from association with a system (pbx) device (association is done by admin).   | 
