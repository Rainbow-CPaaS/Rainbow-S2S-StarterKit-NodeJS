...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.GetCompanyAdministratorsSuccessData = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The GetCompanyAdministratorsSuccessData model module.
   * @module model/GetCompanyAdministratorsSuccessData
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>GetCompanyAdministratorsSuccessData</code>.
   * @alias module:model/GetCompanyAdministratorsSuccessData
   * @class
   ...
   */
  var exports = function(firstName, lastName, companyId, isTerminated, jidIm, lastUpdateDate, companyName, guestMode, id, lastAvatarUpdateDate) {
    var _this = this;
  ...
  /**
   * Constructs a <code>GetCompanyAdministratorsSuccessData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetCompanyAdministratorsSuccessData} obj Optional instance to populate.
   * @return {module:model/GetCompanyAdministratorsSuccessData} The populated <code>GetCompanyAdministratorsSuccessData</code> instance.
   */
