...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.GetUserDataByIdSuccessPhoneNumbers = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The GetUserDataByIdSuccessPhoneNumbers model module.
   * @module model/GetUserDataByIdSuccessPhoneNumbers
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>GetUserDataByIdSuccessPhoneNumbers</code>.
   * @alias module:model/GetUserDataByIdSuccessPhoneNumbers
   * @class
  ...
  /**
   * Constructs a <code>GetUserDataByIdSuccessPhoneNumbers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetUserDataByIdSuccessPhoneNumbers} obj Optional instance to populate.
   * @return {module:model/GetUserDataByIdSuccessPhoneNumbers} The populated <code>GetUserDataByIdSuccessPhoneNumbers</code> instance.
   */
