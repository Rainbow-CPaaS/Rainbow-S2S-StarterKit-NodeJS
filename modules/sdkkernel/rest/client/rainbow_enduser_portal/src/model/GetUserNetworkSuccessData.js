...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetUserNetworkSuccessEmails', 'model/GetUserNetworkSuccessPhoneNumbers'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetUserNetworkSuccessEmails'), require('./GetUserNetworkSuccessPhoneNumbers'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowEnduserPortal) {
      root.RainbowEnduserPortal = {};
    }
    root.RainbowEnduserPortal.GetUserNetworkSuccessData = factory(root.RainbowEnduserPortal.ApiClient, root.RainbowEnduserPortal.GetUserNetworkSuccessEmails, root.RainbowEnduserPortal.GetUserNetworkSuccessPhoneNumbers);
  }
}(this, function(ApiClient, GetUserNetworkSuccessEmails, GetUserNetworkSuccessPhoneNumbers) {
  'use strict';



  /**
   * The GetUserNetworkSuccessData model module.
   * @module model/GetUserNetworkSuccessData
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>GetUserNetworkSuccessData</code>.
   * @alias module:model/GetUserNetworkSuccessData
   * @class
   * @param showPresence {Boolean} True when the user agreed to show his presence
   ...
   * @param emails {Array.<module:model/GetUserNetworkSuccessEmails>} Array of user emails addresses objects
   * @param phoneNumbers {Array.<module:model/GetUserNetworkSuccessPhoneNumbers>} Array of user phone numbers objects.    Phone number objects can:   * be created by user (information filled by user), * come from association with a system (pbx) device (association is done by admin).  
   ...
   */
  var exports = function(showPresence, id, loginEmail, firstName, lastName, displayName, nickName, title, jobTitle, tags, emails, phoneNumbers, country, language, timezone, jidIm, jidTel, companyId, companyName, roles, lastUpdateDate, lastAvatarUpdateDate, isTerminated, guestMode, lastOfflineMailReceivedDate) {
    var _this = this;

    _this['showPresence'] = showPresence;
    _this['id'] = id;
  ...
  /**
   * Constructs a <code>GetUserNetworkSuccessData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetUserNetworkSuccessData} obj Optional instance to populate.
   * @return {module:model/GetUserNetworkSuccessData} The populated <code>GetUserNetworkSuccessData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('showPresence')) {
        obj['showPresence'] = ApiClient.convertToType(data['showPresence'], 'Boolean');
      }
      ...
      if (data.hasOwnProperty('emails')) {
        obj['emails'] = ApiClient.convertToType(data['emails'], [GetUserNetworkSuccessEmails]);
      }
      if (data.hasOwnProperty('phoneNumbers')) {
        obj['phoneNumbers'] = ApiClient.convertToType(data['phoneNumbers'], [GetUserNetworkSuccessPhoneNumbers]);
      }
  ...
  /**
   * True when the user agreed to show his presence
   * @member {Boolean} showPresence
   */
  exports.prototype['showPresence'] = undefined;
  /**
   ...
   * @member {Array.<module:model/GetUserNetworkSuccessEmails>} emails
   */
   ...
   * @member {Array.<module:model/GetUserNetworkSuccessPhoneNumbers>} phoneNumbers
   */
   ...
   * @member {module:model/GetUserNetworkSuccessData.StateEnum} state
   */
