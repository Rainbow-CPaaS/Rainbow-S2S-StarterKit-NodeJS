...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.AcceptPresenceSharingSuccessData = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The AcceptPresenceSharingSuccessData model module.
   * @module model/AcceptPresenceSharingSuccessData
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>AcceptPresenceSharingSuccessData</code>.
   * @alias module:model/AcceptPresenceSharingSuccessData
   * @class
  ...
  /**
   * Constructs a <code>AcceptPresenceSharingSuccessData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AcceptPresenceSharingSuccessData} obj Optional instance to populate.
   * @return {module:model/AcceptPresenceSharingSuccessData} The populated <code>AcceptPresenceSharingSuccessData</code> instance.
   */
