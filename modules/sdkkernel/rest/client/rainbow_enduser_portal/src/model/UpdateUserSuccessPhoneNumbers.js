...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.UpdateUserSuccessPhoneNumbers = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The UpdateUserSuccessPhoneNumbers model module.
   * @module model/UpdateUserSuccessPhoneNumbers
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>UpdateUserSuccessPhoneNumbers</code>.
   * @alias module:model/UpdateUserSuccessPhoneNumbers
   * @class
  ...
  /**
   * Constructs a <code>UpdateUserSuccessPhoneNumbers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateUserSuccessPhoneNumbers} obj Optional instance to populate.
   * @return {module:model/UpdateUserSuccessPhoneNumbers} The populated <code>UpdateUserSuccessPhoneNumbers</code> instance.
   */
