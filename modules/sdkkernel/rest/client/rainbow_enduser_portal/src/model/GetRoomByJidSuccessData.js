...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetRoomByJidSuccessConfEndpoints', 'model/GetRoomByJidSuccessUsers', 'model/GetRoomsSuccessDataConference'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetRoomByJidSuccessConfEndpoints'), require('./GetRoomByJidSuccessUsers'), require('./GetRoomsSuccessDataConference'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowEnduserPortal) {
      root.RainbowEnduserPortal = {};
    }
    root.RainbowEnduserPortal.GetRoomByJidSuccessData = factory(root.RainbowEnduserPortal.ApiClient, root.RainbowEnduserPortal.GetRoomByJidSuccessConfEndpoints, root.RainbowEnduserPortal.GetRoomByJidSuccessUsers, root.RainbowEnduserPortal.GetRoomsSuccessDataConference);
  }
}(this, function(ApiClient, GetRoomByJidSuccessConfEndpoints, GetRoomByJidSuccessUsers, GetRoomsSuccessDataConference) {
  'use strict';



  /**
   * The GetRoomByJidSuccessData model module.
   * @module model/GetRoomByJidSuccessData
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>GetRoomByJidSuccessData</code>.
   * @alias module:model/GetRoomByJidSuccessData
   * @class
   * @param creator {String} Rainbow Id of creator
   * @param conference {module:model/GetRoomsSuccessDataConference} 
   * @param visibility {module:model/GetRoomByJidSuccessData.VisibilityEnum} Public/private group visibility for search
   ...
   * @param users {Array.<module:model/GetRoomByJidSuccessUsers>} List of users members of the room.
   * @param confEndpoints {Array.<module:model/GetRoomByJidSuccessConfEndpoints>} Conference end point of a room user. This user is always a 'moderator'. Only one confEndPoint per room.
  ...
  /**
   * Constructs a <code>GetRoomByJidSuccessData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetRoomByJidSuccessData} obj Optional instance to populate.
   * @return {module:model/GetRoomByJidSuccessData} The populated <code>GetRoomByJidSuccessData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('users')) {
        obj['users'] = ApiClient.convertToType(data['users'], [GetRoomByJidSuccessUsers]);
      }
      if (data.hasOwnProperty('confEndpoints')) {
        obj['confEndpoints'] = ApiClient.convertToType(data['confEndpoints'], [GetRoomByJidSuccessConfEndpoints]);
      }
   ...
   * @member {module:model/GetRoomByJidSuccessData.VisibilityEnum} visibility
   */
   ...
   * @member {Array.<module:model/GetRoomByJidSuccessUsers>} users
   */
  exports.prototype['users'] = undefined;
  /**
   * Conference end point of a room user. This user is always a 'moderator'. Only one confEndPoint per room.
   * @member {Array.<module:model/GetRoomByJidSuccessConfEndpoints>} confEndpoints
   */
