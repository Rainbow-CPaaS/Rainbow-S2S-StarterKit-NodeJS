...
(function(root, factory) {
   ...
   */
  var exports = function(creator, visibility, jid, activeUsersCounter, customData, creationDate, isActive, autoRegister, users, confEndpoints, guestEmails, name, topic, id, disableNotifications) {
    var _this = this;
