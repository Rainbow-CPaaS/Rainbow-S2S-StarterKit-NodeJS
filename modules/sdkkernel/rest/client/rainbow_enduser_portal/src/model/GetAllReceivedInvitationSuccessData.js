...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.GetAllReceivedInvitationSuccessData = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The GetAllReceivedInvitationSuccessData model module.
   * @module model/GetAllReceivedInvitationSuccessData
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>GetAllReceivedInvitationSuccessData</code>.
   * @alias module:model/GetAllReceivedInvitationSuccessData
   * @class
  ...
  /**
   * Constructs a <code>GetAllReceivedInvitationSuccessData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetAllReceivedInvitationSuccessData} obj Optional instance to populate.
   * @return {module:model/GetAllReceivedInvitationSuccessData} The populated <code>GetAllReceivedInvitationSuccessData</code> instance.
   */
