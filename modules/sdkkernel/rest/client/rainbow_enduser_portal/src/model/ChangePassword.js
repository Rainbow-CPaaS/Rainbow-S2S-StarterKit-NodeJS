...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.ChangePassword = factory(root.RainbowEnduserPortal.ApiClient);
  }
   ...
   * @class
   * @param oldPassword {String} Previous user password.
   * @param newPassword {String} New user password.    Rules: more than 8 characters, at least 1 capital letter, 1 number, 1 special character.
   */
  ...
  /**
   * New user password.    Rules: more than 8 characters, at least 1 capital letter, 1 number, 1 special character.
