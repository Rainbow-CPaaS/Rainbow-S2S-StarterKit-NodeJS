...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.AcceptUserInvitationSuccessData = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The AcceptUserInvitationSuccessData model module.
   * @module model/AcceptUserInvitationSuccessData
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>AcceptUserInvitationSuccessData</code>.
   * @alias module:model/AcceptUserInvitationSuccessData
   * @class
   ...
   */
  var exports = function(invitingDate, invitingUserEmail, requestedNotificationLanguage, id, invitingUserId, type, lastNotificationDate, status) {
    var _this = this;
  ...
  /**
   * Constructs a <code>AcceptUserInvitationSuccessData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AcceptUserInvitationSuccessData} obj Optional instance to populate.
   * @return {module:model/AcceptUserInvitationSuccessData} The populated <code>AcceptUserInvitationSuccessData</code> instance.
   */
