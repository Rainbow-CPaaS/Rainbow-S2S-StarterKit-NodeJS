...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.SendIm = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The SendIm model module.
   * @module model/SendIm
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>SendIm</code>.
   * @alias module:model/SendIm
   * @class
   * @param toUserId {String} IM recipient user unique identifier (like 56c5c19f94141765119f896c)
   */
  var exports = function(toUserId) {
    var _this = this;
  ...
  /**
   * Constructs a <code>SendIm</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SendIm} obj Optional instance to populate.
   * @return {module:model/SendIm} The populated <code>SendIm</code> instance.
   */
