...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.SearchUsersByJidsSuccessData = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The SearchUsersByJidsSuccessData model module.
   * @module model/SearchUsersByJidsSuccessData
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>SearchUsersByJidsSuccessData</code>.
   * @alias module:model/SearchUsersByJidsSuccessData
   * @class
  ...
  /**
   * Constructs a <code>SearchUsersByJidsSuccessData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SearchUsersByJidsSuccessData} obj Optional instance to populate.
   * @return {module:model/SearchUsersByJidsSuccessData} The populated <code>SearchUsersByJidsSuccessData</code> instance.
   */
