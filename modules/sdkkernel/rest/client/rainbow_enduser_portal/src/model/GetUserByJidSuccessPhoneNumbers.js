...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.GetUserByJidSuccessPhoneNumbers = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The GetUserByJidSuccessPhoneNumbers model module.
   * @module model/GetUserByJidSuccessPhoneNumbers
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>GetUserByJidSuccessPhoneNumbers</code>.
   * @alias module:model/GetUserByJidSuccessPhoneNumbers
   * @class
  ...
  /**
   * Constructs a <code>GetUserByJidSuccessPhoneNumbers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetUserByJidSuccessPhoneNumbers} obj Optional instance to populate.
   * @return {module:model/GetUserByJidSuccessPhoneNumbers} The populated <code>GetUserByJidSuccessPhoneNumbers</code> instance.
   */
