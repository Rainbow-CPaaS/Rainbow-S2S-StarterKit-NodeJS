...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.GetRoomAvatarSuccess = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The GetRoomAvatarSuccess model module.
   * @module model/GetRoomAvatarSuccess
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>GetRoomAvatarSuccess</code>.
   * @alias module:model/GetRoomAvatarSuccess
   * @class
   * @param contentType {module:model/GetRoomAvatarSuccess.ContentTypeEnum} Avatar content-type.
   * @param dimsCached {String} Whether or not the resize avatar file has been cached by nginx.
   * @param lastModified {Date} Last avatar update date (same value than the one in user object and in user vCard).
  ...
  /**
   * Constructs a <code>GetRoomAvatarSuccess</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetRoomAvatarSuccess} obj Optional instance to populate.
   * @return {module:model/GetRoomAvatarSuccess} The populated <code>GetRoomAvatarSuccess</code> instance.
   */
  ...
  /**
   * Avatar content-type.
   * @member {module:model/GetRoomAvatarSuccess.ContentTypeEnum} Content-Type
   */
  ...
  /**
   * Last avatar update date (same value than the one in user object and in user vCard).
