...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.GetUserNetworkSuccessPhoneNumbers = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The GetUserNetworkSuccessPhoneNumbers model module.
   * @module model/GetUserNetworkSuccessPhoneNumbers
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>GetUserNetworkSuccessPhoneNumbers</code>.
   * @alias module:model/GetUserNetworkSuccessPhoneNumbers
   * @class
  ...
  /**
   * Constructs a <code>GetUserNetworkSuccessPhoneNumbers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetUserNetworkSuccessPhoneNumbers} obj Optional instance to populate.
   * @return {module:model/GetUserNetworkSuccessPhoneNumbers} The populated <code>GetUserNetworkSuccessPhoneNumbers</code> instance.
   */
