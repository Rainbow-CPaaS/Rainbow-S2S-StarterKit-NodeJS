...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.GetJoinCompanyInvitationsSuccessData = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The GetJoinCompanyInvitationsSuccessData model module.
   * @module model/GetJoinCompanyInvitationsSuccessData
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>GetJoinCompanyInvitationsSuccessData</code>.
   * @alias module:model/GetJoinCompanyInvitationsSuccessData
   * @class
  ...
  /**
   * Constructs a <code>GetJoinCompanyInvitationsSuccessData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetJoinCompanyInvitationsSuccessData} obj Optional instance to populate.
   * @return {module:model/GetJoinCompanyInvitationsSuccessData} The populated <code>GetJoinCompanyInvitationsSuccessData</code> instance.
   */
