...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.GetPresenceSharingRequestSuccessData = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The GetPresenceSharingRequestSuccessData model module.
   * @module model/GetPresenceSharingRequestSuccessData
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>GetPresenceSharingRequestSuccessData</code>.
   * @alias module:model/GetPresenceSharingRequestSuccessData
   * @class
   ...
   */
  var exports = function(id, fromUserId, toUserId, requestDate, acceptationDate, status) {
    var _this = this;
  ...
  /**
   * Constructs a <code>GetPresenceSharingRequestSuccessData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetPresenceSharingRequestSuccessData} obj Optional instance to populate.
   * @return {module:model/GetPresenceSharingRequestSuccessData} The populated <code>GetPresenceSharingRequestSuccessData</code> instance.
   */
