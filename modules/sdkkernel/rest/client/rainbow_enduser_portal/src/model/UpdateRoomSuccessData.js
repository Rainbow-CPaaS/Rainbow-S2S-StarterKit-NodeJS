...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetRoomsSuccessDataConference', 'model/UpdateRoomSuccessConfEndpoints', 'model/UpdateRoomSuccessUsers'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetRoomsSuccessDataConference'), require('./UpdateRoomSuccessConfEndpoints'), require('./UpdateRoomSuccessUsers'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowEnduserPortal) {
      root.RainbowEnduserPortal = {};
    }
    root.RainbowEnduserPortal.UpdateRoomSuccessData = factory(root.RainbowEnduserPortal.ApiClient, root.RainbowEnduserPortal.GetRoomsSuccessDataConference, root.RainbowEnduserPortal.UpdateRoomSuccessConfEndpoints, root.RainbowEnduserPortal.UpdateRoomSuccessUsers);
  }
}(this, function(ApiClient, GetRoomsSuccessDataConference, UpdateRoomSuccessConfEndpoints, UpdateRoomSuccessUsers) {
  'use strict';



  /**
   * The UpdateRoomSuccessData model module.
   * @module model/UpdateRoomSuccessData
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>UpdateRoomSuccessData</code>.
   * @alias module:model/UpdateRoomSuccessData
   * @class
   * @param creator {String} Rainbow Id of creator
   * @param conference {module:model/GetRoomsSuccessDataConference} 
   * @param visibility {module:model/UpdateRoomSuccessData.VisibilityEnum} Public/private group visibility for search
   ...
   * @param users {Array.<module:model/UpdateRoomSuccessUsers>} List of users members of the room.
   * @param confEndpoints {Array.<module:model/UpdateRoomSuccessConfEndpoints>} Conference end point of a room user. This user is always a 'moderator'. Only one confEndPoint per room.
  ...
  /**
   * Constructs a <code>UpdateRoomSuccessData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateRoomSuccessData} obj Optional instance to populate.
   * @return {module:model/UpdateRoomSuccessData} The populated <code>UpdateRoomSuccessData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('users')) {
        obj['users'] = ApiClient.convertToType(data['users'], [UpdateRoomSuccessUsers]);
      }
      if (data.hasOwnProperty('confEndpoints')) {
        obj['confEndpoints'] = ApiClient.convertToType(data['confEndpoints'], [UpdateRoomSuccessConfEndpoints]);
      }
   ...
   * @member {module:model/UpdateRoomSuccessData.VisibilityEnum} visibility
   */
   ...
   * @member {Array.<module:model/UpdateRoomSuccessUsers>} users
   */
  exports.prototype['users'] = undefined;
  /**
   * Conference end point of a room user. This user is always a 'moderator'. Only one confEndPoint per room.
   * @member {Array.<module:model/UpdateRoomSuccessConfEndpoints>} confEndpoints
   */
