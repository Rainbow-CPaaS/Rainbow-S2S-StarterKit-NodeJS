...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.GetConnectedUserDataSuccessPhoneNumbers = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The GetConnectedUserDataSuccessPhoneNumbers model module.
   * @module model/GetConnectedUserDataSuccessPhoneNumbers
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>GetConnectedUserDataSuccessPhoneNumbers</code>.
   * @alias module:model/GetConnectedUserDataSuccessPhoneNumbers
   * @class
  ...
  /**
   * Constructs a <code>GetConnectedUserDataSuccessPhoneNumbers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetConnectedUserDataSuccessPhoneNumbers} obj Optional instance to populate.
   * @return {module:model/GetConnectedUserDataSuccessPhoneNumbers} The populated <code>GetConnectedUserDataSuccessPhoneNumbers</code> instance.
   */
