...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetUserByJidSuccessEmails', 'model/GetUserByJidSuccessPhoneNumbers'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetUserByJidSuccessEmails'), require('./GetUserByJidSuccessPhoneNumbers'));
  } else {
    // Browser globals (root is window)
    if (!root.RainbowEnduserPortal) {
      root.RainbowEnduserPortal = {};
    }
    root.RainbowEnduserPortal.GetUserByJidSuccessData = factory(root.RainbowEnduserPortal.ApiClient, root.RainbowEnduserPortal.GetUserByJidSuccessEmails, root.RainbowEnduserPortal.GetUserByJidSuccessPhoneNumbers);
  }
}(this, function(ApiClient, GetUserByJidSuccessEmails, GetUserByJidSuccessPhoneNumbers) {
  'use strict';



  /**
   * The GetUserByJidSuccessData model module.
   * @module model/GetUserByJidSuccessData
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>GetUserByJidSuccessData</code>.
   * @alias module:model/GetUserByJidSuccessData
   * @class
   ...
   * @param phoneNumbers {Array.<module:model/GetUserByJidSuccessPhoneNumbers>} Array of user phone numbers objects.    Phone number objects can:   * be created by user (information filled by user), * come from association with a system (pbx) device (association is done by admin).  
   ...
   * @param emails {Array.<module:model/GetUserByJidSuccessEmails>} Array of user emails addresses objects
  ...
  /**
   * Constructs a <code>GetUserByJidSuccessData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetUserByJidSuccessData} obj Optional instance to populate.
   * @return {module:model/GetUserByJidSuccessData} The populated <code>GetUserByJidSuccessData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('phoneNumbers')) {
        obj['phoneNumbers'] = ApiClient.convertToType(data['phoneNumbers'], [GetUserByJidSuccessPhoneNumbers]);
      }
      ...
      if (data.hasOwnProperty('emails')) {
        obj['emails'] = ApiClient.convertToType(data['emails'], [GetUserByJidSuccessEmails]);
      }
   ...
   * @member {Array.<module:model/GetUserByJidSuccessPhoneNumbers>} phoneNumbers
   */
   ...
   * @member {Array.<module:model/GetUserByJidSuccessEmails>} emails
   */
   ...
   * @member {module:model/GetUserByJidSuccessData.StateEnum} state
   */
