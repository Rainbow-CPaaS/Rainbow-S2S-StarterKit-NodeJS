...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.GetRainbowProfileByIdSuccessData = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The GetRainbowProfileByIdSuccessData model module.
   * @module model/GetRainbowProfileByIdSuccessData
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>GetRainbowProfileByIdSuccessData</code>.
   * @alias module:model/GetRainbowProfileByIdSuccessData
   * @class
   ...
   */
  var exports = function(featuresList, name, description, id, creationDate) {
    var _this = this;
  ...
  /**
   * Constructs a <code>GetRainbowProfileByIdSuccessData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetRainbowProfileByIdSuccessData} obj Optional instance to populate.
   * @return {module:model/GetRainbowProfileByIdSuccessData} The populated <code>GetRainbowProfileByIdSuccessData</code> instance.
   */
