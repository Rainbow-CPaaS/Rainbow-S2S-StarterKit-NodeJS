...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.RegisterMyselfSuccessPhoneNumbers = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The RegisterMyselfSuccessPhoneNumbers model module.
   * @module model/RegisterMyselfSuccessPhoneNumbers
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>RegisterMyselfSuccessPhoneNumbers</code>.
   * @alias module:model/RegisterMyselfSuccessPhoneNumbers
   * @class
  ...
  /**
   * Constructs a <code>RegisterMyselfSuccessPhoneNumbers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RegisterMyselfSuccessPhoneNumbers} obj Optional instance to populate.
   * @return {module:model/RegisterMyselfSuccessPhoneNumbers} The populated <code>RegisterMyselfSuccessPhoneNumbers</code> instance.
   */
