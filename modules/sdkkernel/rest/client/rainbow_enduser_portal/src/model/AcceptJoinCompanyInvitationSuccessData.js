...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.AcceptJoinCompanyInvitationSuccessData = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The AcceptJoinCompanyInvitationSuccessData model module.
   * @module model/AcceptJoinCompanyInvitationSuccessData
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>AcceptJoinCompanyInvitationSuccessData</code>.
   * @alias module:model/AcceptJoinCompanyInvitationSuccessData
   * @class
   ...
   */
  var exports = function(companyName, acceptationDate, requestedNotificationLanguage, lastNotificationDate, companyId, invitedUserId, declinationDate, invitedUserLoginEmail, id, invitingAdminId, invitingAdminLoginEmail, invitationDate, status) {
    var _this = this;
  ...
  /**
   * Constructs a <code>AcceptJoinCompanyInvitationSuccessData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AcceptJoinCompanyInvitationSuccessData} obj Optional instance to populate.
   * @return {module:model/AcceptJoinCompanyInvitationSuccessData} The populated <code>AcceptJoinCompanyInvitationSuccessData</code> instance.
   */
