...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.SendJoinConferenceInvitationEmailSuccessUsersRainbow = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The SendJoinConferenceInvitationEmailSuccessUsersRainbow model module.
   * @module model/SendJoinConferenceInvitationEmailSuccessUsersRainbow
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>SendJoinConferenceInvitationEmailSuccessUsersRainbow</code>.
   * @alias module:model/SendJoinConferenceInvitationEmailSuccessUsersRainbow
   * @class
  ...
  /**
   * Constructs a <code>SendJoinConferenceInvitationEmailSuccessUsersRainbow</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SendJoinConferenceInvitationEmailSuccessUsersRainbow} obj Optional instance to populate.
   * @return {module:model/SendJoinConferenceInvitationEmailSuccessUsersRainbow} The populated <code>SendJoinConferenceInvitationEmailSuccessUsersRainbow</code> instance.
   */
