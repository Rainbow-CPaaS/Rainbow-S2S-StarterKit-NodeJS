...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RainbowEnduserPortal.UpdateRoom = factory(root.RainbowEnduserPortal.ApiClient);
  }
  ...
  /**
   * The UpdateRoom model module.
   * @module model/UpdateRoom
   * @version 1.84.0
   */

  /**
   * Constructs a new <code>UpdateRoom</code>.
   * @alias module:model/UpdateRoom
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateRoom</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateRoom} obj Optional instance to populate.
   * @return {module:model/UpdateRoom} The populated <code>UpdateRoom</code> instance.
   */
   ...
   * @member {module:model/UpdateRoom.VisibilityEnum} visibility
   * @default 'private'
   */
  ...
  /**
   * User unique identifier; New room owner must be a moderator and current owner must have valid licence (feature BUBBLE_PROMOTE_MEMBER)
   * @member {String} owner
   */
   ...
   * @member {module:model/UpdateRoom.AutoRegisterEnum} autoRegister
   * @default 'unlock'
   */
